...
function(manpage)
  ...
  add_custom_command_target(
      ...
      COMMAND
        ...
        "--center" "${MP_PAGE_HEADER}" "--release=\"nextcode ${NEXTCODE_VERSION}\""
  ...
  if("${NEXTCODE_HOST_VARIANT_SDK}" STREQUAL "OPENBSD")
    set(MANPAGE_DEST "")
  endif()
  nextcode_install_in_component(FILES "${output_file_name}"
