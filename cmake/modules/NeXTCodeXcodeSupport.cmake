...
function(fixup_imported_target_property_for_xcode target property llvm_build_type)
  ...
  foreach(build_type ${CMAKE_CONFIGURATION_TYPES})
    ...
    set(NEXTCODE_BUILD_PROPERTY_NAME "${property}_${build_type_upper}")
    set_target_properties(${target} PROPERTIES "${NEXTCODE_BUILD_PROPERTY_NAME}" "${PROP_VALUE}")
  endforeach()
endfunction()
...
# if we compile LLVM-Release and NeXTCode-Debug, NeXTCode is going to look in the
...
macro(nextcode_common_xcode_cxx_config)
