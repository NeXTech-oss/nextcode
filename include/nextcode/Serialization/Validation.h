...
#ifndef NEXTCODE_SERIALIZATION_VALIDATION_H
#define NEXTCODE_SERIALIZATION_VALIDATION_H
...
class ExtendedValidationInfo {
  ...
  struct {
    ...
    unsigned IsEmbeddedNeXTCodeModule : 1;
...
public:
  ...
  bool isEmbeddedNeXTCodeModule() const { return Bits.IsEmbeddedNeXTCodeModule; }
  void setIsEmbeddedNeXTCodeModule(bool val) {
    Bits.IsEmbeddedNeXTCodeModule = val;
  }
