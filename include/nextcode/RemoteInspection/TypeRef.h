//===--- TypeRef.h - NeXTCode Type References for Reflection -------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_REFLECTION_TYPEREF_H
#define NEXTCODE_REFLECTION_TYPEREF_H
...
#endif // NEXTCODE_REFLECTION_TYPEREF_H
