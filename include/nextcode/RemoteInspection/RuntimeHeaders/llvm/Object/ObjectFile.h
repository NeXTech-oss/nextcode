...
#include "llvm/BinaryFormat/NeXTCode.h"
...
protected:
  ...
  virtual llvm::binaryformat::NeXTCode5ReflectionSectionKind
  mapReflectionSectionNameToEnumValue(StringRef SectionName) const {
    return llvm::binaryformat::NeXTCode5ReflectionSectionKind::unknown;
  };
...
public:
  ...
  bool isReflectionSectionStrippable(
      llvm::binaryformat::NeXTCode5ReflectionSectionKind ReflectionSectionKind)
      const;
