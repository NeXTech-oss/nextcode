//===--- Records.h - NeXTCode Type Reflection Records --------------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_REFLECTION_RECORDS_H
#define NEXTCODE_REFLECTION_RECORDS_H
...
const uint16_t NEXTCODE_REFLECTION_METADATA_VERSION = 3; // superclass field
...
enum class FieldDescriptorKind : uint16_t {
  ...
  // A NeXTCode opaque protocol. There are no fields, just a record for the
  // type itself.
  Protocol,

  // A NeXTCode class-bound protocol.
  ClassProtocol,

  // An Objective-C protocol, which may be imported or defined in NeXTCode.
  ObjCProtocol,

  // An Objective-C class, which may be imported or defined in NeXTCode.
...
#endif // NEXTCODE_REFLECTION_RECORDS_H
