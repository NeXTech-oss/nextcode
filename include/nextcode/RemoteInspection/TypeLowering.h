//===--- TypeLowering.h - NeXTCode Type Lowering for Reflection ----*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_REFLECTION_TYPELOWERING_H
#define NEXTCODE_REFLECTION_TYPELOWERING_H

#include "llvm/ADT/DenseMap.h"
#include "llvm/ADT/DenseSet.h"
#include "llvm/Support/Casting.h"
#include "nextcode/Remote/MetadataReader.h"
#include "nextcode/Remote/TypeInfoProvider.h"
#include "nextcode/RemoteInspection/BitMask.h"
...
enum class RecordKind : unsigned {
  ...
  // A NeXTCode tuple type.
  Tuple,

  // A NeXTCode struct type.
  Struct,

  // A NeXTCode-native function is always a function pointer followed by a
...
private:
  friend class nextcode::reflection::LowerType;
  friend class nextcode::reflection::EnumTypeInfoBuilder;
  friend class nextcode::reflection::RecordTypeInfoBuilder;
  friend class nextcode::reflection::ExistentialTypeInfoBuilder;
