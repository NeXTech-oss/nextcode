...
#ifndef NEXTCODE_DRIVER_COMPILATION_H
#define NEXTCODE_DRIVER_COMPILATION_H
...
public:
  ...
  /// a file.
  ///
  /// \sa types::isPartOfNeXTCodeCompilation
  ...
  unsigned countNeXTCodeInputs() const;

  /// Unfortunately the success or failure of a NeXTCode compilation is currently
