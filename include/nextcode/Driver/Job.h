...
#ifndef NEXTCODE_DRIVER_JOB_H
#define NEXTCODE_DRIVER_JOB_H
...
public:
  ...
  /// Assumes that, if a compile job, has one primary nextcode input
  /// May return empty if none.
  StringRef getFirstNeXTCodePrimaryInput() const;
};
