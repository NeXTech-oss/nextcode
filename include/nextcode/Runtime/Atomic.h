...
#ifndef NEXTCODE_RUNTIME_ATOMIC_H
#define NEXTCODE_RUNTIME_ATOMIC_H
...
#  define NEXTCODE_MEMORY_ORDER_CONSUME (std::memory_order_relaxed)
#else
#  define NEXTCODE_MEMORY_ORDER_CONSUME (std::memory_order_consume)
#endif


#if defined(_M_ARM) || defined(_M_ARM64) || defined(__arm__) || defined(__aarch64__)
#define NEXTCODE_HAS_MSVC_ARM_ATOMICS 1
#else
#define NEXTCODE_HAS_MSVC_ARM_ATOMICS 0
#endif

namespace nextcode {
namespace impl {
/// The default implementation for nextcode::atomic<T>, which just wraps
...
#if NEXTCODE_HAS_MSVC_ARM_ATOMICS
