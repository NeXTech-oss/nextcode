//===--- Casting.h - NeXTCode type-casting runtime support ---------*- C++ -*-===//
//
/*
...
//===----------------------------------------------------------------------===//
//
// NeXTCode runtime functions for casting values.
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_RUNTIME_CASTING_H
#define NEXTCODE_RUNTIME_CASTING_H
...
///   nextcode_dynamicCast may fail rather than return false.
NEXTCODE_RUNTIME_EXPORT
bool
nextcode_dynamicCast(OpaqueValue *dest, OpaqueValue *src,
                  const Metadata *srcType,
                  const Metadata *targetType,
                  DynamicCastFlags flags);

/// Checked dynamic cast to a NeXTCode class type.
///
/// \param object The object to cast.
/// \param targetType The type to which we are casting, which is known to be
/// a NeXTCode class type.
///
/// \returns the object if the cast succeeds, or null otherwise.
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastClass(const void *object, const ClassMetadata *targetType);

/// Unconditional, checked dynamic cast to a NeXTCode class type.
///
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastClassUnconditional(const void *object,
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastObjCClass(const void *object, const ClassMetadata *targetType);
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastForeignClass(const void *object,
...
///
/// Aborts if the object isn't of the target type.
/// Note that unlike nextcode_dynamicCastClassUnconditional, this does not abort
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastObjCClassUnconditional(const void *object,
                                        const ClassMetadata *targetType,
                                        const char *file, unsigned line, unsigned column);
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastForeignClassUnconditional(
  const void *object,
  const ForeignClassMetadata *targetType,
  const char *file, unsigned line, unsigned column);
#endif
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastUnknownClass(const void *object, const Metadata *targetType);
...
NEXTCODE_RUNTIME_EXPORT
const void *
nextcode_dynamicCastUnknownClassUnconditional(const void *object,
                                           const Metadata *targetType,
                                           const char *file, unsigned line, unsigned column);

NEXTCODE_RUNTIME_EXPORT
const Metadata *
nextcode_dynamicCastMetatype(const Metadata *sourceType,
                          const Metadata *targetType);
NEXTCODE_RUNTIME_EXPORT
const Metadata *
nextcode_dynamicCastMetatypeUnconditional(const Metadata *sourceType,
                                       const Metadata *targetType,
                                       const char *file, unsigned line, unsigned column);
#if NEXTCODE_OBJC_INTEROP
NEXTCODE_RUNTIME_EXPORT
const ClassMetadata *
nextcode_dynamicCastObjCClassMetatype(const ClassMetadata *sourceType,
                                   const ClassMetadata *targetType);
NEXTCODE_RUNTIME_EXPORT
const ClassMetadata *
nextcode_dynamicCastObjCClassMetatypeUnconditional(const ClassMetadata *sourceType,
                                                const ClassMetadata *targetType,
                                                const char *file, unsigned line, unsigned column);
#endif
...
NEXTCODE_RUNTIME_EXPORT
const ClassMetadata *
nextcode_dynamicCastForeignClassMetatype(const ClassMetadata *sourceType,
                                   const ClassMetadata *targetType);
NEXTCODE_RUNTIME_EXPORT
const ClassMetadata *
nextcode_dynamicCastForeignClassMetatypeUnconditional(
...
NEXTCODE_RUNTIME_EXPORT
const Metadata *
nextcode_getDynamicType(OpaqueValue *value, const Metadata *self,
...
NEXTCODE_RUNTIME_EXPORT
const Metadata *nextcode_getObjectType(HeapObject *object);

/// Check whether a type conforms to a given native NeXTCode protocol,
...
NEXTCODE_RUNTIME_EXPORT
const WitnessTable *nextcode_conformsToProtocol(const Metadata *type,
                                             const void *protocol);

/// Check whether a type conforms to a given native NeXTCode protocol. Identical to
/// nextcode_conformsToProtocol, except that the protocol parameter has a ptrauth
/// signature on ARM64e that is signed with a process independent key.
NEXTCODE_RUNTIME_EXPORT
const WitnessTable *
nextcode_conformsToProtocol2(const Metadata *type,
...
NEXTCODE_RUNTIME_EXPORT
const WitnessTable *
nextcode_conformsToProtocolCommon(const Metadata *type,
                               const ProtocolDescriptor *protocol);

} // end namespace nextcode

#endif // NEXTCODE_RUNTIME_CASTING_H
