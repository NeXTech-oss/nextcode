...
#ifndef NEXTCODE_CONCURRENCY_VOUCHERSHIMS_H
#define NEXTCODE_CONCURRENCY_VOUCHERSHIMS_H
...
#if __APPLE__ && !NEXTCODE_THREADING_NONE && __has_include(<os/voucher_private.h>)
...
#if (NEXTCODE_HAS_VOUCHER_HEADER || NEXTCODE_OBJC_INTEROP) && !NEXTCODE_THREADING_NONE
...
#endif // NEXTCODE_CONCURRENCY_VOUCHERSHIMS_H
