...
#ifndef NEXTCODE_RUNTIME_EXISTENTIALCONTAINER_H
#define NEXTCODE_RUNTIME_EXISTENTIALCONTAINER_H
...
struct TargetOpaqueExistentialContainer {
  ...
  void copyTypeInto(nextcode::TargetOpaqueExistentialContainer<Runtime> *dest,
