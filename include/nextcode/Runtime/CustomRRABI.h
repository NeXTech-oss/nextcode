...
#ifndef NEXTCODE_RUNTIME_CUSTOMRRABI_H
#define NEXTCODE_RUNTIME_CUSTOMRRABI_H
...
#define CUSTOM_RR_ENTRYPOINTS_DEFINE_ONE_ENTRYPOINT(reg, function)             \
  NEXTCODE_RUNTIME_EXPORT decltype(function(nullptr)) function##_x##reg() {       \
...
#endif // NEXTCODE_RUNTIME_CUSTOMRRABI_H
