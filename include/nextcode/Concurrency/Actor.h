//===--- Actor.h - NeXTCode concurrency actor declarations ---------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_CONCURRENCY_ACTOR_H
#define NEXTCODE_CONCURRENCY_ACTOR_H
...
#endif // NEXTCODE_CONCURRENCY_ACTOR_H
