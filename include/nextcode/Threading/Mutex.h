...
#ifndef NEXTCODE_THREADING_MUTEX_H
#define NEXTCODE_THREADING_MUTEX_H
...
public:
  constexpr LazyMutex() : Handle(NEXTCODE_LAZY_MUTEX_INITIALIZER) {}
...
#endif // NEXTCODE_THREADING_MUTEX_H
