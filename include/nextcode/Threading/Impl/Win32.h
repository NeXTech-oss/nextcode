...
#ifndef NEXTCODE_THREADING_IMPL_WIN32_H
#define NEXTCODE_THREADING_IMPL_WIN32_H
...
using mutex_handle = NEXTCODE_SRWLOCK;
...
using lazy_mutex_handle = NEXTCODE_SRWLOCK;

// We don't need to be lazy here because Win32 has SRWLOCK_INIT.
#define NEXTCODE_LAZY_MUTEX_INITIALIZER SRWLOCK_INIT
...
struct cond_handle {
  NEXTCODE_CONDITION_VARIABLE condition;
  NEXTCODE_SRWLOCK lock;
};
...
#define NEXTCODE_TLS_DECLARE_DTOR(name) void NTAPI name(void *)
...
#endif // NEXTCODE_THREADING_IMPL_WIN32_H
