...
#ifndef NEXTCODE_SEMA_IDETYPECHECKING_H
#define NEXTCODE_SEMA_IDETYPECHECKING_H
...
namespace nextcode {
  ...
  ///
  /// Unlike other member lookup functions, \c nextcode::resolveValueMember()
  ...
  /// Just a proxy to nextcode::contextUsesConcurrencyFeatures() from lib/IDE code.
