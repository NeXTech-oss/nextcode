...
#ifndef NEXTCODE_SEMA_CSFIX_H
#define NEXTCODE_SEMA_CSFIX_H
...
enum class FixKind : uint8_t {
  ...
  /// Allow NeXTCode -> C pointer conversion in an argument position
  /// of a NeXTCode function.
  AllowNeXTCodeToCPointerConversion,
...
class AllowNeXTCodeToCPointerConversion final : public ConstraintFix {
  AllowNeXTCodeToCPointerConversion(ConstraintSystem &cs,
                                 ConstraintLocator *locator)
      : ConstraintFix(cs, FixKind::AllowNeXTCodeToCPointerConversion, locator) {}

public:
  std::string getName() const override {
    return "allow implicit NeXTCode -> C pointer conversion";
  }

  bool diagnose(const Solution &solution, bool asNote = false) const override;

  static AllowNeXTCodeToCPointerConversion *create(ConstraintSystem &cs,
                                                ConstraintLocator *locator);
};
...
namespace llvm {
  template <>
  struct DenseMapInfo<nextcode::constraints::FixKind> {
    using FixKind = nextcode::constraints::FixKind;
