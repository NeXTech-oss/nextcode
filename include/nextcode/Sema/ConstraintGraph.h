...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_SEMA_CONSTRAINT_GRAPH_H
#define NEXTCODE_SEMA_CONSTRAINT_GRAPH_H
...
public:
  ...
  NEXTCODE_DEBUG_HELPER(void dump());
  ...
  // FIXME: Potentially side-effectful.
  NEXTCODE_DEBUG_HELPER(void dumpConnectedComponents());
...
#endif // LLVM_NEXTCODE_SEMA_CONSTRAINT_GRAPH_H
