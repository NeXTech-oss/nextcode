...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_SEMA_CONSTRAINT_H
#define NEXTCODE_SEMA_CONSTRAINT_H
...
#include "nextcode/Sema/ContextualTypeInfo.h"
...
enum class ConversionRestrictionKind {
  ...
  CGFloatToDouble,
  /// Implicit conversion between NeXTCode and C pointers:
...
public:
  ...
  NEXTCODE_DEBUG_DUMPER(dump(SourceManager *SM));

  NEXTCODE_DEBUG_DUMPER(dump(ConstraintSystem *CS));
...
template<>
struct ilist_traits<nextcode::constraints::Constraint>
         : public ilist_node_traits<nextcode::constraints::Constraint> {
  using Element = nextcode::constraints::Constraint;
...
#endif // LLVM_NEXTCODE_SEMA_CONSTRAINT_H
