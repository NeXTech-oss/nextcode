...
// It should only be used within the nextcode compiler or runtime library, but not
// by external tools which use the demangler library (like lldb).
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_DEMANGLING_DEMANGLER_H
#define NEXTCODE_DEMANGLING_DEMANGLER_H
...
protected:
  ...
  NodePointer createNeXTCodeType(Node::Kind typeKind, const char *name);
...
#endif // NEXTCODE_DEMANGLING_DEMANGLER_H
