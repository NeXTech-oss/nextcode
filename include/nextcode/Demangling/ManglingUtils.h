//===--- ManglingUtils.h - Utilities for NeXTCode name mangling ----*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_DEMANGLING_MANGLINGUTILS_H
#define NEXTCODE_DEMANGLING_MANGLINGUTILS_H
...
/// Returns the standard type kind for an 'S' substitution, e.g. 'i' for "Integer".
///
...
#endif // NEXTCODE_DEMANGLING_MANGLINGUTILS_H
