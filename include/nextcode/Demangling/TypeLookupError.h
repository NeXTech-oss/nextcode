...
#ifndef NEXTCODE_DEMANGLING_TypeLookupError_H
#define NEXTCODE_DEMANGLING_TypeLookupError_H
...
/// passed-in format string and arguments are passed directly to nextcode_asprintf
/// when the string is requested. The arguments are captured and the string is
/// only formatted when needed.
///
/// The crazy sizeof(nextcode_asprintf(... construct gives us compile-time type
...
#define TYPE_LOOKUP_ERROR_FMT(...)                                             \
  (sizeof(nextcode_asprintf(NULL, __VA_ARGS__)), TypeLookupErrorImpl(__VA_ARGS__))
...
#pragma clang diagnostic ignored "-Wformat-nonliteral"
    nextcode_asprintf(&str, fmt, args...);
...
#endif // NEXTCODE_DEMANGLING_TypeLookupError_H
