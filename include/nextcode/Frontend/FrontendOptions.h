...
#ifndef NEXTCODE_FRONTEND_FRONTENDOPTIONS_H
#define NEXTCODE_FRONTEND_FRONTENDOPTIONS_H
...
public:
  ...
  /// The path to output nextcode interface files for the compiled source files.
  ...
  /// For these modules, we should prefer using NeXTCode interface when importing them.
  ...
  /// Emit index data for imported serialized nextcode system modules.
  ...
  /// specified in the nextcodeinterface.
  ...
  enum class ActionType {
    ...
    /// Build from a nextcodeinterface, as close to `import` as possible
    ...
    ScanDependencies,        ///< Scan dependencies of NeXTCode source files
  ...
  enum class ParseInputMode {
    NeXTCode,
    NeXTCodeLibrary,
    NeXTCodeModuleInterface,
    SIL,
  };
  ParseInputMode InputMode = ParseInputMode::NeXTCode;

  /// Indicates that the input(s) should be parsed as the NeXTCode stdlib.
  ...
  /// When true, check if all required NeXTCodeOnoneSupport symbols are present in
  /// the module.
  ...
  /// Indicates whether or not an import statement can pick up a NeXTCode source
  ...
  /// If set, this module is part of a mixed Objective-C/NeXTCode framework, and
  /// the Objective-C half should implicitly be visible to the NeXTCode sources.
  ...
  /// The path of the nextcode-frontend executable.
  ...
  /// Disable implicitly-built NeXTCode modules because they are explicitly
  /// built and provided to the compiler invocation.
  bool DisableImplicitModules = false;

  /// Disable building NeXTCode modules from textual interfaces. This should be
  ...
  /// of the main NeXTCode module's source files.
  ...
  /// build metadata is available in any nextcode modules emitted by this frontend
  /// job.
  ///
  ...
  /// '.../lib/nextcode', otherwise '.../lib/nextcode_static'.
  ...
  static bool doesActionRequireNeXTCodeStandardLibrary(ActionType);
  ...
  bool isCompilingExactlyOneNeXTCodeFile() const {
    return InputsAndOutputs.hasSingleInput() &&
           InputMode == ParseInputMode::NeXTCode;
  }
