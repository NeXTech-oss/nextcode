...
#ifndef NEXTCODE_SIL_SILINSTRUCTIONWORKLIST_H
#define NEXTCODE_SIL_SILINSTRUCTIONWORKLIST_H
...
public:
  ...
  void eraseInstFromFunction(SILInstruction &instruction,
    ...
    nextcode::salvageDebugInfo(&instruction);
...
#endif // NEXTCODE_SIL_SILINSTRUCTIONWORKLIST_H
