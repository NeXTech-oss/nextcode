...
#ifndef NEXTCODE_SIL_SILVTABLE_H
#define NEXTCODE_SIL_SILVTABLE_H
...
template <>
struct ilist_traits<::nextcode::SILVTable> :
public ilist_node_traits<::nextcode::SILVTable> {
  using SILVTable = ::nextcode::SILVTable;
