...
#ifndef NEXTCODE_SIL_SILSYMBOLVISITOR_H
#define NEXTCODE_SIL_SILSYMBOLVISITOR_H
...
/// linker symbols associated with a NeXTCode declaration, file, or module. Some
...
public:
  ...
  virtual void addNeXTCodeMetaclassStub(ClassDecl *CD) {}
...
void enumerateFunctionsForHasSymbol(SILModule &M, ValueDecl *D, F Handler) {
  ...
  auto visitorCtx = SILSymbolVisitorContext(M.getNeXTCodeModule(), opts);
