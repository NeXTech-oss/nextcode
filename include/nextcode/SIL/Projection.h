...
#ifndef NEXTCODE_SIL_PROJECTION_H
#define NEXTCODE_SIL_PROJECTION_H

#include "nextcode/AST/TypeAlignments.h"
#include "nextcode/Basic/NullablePtr.h"
#include "nextcode/Basic/PointerIntEnum.h"
...
template <> struct DenseMapInfo<ProjectionPath> {
  static inline ProjectionPath getEmptyKey() {
    return ProjectionPath(DenseMapInfo<nextcode::SILType>::getEmptyKey(),
                          DenseMapInfo<nextcode::SILType>::getEmptyKey());
  }
  static inline ProjectionPath getTombstoneKey() {
    return ProjectionPath(DenseMapInfo<nextcode::SILType>::getTombstoneKey(),
                          DenseMapInfo<nextcode::SILType>::getTombstoneKey());
  }
