...
#ifndef NEXTCODE_SIL_SILWITNESSTABLE_H
#define NEXTCODE_SIL_SILWITNESSTABLE_H
...
template <>
struct ilist_traits<::nextcode::SILWitnessTable> :
public ilist_node_traits<::nextcode::SILWitnessTable> {
  using SILWitnessTable = ::nextcode::SILWitnessTable;
