...
#ifndef NEXTCODE_SIL_APPLYSITE_H
#define NEXTCODE_SIL_APPLYSITE_H
...
#define FOREACH_IMPL_RETURN(OPERATION)                                         \
  ...
  bool canOptimize() const {
    return !nextcode::isa<DynamicFunctionRefInst>(getCallee()) &&
      !nextcode::isa<PreviousDynamicFunctionRefInst>(getCallee());
  }
...
template<>
struct PointerLikeTypeTraits<nextcode::ApplySite> {
public:
  static inline void *getAsVoidPointer(nextcode::ApplySite apply) {
    return (void*)apply.getInstruction();
  }
  static inline nextcode::ApplySite getFromVoidPointer(void *pointer) {
    return nextcode::ApplySite((nextcode::SILInstruction*)pointer);
  }
  enum { NumLowBitsAvailable =
         PointerLikeTypeTraits<nextcode::SILNode *>::NumLowBitsAvailable };
};

template<>
struct PointerLikeTypeTraits<nextcode::FullApplySite> {
public:
  static inline void *getAsVoidPointer(nextcode::FullApplySite apply) {
    return (void*)apply.getInstruction();
  }
  static inline nextcode::FullApplySite getFromVoidPointer(void *pointer) {
    return nextcode::FullApplySite((nextcode::SILInstruction*)pointer);
  }
  enum { NumLowBitsAvailable =
         PointerLikeTypeTraits<nextcode::SILNode *>::NumLowBitsAvailable };
};
...
template <> struct simplify_type<const ::nextcode::ApplySite> {
  using SimpleType = ::nextcode::SILInstruction *;
  static SimpleType getSimplifiedValue(const ::nextcode::ApplySite &Val) {
    return Val.getInstruction();
  }
};
template <>
struct simplify_type<::nextcode::ApplySite>
    : public simplify_type<const ::nextcode::ApplySite> {};
template <>
struct simplify_type<::nextcode::FullApplySite>
    : public simplify_type<const ::nextcode::ApplySite> {};
template <>
struct simplify_type<const ::nextcode::FullApplySite>
    : public simplify_type<const ::nextcode::ApplySite> {};

template <> struct DenseMapInfo<::nextcode::ApplySite> {
  static ::nextcode::ApplySite getEmptyKey() {
    return ::nextcode::ApplySite::getFromOpaqueValue(
        llvm::DenseMapInfo<void *>::getEmptyKey());
  }
  static ::nextcode::ApplySite getTombstoneKey() {
    return ::nextcode::ApplySite::getFromOpaqueValue(
        llvm::DenseMapInfo<void *>::getTombstoneKey());
  }
  static unsigned getHashValue(::nextcode::ApplySite AS) {
    auto *I = AS.getInstruction();
    return DenseMapInfo<::nextcode::SILInstruction *>::getHashValue(I);
  }
  static bool isEqual(::nextcode::ApplySite LHS, ::nextcode::ApplySite RHS) {
    return LHS == RHS;
  }
};

template <> struct DenseMapInfo<::nextcode::FullApplySite> {
  static ::nextcode::FullApplySite getEmptyKey() {
    return ::nextcode::FullApplySite::getFromOpaqueValue(
        llvm::DenseMapInfo<void *>::getEmptyKey());
  }
  static ::nextcode::FullApplySite getTombstoneKey() {
    return ::nextcode::FullApplySite::getFromOpaqueValue(
        llvm::DenseMapInfo<void *>::getTombstoneKey());
  }
  static unsigned getHashValue(::nextcode::FullApplySite AS) {
    auto *I = AS.getInstruction();
    return DenseMapInfo<::nextcode::SILInstruction *>::getHashValue(I);
  }
  static bool isEqual(::nextcode::FullApplySite LHS, ::nextcode::FullApplySite RHS) {
    return LHS == RHS;
  }
};
