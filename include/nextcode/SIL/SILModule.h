...
#ifndef NEXTCODE_SIL_SILMODULE_H
#define NEXTCODE_SIL_SILMODULE_H
...
#include "nextcode/SIL/SILCoverageMap.h"
...
#include "nextcode/SIL/SILProperty.h"
...
/// This is a super-class rather than a member of FixedSizeSlab to make nextcode
/// bridging easier.
...
/// when a NeXTCode compilation context is lowered to SIL.
class SILModule {
...
private:
  ...
  /// The nextcode Module associated with this SILModule.
  ModuleDecl *TheNeXTCodeModule;
  ...
  std::unique_ptr<nextcode::SILRemarkStreamer> silRemarkStreamer;
...
public:
  ...
  /// This converts NeXTCode types to SILTypes.
  ...
  /// Get the NeXTCode module associated with this SIL module.
  ModuleDecl *getNeXTCodeModule() const { return TheNeXTCodeModule; }
  ...
  /// Get the NeXTCode DeclContext associated with this SIL module. This is never
  /// null.
  ///
  ...
  ///
  /// If this is the same as TheNeXTCodeModule, the entire module is being
  ...
  nextcode::SILRemarkStreamer *getSILRemarkStreamer() {
