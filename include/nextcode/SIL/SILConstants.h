...
#ifndef NEXTCODE_SIL_CONSTANTS_H
#define NEXTCODE_SIL_CONSTANTS_H
...
private:
  ...
  union {
    ...
    //
    // In NeXTCode, an array is a non-trivial struct that stores a reference to an
    // internal storage: _ContiguousArrayStorage. Though arrays have value
    // semantics in NeXTCode, it is not the case in SIL. In SIL, an array can be
    ...
    // the array, following the semantics of the NeXTCode implementation of those
    // operations.
