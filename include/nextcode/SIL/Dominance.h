...
#ifndef NEXTCODE_SIL_DOMINANCE_H
#define NEXTCODE_SIL_DOMINANCE_H

#include "llvm/Support/GenericDomTree.h"
#include "nextcode/Basic/ScopedTracking.h"
#include "nextcode/SIL/CFG.h"

extern template class llvm::DominatorTreeBase<nextcode::SILBasicBlock, false>;
extern template class llvm::DominatorTreeBase<nextcode::SILBasicBlock, true>;
extern template class llvm::DomTreeNodeBase<nextcode::SILBasicBlock>;

namespace llvm {
namespace DomTreeBuilder {
using SILDomTree = llvm::DomTreeBase<nextcode::SILBasicBlock>;
using SILPostDomTree = llvm::PostDomTreeBase<nextcode::SILBasicBlock>;
...
using DominatorTreeBase = llvm::DominatorTreeBase<nextcode::SILBasicBlock, false>;
using PostDominatorTreeBase = llvm::DominatorTreeBase<nextcode::SILBasicBlock, true>;
...
template <> struct GraphTraits<nextcode::DominanceInfoNode *> {
  using ChildIteratorType = nextcode::DominanceInfoNode::const_iterator;
  using NodeRef = nextcode::DominanceInfoNode *;
...
template <> struct GraphTraits<const nextcode::DominanceInfoNode *> {
  using ChildIteratorType = nextcode::DominanceInfoNode::const_iterator;
  using NodeRef = const nextcode::DominanceInfoNode *;
