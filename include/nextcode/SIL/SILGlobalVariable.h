...
#ifndef NEXTCODE_SIL_SILGLOBALVARIABLE_H
#define NEXTCODE_SIL_SILGLOBALVARIABLE_H
...
template <>
struct ilist_traits<::nextcode::SILGlobalVariable> :
public ilist_node_traits<::nextcode::SILGlobalVariable> {
  using SILGlobalVariable = ::nextcode::SILGlobalVariable;
