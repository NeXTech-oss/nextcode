...
#ifndef NEXTCODE_SILOPTIMIZER_UTILS_PRUNEDLIVENESS_H
#define NEXTCODE_SILOPTIMIZER_UTILS_PRUNEDLIVENESS_H
...
struct LiveRangeSummary {
  ...
  void meet(const InnerBorrowKind lhs) {
    innerBorrowKind = nextcode::meet(innerBorrowKind, lhs);
  }
  void meet(const AddressUseKind lhs) {
    addressUseKind = nextcode::meet(addressUseKind, lhs);
  }
