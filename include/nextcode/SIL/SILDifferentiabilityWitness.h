...
#ifndef NEXTCODE_SIL_SILDIFFERENTIABILITYWITNESS_H
#define NEXTCODE_SIL_SILDIFFERENTIABILITYWITNESS_H
...
template <>
struct ilist_traits<::nextcode::SILDifferentiabilityWitness>
    : public ilist_node_traits<::nextcode::SILDifferentiabilityWitness> {
  using SILDifferentiabilityWitness = ::nextcode::SILDifferentiabilityWitness;
...
#endif // NEXTCODE_SIL_SILDIFFERENTIABILITYWITNESS_H
