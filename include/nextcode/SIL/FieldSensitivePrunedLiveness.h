...
#ifndef NEXTCODE_SIL_FIELDSENSITIVEPRUNTEDLIVENESS_H
#define NEXTCODE_SIL_FIELDSENSITIVEPRUNTEDLIVENESS_H
...
private:
  ...
  NEXTCODE_ASSERT_ONLY_DECL(bool seenUse = false);
...
public:
  ...
  void clear() {
    ...
    NEXTCODE_ASSERT_ONLY(seenUse = false);
  }
