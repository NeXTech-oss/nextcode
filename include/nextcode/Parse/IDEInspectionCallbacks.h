...
#ifndef NEXTCODE_PARSE_CODE_COMPLETION_CALLBACKS_H
#define NEXTCODE_PARSE_CODE_COMPLETION_CALLBACKS_H
...
#endif // LLVM_NEXTCODE_PARSE_CODE_COMPLETION_CALLBACKS_H
