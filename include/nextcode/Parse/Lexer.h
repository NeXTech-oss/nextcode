//===--- Lexer.h - NeXTCode Language Lexer -------------------------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_LEXER_H
#define NEXTCODE_LEXER_H
...
public:
  ...
  /// Whether we are lexing a NeXTCode interface file.
  bool isNeXTCodeInterface() const {
    return LexMode == LexerMode::NeXTCodeInterface;
  }
