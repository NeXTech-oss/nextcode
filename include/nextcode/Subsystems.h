//===--- Subsystems.h - NeXTCode Compiler Subsystem Entrypoints ----*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_SUBSYSTEMS_H
#define NEXTCODE_SUBSYSTEMS_H
...
namespace nextcode {
  ...
  /// to C/C++ objects and for pointers that were generated by NeXTCode and passed
  ...
  /// Turn the given NeXTCode module into LLVM IR and return the generated module.
  ...
  /// Turn the given NeXTCode file into LLVM IR and return the generated module.
  /// To compile and output the generated code, call \c performLLVM.
  GeneratedModule
  ...
  /// the NeXTCode LLVM Pipeline upon it. This will include the emission of LLVM IR
  ...
  /// Wrap a serialized module inside a nextcode AST section in an object file.
  void createNeXTCodeModuleObjectFile(SILModule &SILMod, StringRef Buffer,
