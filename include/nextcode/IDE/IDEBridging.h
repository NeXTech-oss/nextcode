...
#ifndef NEXTCODE_IDE_IDEBRIDGING
#define NEXTCODE_IDE_IDEBRIDGING
...
struct ResolvedLoc {
  ...
  nextcode::CharSourceRange range;
  ...
  ///
  /// See documentation on `DeclNameLocation.Argument` in nextcode-syntax for more
  /// background.
  ...
  ResolvedLoc(nextcode::CharSourceRange range,
              std::vector<nextcode::CharSourceRange> labelRanges,
              std::optional<unsigned> firstTrailingLabel,
