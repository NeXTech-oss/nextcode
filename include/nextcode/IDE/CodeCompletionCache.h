...
#ifndef NEXTCODE_IDE_CODE_COMPLETIONCACHE_H
#define NEXTCODE_IDE_CODE_COMPLETIONCACHE_H

#include "nextcode/Basic/ThreadSafeRefCounted.h"
...
namespace llvm {
template<>
struct DenseMapInfo<nextcode::ide::CodeCompletionCache::Key> {
  using KeyTy = nextcode::ide::CodeCompletionCache::Key;
...
#endif // NEXTCODE_IDE_CODE_COMPLETIONCACHE_H
