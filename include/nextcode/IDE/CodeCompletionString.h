...
#ifndef NEXTCODE_IDE_CODECOMPLETIONSTRING_H
#define NEXTCODE_IDE_CODECOMPLETIONSTRING_H
...
class CodeCompletionStringChunk {
  friend class nextcode::ide::CodeCompletionResultBuilder;
...
public:
  enum class ChunkKind {
    ...
    /// The keyword part of a declaration before the name, like "function".
    DeclIntroducer,
...
#endif // NEXTCODE_IDE_CODECOMPLETIONSTRING_H
