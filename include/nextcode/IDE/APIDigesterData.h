...
#ifndef NEXTCODE_IDE_APIDIGESTERDATA_H
#define NEXTCODE_IDE_APIDIGESTERDATA_H
...
/// nextcode-api-digester. This struct also handles the serialization and
...
struct APIDiffItemStore {
  ...
  /// Add a path of a JSON file dumped from nextcode-api-digester that contains
...
#endif // NEXTCODE_IDE_APIDIGESTERDATA_H
