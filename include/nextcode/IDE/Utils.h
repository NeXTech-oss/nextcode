...
#ifndef NEXTCODE_IDE_UTILS_H
#define NEXTCODE_IDE_UTILS_H
...
/// Entry point to run the NameMatcher written in nextcode-syntax.
///
/// - Parameters:
///   - sourceFile: The source file from which to load the NeXTCodeSyntax tree
