...
#ifndef NEXTCODE_LOCALIZATIONFORMAT_H
#define NEXTCODE_LOCALIZATIONFORMAT_H
...
public:
  ...
  using external_key_type = nextcode::DiagID;
...
public:
  ...
  ///                    identifier.
  void insert(nextcode::DiagID id, llvm::StringRef translation);
...
public:
  ...
  virtual llvm::StringRef getMessageOr(nextcode::DiagID id,
...
protected:
  ...
  virtual llvm::StringRef getMessage(nextcode::DiagID id) const = 0;
};
...
public:
  ...
  void forEachAvailable(
      llvm::function_ref<void(nextcode::DiagID, llvm::StringRef)> callback);

protected:
  bool initializeImpl() override;
  llvm::StringRef getMessage(nextcode::DiagID id) const override;
