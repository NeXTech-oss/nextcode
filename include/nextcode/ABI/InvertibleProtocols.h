...
#ifndef NEXTCODE_ABI_INVERTIBLEPROTOCOLS_H
#define NEXTCODE_ABI_INVERTIBLEPROTOCOLS_H
...
#include "nextcode/ABI/InvertibleProtocols.def"
  ...
  ///
  /// This can occur when an older NeXTCode runtime is working with metadata
  /// or mangled names generated by a newer compiler that has introduced
  /// another kind of invertible protocol. The NeXTCode runtime will need to
...
#endif // NEXTCODE_ABI_INVERTIBLEPROTOCOLS_H
