...
// generated or in the NeXTCode runtime) how to lay out, copy, move, and
...
#ifndef NEXTCODE_ABI_VALUEWITNESSTABLE_H
#define NEXTCODE_ABI_VALUEWITNESSTABLE_H
...
/// Three pointers is a sweet spot for NeXTCode, because it means we can
...
#define FUNCTION_VALUE_WITNESS(lowerId, upperId, returnType, paramTypes) \
  ...
  __ptrauth_nextcode_value_witness_function_pointer( \
