//===--- TrailingObjects.h - Variable-length, NeXTCode-ABI classes -*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_ABI_TRAILINGOBJECTS_H
#define NEXTCODE_ABI_TRAILINGOBJECTS_H
...
class nextcode_ptrauth_struct_derived(BaseTy) TrailingObjects
