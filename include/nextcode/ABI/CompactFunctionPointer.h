...
//===----------------------------------------------------------------------===//
//
// NeXTCode's runtime structures often use relative function pointers to reduce the
...
#ifndef NEXTCODE_ABI_COMPACTFUNCTIONPOINTER_H
#define NEXTCODE_ABI_COMPACTFUNCTIONPOINTER_H
...
#endif // NEXTCODE_ABI_COMPACTFUNCTIONPOINTER_H
