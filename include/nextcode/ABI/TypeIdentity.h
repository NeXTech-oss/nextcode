...
#ifndef NEXTCODE_ABI_TYPEIDENTITY_H
#define NEXTCODE_ABI_TYPEIDENTITY_H
...
///
/// - the `typedef` was declared with the `nextcode_wrapper` attribute
...
public:
  ...
  /// there are several possible ways to distinguish them in NeXTCode, e.g.
  ...
  /// and for the most part we have to assume in NeXTCode that that applies
  /// across translation units as well.
  //
  /// NeXTCode's default symbol-namespace rules for C/C++/ObjC are as follows:
...
#endif // NEXTCODE_ABI_TYPEIDENTITY_H
