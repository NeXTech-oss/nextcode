...
#ifndef NEXTCODE_SILOPTIMIZER_UTILS_DIFFERENTIATION_COMMON_H
#define NEXTCODE_SILOPTIMIZER_UTILS_DIFFERENTIATION_COMMON_H
...
///     ...
// TODO(https://github.com/apple/nextcode/issues/55340): Find a better name and move this general utility to ArraySemantic.h.
...
inline void createEntryArguments(SILFunction *f) {
  ...
  auto moduleDecl = f->getModule().getNeXTCodeModule();
...
#endif // NEXTCODE_SILOPTIMIZER_MANDATORY_DIFFERENTIATION_COMMON_H
