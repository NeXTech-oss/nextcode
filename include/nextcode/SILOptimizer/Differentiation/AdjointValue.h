...
#ifndef NEXTCODE_SILOPTIMIZER_UTILS_DIFFERENTIATION_ADJOINTVALUE_H
#define NEXTCODE_SILOPTIMIZER_UTILS_DIFFERENTIATION_ADJOINTVALUE_H
...
public:
  ...
  CanType getNeXTCodeType() const { return getType().getASTType(); }
  ...
  NominalTypeDecl *getAnyNominal() const {
    return getNeXTCodeType()->getAnyNominal();
  }
...
#endif // NEXTCODE_SILOPTIMIZER_UTILS_DIFFERENTIATION_ADJOINTVALUE_H
