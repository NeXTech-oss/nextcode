...
#ifndef NEXTCODE_SILOPTIMIZER_UTILS_CANONICALOSSALIFETIME_H
#define NEXTCODE_SILOPTIMIZER_UTILS_CANONICALOSSALIFETIME_H
...
public:
  ...
  NEXTCODE_ASSERT_ONLY_DECL(void dump() const LLVM_ATTRIBUTE_USED);
};
