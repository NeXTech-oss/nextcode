...
#ifndef NEXTCODE_SILOPTIMIZER_ANALYSIS_CALLERANALYSIS_H
#define NEXTCODE_SILOPTIMIZER_ANALYSIS_CALLERANALYSIS_H
...
///
/// Originally, nextcode had an eagerly recomputed caller analysis. This was found
...
public:
  ...
  NEXTCODE_DEBUG_DUMPER(print(const char *filePath));
