...
#ifndef NEXTCODE_SILOPTIMIZER_ANALYSIS_REGIONANALYSIS_H
#define NEXTCODE_SILOPTIMIZER_ANALYSIS_REGIONANALYSIS_H
...
operator<<(llvm::raw_ostream &os,
           const nextcode::regionanalysisimpl::RepresentativeValue &value) {
  value.print(os);
  return os;
}

template <>
struct DenseMapInfo<nextcode::regionanalysisimpl::RepresentativeValue> {
  using RepresentativeValue = nextcode::regionanalysisimpl::RepresentativeValue;
