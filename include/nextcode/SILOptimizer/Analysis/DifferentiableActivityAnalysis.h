...
#ifndef NEXTCODE_SILOPTIMIZER_ANALYSIS_DIFFERENTIABLEACTIVITYANALYSIS_H_
#define NEXTCODE_SILOPTIMIZER_ANALYSIS_DIFFERENTIABLEACTIVITYANALYSIS_H_
...
private:
  ...
  bool hasTangentSpace(SILValue value) {
    ...
    auto lookupConformance =
        LookUpConformanceInModule(getFunction().getModule().getNeXTCodeModule());
...
#endif // NEXTCODE_SILOPTIMIZER_ANALYSIS_DIFFERENTIABLEACTIVITYANALYSIS_H_
