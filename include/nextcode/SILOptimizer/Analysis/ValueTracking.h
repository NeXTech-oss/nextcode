...
#ifndef NEXTCODE_SILOPTIMIZER_ANALYSIS_VALUETRACKING_H
#define NEXTCODE_SILOPTIMIZER_ANALYSIS_VALUETRACKING_H
...
/// infrastructure for the NeXTCode compiler.
...
#endif // NEXTCODE_SILOPTIMIZER_ANALYSIS_VALUETRACKING_H
