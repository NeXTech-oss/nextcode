...
#ifndef NEXTCODE_SILOPTIMIZER_ANALYSIS_ARCANALYSIS_H
#define NEXTCODE_SILOPTIMIZER_ANALYSIS_ARCANALYSIS_H
...
public:
  ...
  iterator_range<iterator> getRange() { return nextcode::make_range(begin(), end()); }
