...
#include "nextcode/AST/DependencyCollector.h"
#include "llvm/ADT/DenseMap.h"
#include "llvm/ADT/StringRef.h"

#ifndef NEXTCODE_AST_REQUEST_CACHE_H
#define NEXTCODE_AST_REQUEST_CACHE_H
...
#define NEXTCODE_TYPEID_ZONE(Name, Id)                                            \
...
#include "nextcode/Basic/TypeIDZones.def"
...
public:
  ...
  void clear() {
#define NEXTCODE_TYPEID_ZONE(Name, Id) Name##ZoneCache.clear();
#include "nextcode/Basic/TypeIDZones.def"
#undef NEXTCODE_TYPEID_ZONE
  }
};
...
public:
  ...
  void clear() {
#define NEXTCODE_TYPEID_ZONE(Name, Id) Name##ZoneRefs.clear();
#include "nextcode/Basic/TypeIDZones.def"
#undef NEXTCODE_TYPEID_ZONE
  }
};
...
struct DenseMapInfo<nextcode::evaluator::RequestKey<Request, Info>> {
  using RequestKey = nextcode::evaluator::RequestKey<Request, Info>;
...
#endif // NEXTCODE_AST_REQUEST_CACHE_H
