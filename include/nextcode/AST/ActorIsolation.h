...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_AST_ACTORISOLATIONSTATE_H
#define NEXTCODE_AST_ACTORISOLATIONSTATE_H
...
public:
  ...
  // Defined out of line to prevent linker errors since libnextcodeBasic would
  // include this header exascerbating a layering violation where libnextcodeBasic
  // depends on libnextcodeAST.
  NEXTCODE_DEBUG_DUMPER(dumpForDiagnostics());
};
...
inline llvm::raw_ostream &operator<<(llvm::raw_ostream &os,
                                     const nextcode::ActorIsolation &other) {
  other.print(os);
  return os;
}
...
#endif /* NEXTCODE_AST_ACTORISOLATIONSTATE_H */
