//===--- AccessScope.h - NeXTCode Access Scope ---------------------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_ACCESSSCOPE_H
#define NEXTCODE_ACCESSSCOPE_H
...
public:
  ...
  /// Check if private access is allowed. This is a lexical scope check in NeXTCode
  /// 3 mode. In NeXTCode 4 mode, declarations and extensions of the same type will
  /// also allow access.
