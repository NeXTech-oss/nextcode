...
#ifndef NEXTCODE_AST_PRINTOPTIONS_H
#define NEXTCODE_AST_PRINTOPTIONS_H
...
struct PrintOptions {
  ...
  /// Print NeXTCode.Array and NeXTCode.Optional with sugared syntax
  ...
  bool SkipNeXTCodePrivateClangDecls = false;
  ...
  bool IsForNeXTCodeInterface = false;
  ...
  // [TODO: Clang-type-plumbing] Print the full type in the nextcodeinterface.
  ...
  /// Whether to print feature checks for compatibility with older NeXTCode
  ...
  nextcode::BracketOptions BracketOptions;
  ...
  static PrintOptions printInterface(bool printFullConvention) {
    ...
    result.SkipNeXTCodePrivateClangDecls = true;
  ...
  static PrintOptions printNeXTCodeInterfaceFile(ModuleDecl *ModuleToPrint,
                                              bool preferTypeRepr,
                                              bool printFullConvention,
  ...
  /// nextcode file.
  static PrintOptions printNeXTCodeFileInterface(bool printFullConvention) {
    PrintOptions result = printInterface(printFullConvention);
    result.AccessFilter = AccessLevel::Internal;
    result.EmptyLineBetweenDecls = true;
    return result;
...
#endif // LLVM_NEXTCODE_AST_PRINTOPTIONS_H
