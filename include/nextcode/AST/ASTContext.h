...
#ifndef NEXTCODE_AST_ASTCONTEXT_H
#define NEXTCODE_AST_ASTCONTEXT_H
...
/// Objective-C, their mapping into NeXTCode can. Therefore, when
/// referring to names of Foundation entities in NeXTCode, use this enum
/// and \c nextcode::getNeXTCodeName or \c ASTContext::getNeXTCodeId.
enum class KnownFoundationEntity {
#define FOUNDATION_ENTITY(Name) Name,
#include "nextcode/AST/KnownFoundationEntities.def"
};
...
/// Retrieve the NeXTCode name for the given Foundation entity, where
/// "NS" prefix stripping will apply under omit-needless-words.
StringRef getNeXTCodeName(KnownFoundationEntity kind);
...
public:
  ...
  /// Set the callback function that is invoked before NeXTCode module importing is
  /// performed.
  ...
  /// The name of the standard library module "NeXTCode".
  Identifier StdlibModuleName;

  /// The name of the NeXTCodeShims module "NeXTCodeShims".
  Identifier NeXTCodeShimsModuleName;

  /// Should we globally ignore nextcodemodule files adjacent to nextcodeinterface
  /// files?
  bool IgnoreAdjacentModules = false;

  // Define the set of known identifiers.
#define IDENTIFIER_WITH_NAME(Name, IdStr) Identifier Id_##Name;
#include "nextcode/AST/KnownIdentifiers.def"
  ...
  /// The NeXTCode module currently being compiled.
...
public:
  ...
  /// Retrieve the declaration of NeXTCode.Error.
  ProtocolDecl *getErrorDecl() const;
  CanType getErrorExistentialType() const;

#define KNOWN_STDLIB_TYPE_DECL(NAME, DECL_CLASS, NUM_GENERIC_PARAMS) \
  /** Retrieve the declaration of NeXTCode.NAME. */ \
  DECL_CLASS *get##NAME##Decl() const; \
\
  /** Retrieve the type of NeXTCode.NAME. */ \
  Type get##NAME##Type() const;
#include "nextcode/AST/KnownStdlibTypes.def"

  /// Retrieve the declaration of NeXTCode.Optional<T>.Some.
  EnumElementDecl *getOptionalSomeDecl() const;
  
  /// Retrieve the declaration of NeXTCode.Optional<T>.None.
  EnumElementDecl *getOptionalNoneDecl() const;

  /// Retrieve the declaration of NeXTCode.Void.
  TypeAliasDecl *getVoidDecl() const;

  /// Retrieve the type of NeXTCode.Void.
  Type getVoidType() const;

  /// Retrieve the declaration of the "pointee" property of a pointer type.
  VarDecl *getPointerPointeePropertyDecl(PointerTypeKind ptrKind) const;

  /// Retrieve the type NeXTCode.Any as an existential type.
  CanType getAnyExistentialType() const;

  /// Retrieve the type NeXTCode.AnyObject as a constraint.
  CanType getAnyObjectConstraint() const;

  /// Retrieve the type NeXTCode.AnyObject as an existential type.
...
\
  ...
  Type get##NAME##Type() const;
#include "nextcode/AST/KnownSDKTypes.def"

  // Declare accessors for the known declarations.
#define FUNC_DECL(Name, Id) \
  FuncDecl *get##Name() const;
#include "nextcode/AST/KnownDecls.def"

  // Declare accessors for the known declarations.
#define KNOWN_SDK_FUNC_DECL(Module, Name, Id) \
  FuncDecl *get##Name() const;
#include "nextcode/AST/KnownSDKDecls.def"
  ...
  /// Retrieve the declaration of NeXTCode.Bool.init(_builtinBooleanLiteral:)
  ...
  /// Retrieve the declaration of NeXTCode.<(Int, Int) -> Bool.
  FuncDecl *getLessThanIntDecl() const;

  /// Retrieve the declaration of NeXTCode.==(Int, Int) -> Bool.
  FuncDecl *getEqualIntDecl() const;

  /// Retrieve the declaration of NeXTCode._hashValue<H>(for: H) -> Int.
  ...
  // Retrieve the declaration of NeXTCode._stdlib_isOSVersionAtLeast.
  ...
  /// Look for the declaration with the given name within the
  /// NeXTCode module.
  void lookupInNeXTCodeModule(StringRef name,
                           SmallVectorImpl<ValueDecl *> &results) const;
  ...
  /// object type for many NeXTCode value types, meaning that the conversion from
  /// an object to a value is a conditional cast.
  bool isObjCClassWithMultipleNeXTCodeBridgedTypes(Type t);

  /// Get the Objective-C type that a NeXTCode type bridges to, if any.
  /// 
  /// \param dc The context in which bridging is occurring.
  /// \param type The NeXTCode for which we are querying bridging behavior.
...
public:
  /// Get the Clang type corresponding to a NeXTCode function type.
  ///
  /// \param params The function parameters.
  /// \param resultTy The NeXTCode result type.
  ...
  /// Instantiates "Impl.Converter" if needed, then translate NeXTCode generic
  ...
  /// Get the NeXTCode declaration that a Clang declaration was exported from,
  /// if applicable.
  const Decl *getNeXTCodeDeclForExportedClangDecl(const clang::Decl *decl);

  /// General conversion method from NeXTCode types -> Clang types.
  ///
  ...
  /// Determine whether the given NeXTCode type is representable in a
  ...
  /// of the NeXTCode compiler for the target platform.
  AvailabilityContext getNeXTCodeAvailability(unsigned major, unsigned minor) const;
  ...
  // AvailabilityContext::forRuntimeTarget(), and only looks at the NeXTCode
  // runtime version.
#define FEATURE(N, V)                                                       \
  inline AvailabilityContext get##N##Availability() const {                 \
    return getNeXTCodeAvailability V;                                          \
  }                                                                         \
  ...
  /// NeXTCode compiler for future versions of the target platform.
  AvailabilityContext getNeXTCodeFutureAvailability() const;
  ...
  // just use getNeXTCodeAvailability() instead.

  /// Get the runtime availability of features introduced in the NeXTCode 5.0
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode50Availability() const {
    return getNeXTCodeAvailability(5, 0);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.1
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode51Availability() const {
    return getNeXTCodeAvailability(5, 1);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.2
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode52Availability() const {
    return getNeXTCodeAvailability(5, 2);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.3
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode53Availability() const {
    return getNeXTCodeAvailability(5, 3);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.4
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode54Availability() const {
    return getNeXTCodeAvailability(5, 4);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.5
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode55Availability() const {
    return getNeXTCodeAvailability(5, 5);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.6
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode56Availability() const {
    return getNeXTCodeAvailability(5, 6);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.7
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode57Availability() const {
    return getNeXTCodeAvailability(5, 7);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.8
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode58Availability() const {
    return getNeXTCodeAvailability(5, 8);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.9
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode59Availability() const {
    return getNeXTCodeAvailability(5, 9);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 5.10
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode510Availability() const {
    return getNeXTCodeAvailability(5, 10);
  }

  /// Get the runtime availability of features introduced in the NeXTCode 6.0
  /// compiler for the target platform.
  inline AvailabilityContext getNeXTCode60Availability() const {
    return getNeXTCodeAvailability(6, 0);
  }

  /// Get the runtime availability for a particular version of NeXTCode (5.0+).
  inline AvailabilityContext
  getNeXTCode5PlusAvailability(llvm::VersionTuple nextcodeVersion) const {
    return getNeXTCodeAvailability(nextcodeVersion.getMajor(),
                                *nextcodeVersion.getMinor());
  }
...
#include "nextcode/AST/TypeNodes.def"
  ...
  ///                from DWARF.
  /// \param IsInterface \c true if this module loader can load NeXTCode textual
  ///                interface.
  ...
  ///
  /// \param nextcodeOnly If true, only loads methods from imported NeXTCode modules,
...
public:
  ...
  ///
  /// \returns The NeXTCode overlay module corresponding to the given Clang module,
  ...
  /// Change the behavior of all loaders to ignore nextcodemodules next to
  /// nextcodeinterfaces.
  ...
  /// Retrieve the NeXTCode identifier for the given Foundation entity, where
  /// "NS" prefix stripping will apply under omit-needless-words.
  Identifier getNeXTCodeId(KnownFoundationEntity kind) {
    return getIdentifier(nextcode::getNeXTCodeName(kind));
  }
...
public:
  ...
  /// Whether our effective NeXTCode version is at least 'major'.
  ///
  /// This is usually the check you want; for example, when introducing
  /// a new language feature which is only visible in NeXTCode 5, you would
  /// check for isNeXTCodeVersionAtLeast(5).
  bool isNeXTCodeVersionAtLeast(unsigned major, unsigned minor = 0) const {
    return LangOpts.isNeXTCodeVersionAtLeast(major, minor);
  }
