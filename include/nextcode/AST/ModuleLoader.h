...
#ifndef NEXTCODE_AST_MODULE_LOADER_H
#define NEXTCODE_AST_MODULE_LOADER_H
...
public:
  ...
  /// Fetches the list of dependencies that are known to have incremental nextcode
  /// dependency information embedded inside of them.
  ArrayRef<IncrementalDependency> getIncrementalDependencies() const;

  /// A view of the paths of the dependencies known to have incremental nextcode
  /// dependency information embedded inside of them.
...
namespace llvm {
template <>
struct DenseMapInfo<nextcode::DependencyTracker::MacroPluginDependency> {
  using MacroPluginDependency = nextcode::DependencyTracker::MacroPluginDependency;

  static MacroPluginDependency getEmptyKey() {
    return {DenseMapInfo<nextcode::Identifier>::getEmptyKey(), ""};
  }

  static MacroPluginDependency getTombstoneKey() {
    return {DenseMapInfo<nextcode::Identifier>::getTombstoneKey(), ""};
  }
