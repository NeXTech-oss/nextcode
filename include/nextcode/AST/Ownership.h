//===--- Ownership.h - NeXTCode ASTs for Ownership ---------------*- C++ -*-===//
//
/*
...
// reference ownership supported by NeXTCode, such as 'weak' and 'unowned', as well
// as the different kinds of value ownership, such as 'inout' and '__shared'.
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_OWNERSHIP_H
#define NEXTCODE_OWNERSHIP_H
...
/// Different kinds of reference ownership supported by NeXTCode.
...
/// Different kinds of value ownership supported by NeXTCode.
///
