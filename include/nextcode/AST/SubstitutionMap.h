//===--- SubstitutionMap.h - NeXTCode Substitution Map ASTs --------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_AST_SUBSTITUTION_MAP_H
#define NEXTCODE_AST_SUBSTITUTION_MAP_H
...
namespace llvm {
  template <>
  struct PointerLikeTypeTraits<nextcode::SubstitutionMap> {
    static void *getAsVoidPointer(nextcode::SubstitutionMap map) {
      return const_cast<void *>(map.getOpaqueValue());
    }
    static nextcode::SubstitutionMap getFromVoidPointer(const void *ptr) {
      return nextcode::SubstitutionMap::getFromOpaqueValue(ptr);
    }
  ...
  template<> struct DenseMapInfo<nextcode::SubstitutionMap> {
    static nextcode::SubstitutionMap getEmptyKey() {
      return nextcode::SubstitutionMap::getEmptyKey();
    }
    static nextcode::SubstitutionMap getTombstoneKey() {
      return nextcode::SubstitutionMap::getTombstoneKey();
    }
    static unsigned getHashValue(nextcode::SubstitutionMap map) {
      return DenseMapInfo<void*>::getHashValue(map.getOpaqueValue());
    }
    static bool isEqual(nextcode::SubstitutionMap lhs,
                        nextcode::SubstitutionMap rhs) {
