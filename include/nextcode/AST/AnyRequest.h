...
#ifndef NEXTCODE_AST_ANYREQUEST_H
#define NEXTCODE_AST_ANYREQUEST_H
...
namespace llvm {
  template<>
  struct DenseMapInfo<nextcode::ActiveRequest> {
    using ActiveRequest = nextcode::ActiveRequest;
...
#endif // NEXTCODE_AST_ANYREQUEST_H
