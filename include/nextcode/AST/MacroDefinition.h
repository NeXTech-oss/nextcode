//===--- MacroDefinition.h - NeXTCode Macro Definition -------------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_AST_MACRO_DEFINITION_H
#define NEXTCODE_AST_MACRO_DEFINITION_H
...
#endif // NEXTCODE_AST_MACRO_DEFINITION_H
