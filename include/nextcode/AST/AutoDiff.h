//===--- AutoDiff.h - NeXTCode automatic differentiation utilities -----------===//
//
/*
...
#ifndef NEXTCODE_AST_AUTODIFF_H
#define NEXTCODE_AST_AUTODIFF_H
...
struct AutoDiffConfig {
  ...
  // TODO(https://github.com/apple/nextcode/issues/52204): Use principled mangling for AD-generated symbols.
...
using nextcode::AutoDiffConfig;
using nextcode::AutoDiffDerivativeFunctionKind;
using nextcode::CanGenericSignature;
using nextcode::GenericSignature;
using nextcode::IndexSubset;
using nextcode::SILAutoDiffDerivativeFunctionKey;
using nextcode::SILFunctionType;
using nextcode::DifferentiabilityKind;
using nextcode::SILDifferentiabilityWitnessKey;
