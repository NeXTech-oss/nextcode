...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_TYPE_CHECK_REQUESTS_H
#define NEXTCODE_TYPE_CHECK_REQUESTS_H
...
#include "nextcode/AST/CatchNode.h"
...
/// by error. This applies only to pre-NeXTCode 6 mode.
...
#include "nextcode/AST/TypeCheckerTypeIDZone.def"
#undef NEXTCODE_REQUEST

} // end namespace nextcode

#endif // NEXTCODE_TYPE_CHECK_REQUESTS_H
