...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_AST_REQUIREMENTMATCH_H
#define NEXTCODE_AST_REQUIREMENTMATCH_H

#include "nextcode/AST/RequirementEnvironment.h"
...
struct RequirementMatch {
  ...
  nextcode::Witness getWitness(ASTContext &ctx) const {
    return nextcode::Witness(this->Witness, WitnessSubstitutions,
...
#endif // NEXTCODE_AST_REQUIREMENTMATCH_H
