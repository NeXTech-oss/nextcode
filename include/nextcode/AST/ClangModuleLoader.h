...
#ifndef NEXTCODE_AST_CLANG_MODULE_LOADER_H
#define NEXTCODE_AST_CLANG_MODULE_LOADER_H

#include "nextcode/AST/ModuleLoader.h"
#include "nextcode/AST/SubstitutionMap.h"
#include "nextcode/Basic/TaggedUnion.h"
...
public:
  ...
  bool isNeXTCodeDecl() const { return Union.isa<const Decl*>(); }
  const Decl *getNeXTCodeDecl() const {
    assert(isNeXTCodeDecl());
...
public:
  ...
  virtual void dumpNeXTCodeLookupTables() const = 0;
...
#endif // LLVM_NEXTCODE_AST_CLANG_MODULE_LOADER_H
