...
#ifndef NEXTCODE_AST_SEARCHPATHOPTIONS_H
#define NEXTCODE_AST_SEARCHPATHOPTIONS_H
...
public:
  ...
  /// rebuild PCMs and compiled nextcodemodules that depend on them, just like it
  ...
  /// A map of explicit NeXTCode module information.
  std::string ExplicitNeXTCodeModuleMapPath;

  /// Module inputs specified with -nextcode-module-input,
  /// <ModuleName, Path to .codemodule file>
  std::vector<std::pair<std::string, std::string>> ExplicitNeXTCodeModuleInputs;

  /// A map of placeholder NeXTCode module dependency information.
