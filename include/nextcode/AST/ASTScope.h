//===--- ASTScopeImpl.h - NeXTCode AST Object-Oriented Scope --------*- C++-*-===//
//
/*
...
/// describes the scopes that exist within a NeXTCode AST.
///
...
///
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_AST_AST_SCOPE_H
#define NEXTCODE_AST_AST_SCOPE_H
...
#endif // NEXTCODE_AST_AST_SCOPE_H
