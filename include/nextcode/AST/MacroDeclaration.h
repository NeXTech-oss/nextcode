//===--- MacroDeclaration.h - NeXTCode Macro Declaration -----------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_AST_MACRO_DECLARATION_H
#define NEXTCODE_AST_MACRO_DECLARATION_H
...
#endif // NEXTCODE_AST_MACRO_DECLARATION_H
