//===--- ASTMangler.h - NeXTCode AST symbol mangling ---------------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_AST_ASTMANGLER_H
#define NEXTCODE_AST_ASTMANGLER_H
...
protected:
  ...
  /// If enabled, use Objective-C runtime names when mangling @objc NeXTCode
...
public:
  ...
  /// predefined in the NeXTCode runtime for the given type signature.
...
#endif // NEXTCODE_AST_ASTMANGLER_H
