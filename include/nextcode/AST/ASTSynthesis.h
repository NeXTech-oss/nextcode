//===--- ASTSynthesis.h - Convenient NeXTCode AST synthesis --------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_ASTSYNTHESIS_H
#define NEXTCODE_ASTSYNTHESIS_H
...
inline Type synthesizeType(SynthesisContext &SC,
  ...
  case _word: return BuiltinIntegerType::get(BuiltinIntegerWidth::pointer(),
                                             SC.Context);
  case _nextcodeInt: return SC.Context.getIntType();
...
inline ASTExtInfo synthesizeExtInfo(SynthesisContext &SC,
  ...
  case _thick: return ASTExtInfo().withRepresentation(
                                           FunctionTypeRepresentation::NeXTCode);
  }
}
template <class S>
