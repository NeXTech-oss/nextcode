//===--- TypeRefinementContext.h - NeXTCode Refinement Context -----*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_TYPEREFINEMENTCONTEXT_H
#define NEXTCODE_TYPEREFINEMENTCONTEXT_H

#include "nextcode/AST/Identifier.h"
#include "nextcode/AST/Availability.h"
#include "nextcode/AST/Stmt.h" // for PoundAvailableInfo
...
public:
  ...
  NEXTCODE_DEBUG_DUMPER(dump(SourceManager &SrcMgr));
