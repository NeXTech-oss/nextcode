...
#ifndef NEXTCODE_AST_FILEUNIT_H
#define NEXTCODE_AST_FILEUNIT_H
...
public:
  ...
  /// For a serialized AST file, returns \c true if an adjacent nextcodedoc has been
  /// loaded. Otherwise, returns \c false.
  virtual bool hasLoadedNeXTCodeDoc() const { return false; }
  ...
  /// imported NeXTCode module. NeXTCode modules built from source do not apply
  /// their own `-export-as` flag, this way the nextcodeinterface can be
  /// verified.
...
public:
  ...
  /// Returns the NeXTCode module that overlays a Clang module.
