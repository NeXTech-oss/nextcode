...
#ifndef NEXTCODE_AST_EVALUATOR_DEPENDENCIES_H
#define NEXTCODE_AST_EVALUATOR_DEPENDENCIES_H

#include "nextcode/AST/AnyRequest.h"
#include "nextcode/AST/DependencyCollector.h"
#include "nextcode/AST/RequestCache.h"
...
using DependencySource = nextcode::NullablePtr<SourceFile>;
...
#endif // NEXTCODE_AST_EVALUATOR_DEPENDENCIES_H
