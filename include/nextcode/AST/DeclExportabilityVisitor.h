//===- DeclExportabilityVisitor.h - NeXTCode Language Context ASTs -*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_DECLEXPORTABILITYVISITOR_H
#define NEXTCODE_DECLEXPORTABILITYVISITOR_H
...
public:
  ...
  bool visitExtensionDecl(const ExtensionDecl *ext) {
    ...
    // Truly empty extensions are exportable. This can occur in nextcodeinterfaces,
    // for example.
