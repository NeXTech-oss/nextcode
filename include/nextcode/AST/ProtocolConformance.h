...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_AST_PROTOCOLCONFORMANCE_H
#define NEXTCODE_AST_PROTOCOLCONFORMANCE_H
...
#include "nextcode/AST/Witness.h"
...
enum class ProtocolConformanceKind : unsigned {
  ...
  /// and isn't implemented directly in NeXTCode.
  Builtin,
...
protected:
  ...
  union { uint64_t OpaqueBits;
    ...
    NEXTCODE_INLINE_BITFIELD_BASE(ProtocolConformance,
                               bitmax(NumProtocolConformanceKindBits, 8),
      /// The kind of protocol conformance.
      Kind : bitmax(NumProtocolConformanceKindBits, 8)
    );

    NEXTCODE_INLINE_BITFIELD_EMPTY(RootProtocolConformance, ProtocolConformance);

    NEXTCODE_INLINE_BITFIELD_FULL(NormalProtocolConformance, RootProtocolConformance,
    ...
    NEXTCODE_INLINE_BITFIELD(BuiltinProtocolConformance, RootProtocolConformance,
...
#endif // LLVM_NEXTCODE_AST_PROTOCOLCONFORMANCE_H
