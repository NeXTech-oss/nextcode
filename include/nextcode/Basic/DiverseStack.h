...
#ifndef NEXTCODE_BASIC_DIVERSESTACK_H
#define NEXTCODE_BASIC_DIVERSESTACK_H
...
namespace llvm {
  ...
  struct PointerLikeTypeTraits<
                      nextcode::DiverseStackBase::stable_iterator::AsPointer> {
    using AsPointer = nextcode::DiverseStackBase::stable_iterator::AsPointer;
  public:
...
#endif // NEXTCODE_BASIC_DIVERSESTACK_H
