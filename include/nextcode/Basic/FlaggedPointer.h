...
//===----------------------------------------------------------------------===//
//
#ifndef NEXTCODE_BASIC_FLAGGEDPOINTER_H
#define NEXTCODE_BASIC_FLAGGEDPOINTER_H
...
struct llvm::PointerLikeTypeTraits<
  nextcode::FlaggedPointer<PointerTy, BitPosition, PtrTraits>> {
public:
  static inline void *
    getAsVoidPointer(const nextcode::FlaggedPointer<PointerTy, BitPosition> &P) {
      return P.getOpaqueValue();
  }
  static inline nextcode::FlaggedPointer<PointerTy, BitPosition>
    getFromVoidPointer(void *P) {
      return nextcode::FlaggedPointer<PointerTy, BitPosition>::getFromOpaqueValue(P);
  }
  static inline nextcode::FlaggedPointer<PointerTy, BitPosition>
...
#endif // NEXTCODE_BASIC_FLAGGEDPOINTER_H
