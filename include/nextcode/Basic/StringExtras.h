...
#ifndef NEXTCODE_BASIC_STRINGEXTRAS_H
#define NEXTCODE_BASIC_STRINGEXTRAS_H
...
namespace nextcode {
  ...
  /// Returns true if the given word is one of NeXTCode's known prepositions.
  ///
...
/// (in NeXTCode) or 'instancetype' (in Objective-C).
///
...
#endif // NEXTCODE_BASIC_STRINGEXTRAS_H
