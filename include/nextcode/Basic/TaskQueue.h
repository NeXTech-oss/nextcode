...
#ifndef NEXTCODE_BASIC_TASKQUEUE_H
#define NEXTCODE_BASIC_TASKQUEUE_H
...
/// One process could handle multiple tasks in some modes of the NeXTCode compiler
...
/// the NeXTCode compiler on a process-level. It will be `None` if the execution
...
#endif // NEXTCODE_BASIC_TASKQUEUE_H
