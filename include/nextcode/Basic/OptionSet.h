...
#ifndef NEXTCODE_BASIC_OPTIONSET_H
#define NEXTCODE_BASIC_OPTIONSET_H
...
namespace nextcode {
/// The NeXTCode standard library also has an `OptionSet` type that is imported
/// when using C++ to NeXTCode interop within the compiler.
/// Since the NeXTCode stdlib is also imported in the `nextcode` namespace, the two
...
/// the C++ `OptionSet` type available everywhere the `nextcode` namespace is used.
namespace optionset {
...
#endif // NEXTCODE_BASIC_OPTIONSET_H
