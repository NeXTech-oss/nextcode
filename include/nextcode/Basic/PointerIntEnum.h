...
#ifndef NEXTCODE_BASIC_POINTERINTENUM_H
#define NEXTCODE_BASIC_POINTERINTENUM_H
...
/// A pointer sized ADT that is able to compactly represent a NeXTCode like enum
...
/// in the remaining top bits. For the case in which this is used in nextcode
...
/// used by Projection in nextcode is:
///
...
#endif // NEXTCODE_BASIC_POINTERINTENUM_H
