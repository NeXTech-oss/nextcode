...
#ifndef NEXTCODE_BASIC_JSONSERIALIZATION_H
#define NEXTCODE_BASIC_JSONSERIALIZATION_H
...
// and it is used to define nextcode::sys::ProcessId.
template<>
...
inline
typename
std::enable_if<nextcode::json::has_ObjectTraits<T>::value, Output &>::type
...
inline
typename
std::enable_if<nextcode::json::has_ArrayTraits<T>::value, Output &>::type
...
#endif // NEXTCODE_BASIC_JSONSERIALIZATION_H
