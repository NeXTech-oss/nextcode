...
#ifndef NEXTCODE_BASIC_STATISTIC_H
#define NEXTCODE_BASIC_STATISTIC_H
...
#define NEXTCODE_FUNC_STAT NEXTCODE_FUNC_STAT_NAMED(DEBUG_TYPE)

#define NEXTCODE_FUNC_STAT_NAMED(DEBUG_TYPE)                               \
  do {                                                                  \
...
// across nextcode compilations that typically invoke many drivers, each running
...
//    - Calls nextcode::enableCompilationTimers()
...
// There are a handful of cases where the nextcode compiler can introduce
...
// the upper-level files (in libnextcodeAST or libnextcodeSIL), and provide tracing
...
#endif // NEXTCODE_BASIC_STATISTIC_H
