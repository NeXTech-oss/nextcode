...
#ifndef NEXTCODE_BASIC_ASSERTIONS_H
#define NEXTCODE_BASIC_ASSERTIONS_H
...
#define NEXTCODE_ASSERT_ONLY_DECL DEBUG_ASSERT_DECL
#define NEXTCODE_ASSERT_ONLY DEBUG_ASSERT_EXPR
...
#endif // NEXTCODE_BASIC_ASSERTIONS_H
