...
/// \file
///
/// Some data structures emitted by the NeXTCode compiler use relative indirect
...
/// initialized.
///
/// In NeXTCode, we always prefer to use a near direct relative reference
...
///
/// In general, it's our preference in NeXTCode to use option #4 when there
...
#ifndef NEXTCODE_BASIC_RELATIVEPOINTER_H
#define NEXTCODE_BASIC_RELATIVEPOINTER_H
...
#if NEXTCODE_COMPACT_ABSOLUTE_FUNCTION_POINTER
...
#endif // NEXTCODE_BASIC_RELATIVEPOINTER_H
