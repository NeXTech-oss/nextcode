...
#ifndef NEXTCODE_BASIC_FILETYPES_H
#define NEXTCODE_BASIC_FILETYPES_H
...
/// Returns true if the type is a file that contributes to the NeXTCode module
/// being compiled.
///
/// These need to be passed to the NeXTCode frontend
bool isPartOfNeXTCodeCompilation(ID Id);
...
namespace llvm {
template <> struct DenseMapInfo<nextcode::file_types::ID> {
  using ID = nextcode::file_types::ID;
