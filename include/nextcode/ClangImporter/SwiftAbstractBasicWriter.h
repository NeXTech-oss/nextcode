//===- NeXTCodeAbstractBasicWriter.h - Clang serialization adapter -*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_CLANGIMPORTER_NEXTCODEABSTRACTBASICWRITER_H
#define NEXTCODE_CLANGIMPORTER_NEXTCODEABSTRACTBASICWRITER_H
...
/// An implementation of Clang's AbstractBasicWriter interface for a NeXTCode
/// datastream-based reader.  This is paired with the AbstractBasicReader
/// implementation in NeXTCodeAbstractBasicReader.h.  Note that the general
