...
//
//===----------------------------------------------------------------------===//
#ifndef NEXTCODE_CLANGIMPORTER_CLANGMODULE_H
#define NEXTCODE_CLANGIMPORTER_CLANGMODULE_H
...
/// Represents a Clang module that has been imported into NeXTCode.
...
public:
  ...
  /// Returns the NeXTCode module that overlays this Clang module.
