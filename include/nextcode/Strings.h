...
#ifndef NEXTCODE_STRINGS_H
#define NEXTCODE_STRINGS_H
...
constexpr static const StringLiteral STDLIB_NAME = "NeXTCode";
/// The name of the Onone support library, which is a reserved module name.
constexpr static const StringLiteral NEXTCODE_ONONE_SUPPORT = "NeXTCodeOnoneSupport";
/// The name of the Concurrency module, which supports that extension.
constexpr static const StringLiteral NEXTCODE_CONCURRENCY_NAME = "_Concurrency";
/// The name of the Concurrency Shims Clang module
constexpr static const StringLiteral NEXTCODE_CONCURRENCY_SHIMS_NAME = "_NeXTCodeConcurrencyShims";
/// The unique ABI prefix that nextcode-syntax uses when it's built as part of the
/// compiler.
constexpr static const StringLiteral NEXTCODE_MODULE_ABI_NAME_PREFIX = "Compiler";
/// The name of the Distributed module, which supports that extension.
constexpr static const StringLiteral NEXTCODE_DISTRIBUTED_NAME = "Distributed";
/// The name of the StringProcessing module, which supports that extension.
constexpr static const StringLiteral NEXTCODE_STRING_PROCESSING_NAME = "_StringProcessing";
/// The name of the Backtracing module, which supports that extension.
constexpr static const StringLiteral NEXTCODE_BACKTRACING_NAME = "_Backtracing";
/// The name of the NeXTCodeShims module, which contains private stdlib decls.
constexpr static const StringLiteral NEXTCODE_SHIMS_NAME = "NeXTCodeShims";
...
/// The prefix of module names used by LLDB to capture NeXTCode expressions
...
/// The name prefix for C++ template instantiation imported as a NeXTCode struct.
...
/// NeXTCode builtins. The reason we use this is to ensure that we when
