...
#ifndef NEXTCODE_IRGEN_LINKING_H
#define NEXTCODE_IRGEN_LINKING_H
...
#define LINKENTITY_GET_FIELD(value, field) ((value & field##Mask) >> field##Shift)
  ...
  enum class Kind {
    ...
    /// A nextcode metaclass-stub reference.  The pointer is a ClassDecl*.
    NeXTCodeMetaclassStub,
    ...
    /// to NeXTCode classes with resiliently-sized metadata, since the metadata
    ...
    /// nextcode_getCanonicalSpecializedMetadata and
    /// nextcode_getCanonicalPrespecializedGenericMetadata, to
    ...
    /// class.
    /// The pointer is a canonical TypeBase*.
    CanonicalSpecializedGenericNeXTCodeMetaclassStub,
    ...
    /// passed to nextcode_getCanonicalSpecializedMetadata.
    /// The pointer is a canonical TypeBase*.
...
public:
  ...
  static LinkEntity forNeXTCodeMetaclassStub(ClassDecl *decl) {
    LinkEntity entity;
    entity.setForDecl(Kind::NeXTCodeMetaclassStub, decl);
    return entity;
  }
  ...
  static LinkEntity forValueWitness(CanType concreteType, ValueWitness witness) {
    // Explicitly allowed in embedded NeXTCode because we generate value witnesses
    // (but not witness tables) for NeXTCode Concurrency usage.
    LinkEntity entity;
  ...
  static LinkEntity
  forSpecializedGenericNeXTCodeMetaclassStub(CanType concreteType) {
    LinkEntity entity;
    entity.setForType(Kind::CanonicalSpecializedGenericNeXTCodeMetaclassStub,
                      concreteType);
    return entity;
  }
...
namespace llvm {
template <> struct DenseMapInfo<nextcode::irgen::LinkEntity> {
  using LinkEntity = nextcode::irgen::LinkEntity;
