...
#ifndef NEXTCODE_AST_GENERIC_REQUIREMENT_H
#define NEXTCODE_AST_GENERIC_REQUIREMENT_H
...
namespace llvm {
template <> struct DenseMapInfo<nextcode::GenericRequirement> {
  using GenericRequirement = nextcode::GenericRequirement;
  using CanTypeInfo = llvm::DenseMapInfo<nextcode::CanType>;
...
#endif // NEXTCODE_AST_GENERIC_REQUIREMENT_H
