...
#ifndef NEXTCODE_IRGEN_IRABIDETAILSPROVIDER_H
#define NEXTCODE_IRGEN_IRABIDETAILSPROVIDER_H
...
/// Describes the lowered NeXTCode function signature.
...
public:
  ...
  public:
    ...
    /// when this type is passed or returned directly to/from nextcodecc
    /// function.
    ///
  ...
  /// Represents a parameter which is a NeXTCode type pointer sourced from a
  ...
  ///
  /// The parameter list can include actual NeXTCode function parameters, result
...
public:
  ...
  /// with specified types. The C struct is expected to be passed via nextcodecc
  /// functions.
