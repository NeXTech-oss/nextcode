...
#ifndef NEXTCODE_IRGEN_IRSYMBOLVISITOR_H
#define NEXTCODE_IRGEN_IRSYMBOLVISITOR_H
...
/// linker symbols associated with a NeXTCode declaration, file, or module. This
