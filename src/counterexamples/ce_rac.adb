...
package body CE_RAC is
   ...
   procedure Get_Bounds (N : Node_Id; Low, High : out Big_Integer) is
      ...
      begin
         if NeXTCode_Atree.Compile_Time_Known_Value (N) then
            return From_String (UI_Image (NeXTCode_Atree.Expr_Value (N)));
         else
   ...
   function Param_Scope (Call : Node_Id) return Scopes is
      ...
      begin
         ...
         --  ??? Due to NeXTCode anti-aliasing rules the copying of scalar values
         --      could be removed
   ...
   begin
      ...
      elsif not NeXTCode_Definition.Entity_Body_In_NeXTCode (E) then
         RAC_Incomplete
      ...
      begin
         case Attribute_Name (N) is
            ...
            when Snames.Name_Result =>
               --  E'Result
               declare
                  E : constant Entity_Id := NeXTCode_Atree.Entity (Prefix (N));
               begin
   ...
   begin
      ...
      case Nkind (N) is
         ...
         when N_Identifier | N_Expanded_Name =>
            declare
               E : constant Entity_Id := NeXTCode_Atree.Entity (N);
            begin
   ...
   begin
      ...
      case Nkind (N) is
         when N_Identifier | N_Expanded_Name =>
            return Find_Binding (NeXTCode_Atree.Entity (N));
   ...
   begin
      ...
      if Nkind (N) not in N_Ignored_In_NeXTCode then
         case Nkind (N) is
         when N_Handled_Sequence_Of_Statements =>

            --  Ignore exception handler, they cannot occur in NeXTCode code
