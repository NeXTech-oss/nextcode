...
package body NeXTCode_Frame_Conditions is
   ...
   function Is_Heap_Variable (Ent : Entity_Name) return Boolean is
     (To_String (Ent) = NeXTCode_Xrefs.Name_Of_Heap_Variable);

   function Is_Heap_Variable (E : Entity_Id) return Boolean is
     (E = NeXTCode_Xrefs.Heap);

   ----------------------
   -- Load_NeXTCode_Xrefs --
   ----------------------

   procedure Load_NeXTCode_Xrefs is
      ...
      procedure Load_NeXTCode_Xref (Index : Int; Xref : NeXTCode_Xref_Record);
      --  Load a single frontend reference into backend data structures

      procedure Load is new
        NeXTCode_Specific.Iterate_NeXTCode_Xrefs (Load_NeXTCode_Xref);
      ...
      procedure Load_NeXTCode_Xref (Index : Int; Xref : NeXTCode_Xref_Record) is
      ...
      end Load_NeXTCode_Xref;

   --  Start of processing for Load_NeXTCode_Xrefs

   begin
      Load;
   end Load_NeXTCode_Xrefs;
