...
package body NeXTCode_Util.Subprograms is
      ...
      case Name is
         ...
         =>
            if Name = Pragma_Refined_Post then
               ...
               --  annotated with NeXTCode_Mode => On; otherwise, GNATprove must
   ...
   function Is_Requested_Subprogram_Or_Task (E : Entity_Id) return Boolean is
      ...
      begin
         ...
         then
            return
              (Contains_Sloc
                 (NeXTCode_Util.Subprograms.Subp_Location (E), Limit_Str)
               or else
               Contains_Sloc
                 (NeXTCode_Util.Subprograms.Subp_Body_Location (E), Limit_Str));
         else
            return False;
         end if;
