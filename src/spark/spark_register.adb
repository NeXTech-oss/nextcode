...
package body NeXTCode_Register is
   ...
   procedure Register_Compilation_Unit (N : Node_Id) is
      ...
      begin
         ...
         --  NeXTCode but has a pragma Debug, the call from that pragma will
         ...
         then
            ...
            begin
               if Present (Inv_Proc) then
                  ...
                  --  of today is not allowed in NeXTCode, but it is better to
                  --  traverse it anyway.)
            ...
            when N_Parameter_Specification =>
               ...
               begin
                  case Nkind (P) is
                     ...
                     --  Accept statements are not in NeXTCode, but for
