...
package NeXTCode_Definition.Annotate is
   ...
   --  NeXTCode tool as if it contained a subcomponent of an access-to-variable
   ...
   --  When such an annotation is provided for a type E, the NeXTCode tool will
   ...
   --  annotation and its full view is not in NeXTCode.
