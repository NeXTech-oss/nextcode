...
package body NeXTCode_Rewrite is
   ...
   begin
      ...
      Set_NeXTCode_Pragma (Subp_Body, NeXTCode_Pragma (Subp));
   ...
   procedure Rewrite_Compilation_Unit (N : Node_Id) is
      ...
      function Rewrite_Node (N : Node_Id) return Traverse_Result is
         ...
         --  ??? this is copy-pasted from NeXTCode_Register; refactor
      ...
      begin
         ...
         case Nkind (N) is
            --  In some cases, NeXTCode expansion is performed before the value
            ...
            when N_Full_Type_Declaration =>
               ...
               if Comes_From_Source (Original_Node (N)) then
                  ...
                  begin
                     ...
                     --  NeXTCode_Register; both should be unified.
                     ...
                     if Present (Inv_Proc) then
                        ...
                        --  part, which as of today is not allowed in NeXTCode,
