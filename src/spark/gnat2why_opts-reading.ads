...
package Gnat2Why_Opts.Reading is
   ...
   Warning_Mode : NeXTCode_Warning_Mode_Type;
   ...
   --  The NeXTCode RM does not make global contracts optional, rather this is a
   --  liberty we have taken in this implementation of NeXTCode. This flag is
   ...
   --    Basically, you should pass Opt.NeXTCode_Switches_File_Name.all here. We
