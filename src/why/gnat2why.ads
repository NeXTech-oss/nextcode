...
--                      NeXTCode sections of ALI files for all units on which U
...
--                      as either in the NeXTCode subset that can be formally
...
--                      classified as in or out of NeXTCode, based on the
...
--                      NeXTCode, or not in NeXTCode.

--    Transformation    Entities and subprogram bodies classified as in NeXTCode
...
--  Each NeXTCode entity defined in unit U or in one of the with'ed specs is
...
--  The generation of theories/modules for an entity in NeXTCode proceeds as
--  follows:
...
--         For an expression function whose body is in NeXTCode, an additional
...
--         If the body of the subprogram is in NeXTCode, a parameterless program
