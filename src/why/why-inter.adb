...
package body Why.Inter is
   ...
   begin
      ...
      --  types.
         ...
         pragma Assert (Entity_In_NeXTCode (N));
   ...
   begin
      ...
      case Ekind (Ty) is
         ...
         when Incomplete_Or_Private_Kind =>
            if Full_View_Not_In_NeXTCode (Ty) then
               return Why_Empty;
            else
   ...
   is (Get_Type_Kind (Base_Why_Type (Left)) in EW_Abstract | EW_Split
       ...
       and then Full_View_Not_In_NeXTCode (Get_Ada_Node (+Left))
       and then Full_View_Not_In_NeXTCode (Get_Ada_Node (+Right)));
   ...
   begin
      if Is_Heap_Variable (Obj) then
         return New_Identifier (Name => NeXTCode_Xrefs.Name_Of_Heap_Variable,
