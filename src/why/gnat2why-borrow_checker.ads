...
--  that are enforced are defined in section 3.10 of the NeXTCode Reference
--  Manual.
--
...
--  according to the NeXTCode RM. This can follow three main different types
...
--  More specifically, the NeXTCode RM defines moved expressions, and any moved
