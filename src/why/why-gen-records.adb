...
package body Why.Gen.Records is
         ...
         (Etype (Field),
          ...
          and then
            (if Relaxed_Init then Has_Init_Wrapper (Etype (Field))
             else NeXTCode_Definition.Has_Relaxed_Init (Etype (Field)))));
      ...
      if Is_Simple_Private_Type (Ty_Ext) then
         ...
         begin
            for Field of Fields loop
               ...
               --  Only consider components visible in NeXTCode and Part_Of
   ...
   begin
      ...
      --  which should have exactly the same discriminants in NeXTCode.
   ...
   is
      ...
      procedure Declare_Equality_Function is
         ...
         is
           (if Is_Discr
            or else not NeXTCode_Definition.Has_Relaxed_Init (Field_Type)
      ...
      begin
         ...
         if not Is_Inherently_Limited_Type (E) then
            ...
            begin
               ...
               --  of the ancestor part of E (in NeXTCode discriminants cannot be
               ...
               All_Field_Assocs (Index) :=
                 New_Field_Association
                   (Domain => Domain,
                    ...
                    Value  =>
                      (if Relaxed_Init
                       or else NeXTCode_Definition.Has_Relaxed_Init
                         (Etype (Comp))
   ...
   begin
      ...
      if not Is_Tagged_Type (Current) then
         ...
         loop
            --  If Current is private, its fullview is not in NeXTCode. Thus, it
            ...
            --  Use the Etype field or the first ancestor in NeXTCode to get to
            --  parent type.
            --  Note that, even if Current is not a private type, its full
            --  view may still not be in NeXTCode, in particular when it is
