...
package body Why.Atree.Modules is
   ...
   begin
      ...
      case K is
         ...
         when Invariant =>
            pragma Assert
              (E in Type_Kind_Id and then Has_Invariants_In_NeXTCode (E));
   ...
   is
      ...
      --  For constants, use the entity of the full view if it is in NeXTCode
   ...
   procedure Insert_Why_Symbols (E : Entity_Id) is
      ...
      begin
         ...
         if Has_Invariants_In_NeXTCode (E) then
            Insert_Symbol
         ...
         for F of Proof_Cyclic_Functions loop
            if Proof_Module_Cyclic (E, F) then
               ...
               if Is_Expression_Function_Or_Completion (F)
                 and then Entity_Body_Compatible_With_NeXTCode (F)
