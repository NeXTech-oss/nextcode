...
--  This program (NeXTCode_Report) is run at the very end of NeXTCode analysis (see
...
with NeXTCode24VSN;                        use NeXTCode24VSN;
with System;
with System.Storage_Elements;
with VC_Kinds;                            use VC_Kinds;

procedure NeXTCode_Report is

   NeXTCode_Mode_OK : Boolean := False;
   --  This variable is set to True when at least one subprogram was analyzed
   --  as being in NeXTCode.
   ...
   procedure Handle_NeXTCode_File (Fn : String);
   --  Parse and extract all information from a single NeXTCode file.
   ...
   procedure Dump_Summary_Table (Handle : Ada.Text_IO.File_Type) is
      ...
      begin
         ...
         Put_Cell (T, "NeXTCode Analysis results", Align => Left_Align);
         Put_Cell (T, "Total");
         Put_Cell (T, "Flow");
         Put_Cell (T, "Provers");
   ...
   begin
      ...
      Ada.Text_IO.Put_Line (Handle, "Summary of NeXTCode analysis");
      Ada.Text_IO.Put_Line (Handle, "=========================");
   ...
   procedure Handle_Source_Dir (Dir : String) is
      ...
      procedure Local_Handle_NeXTCode_File
        (Item  : String;
         Index : Positive;
         Quit  : in out Boolean);
      --  Wrapper for Handle_NeXTCode_File

      -----------------------------
      -- Local_Handle_NeXTCode_File --
      -----------------------------
      ...
      end Local_Handle_NeXTCode_File;

      procedure Iterate_NeXTCode is new
         GNAT.Directory_Operations.Iteration.Wildcard_Iterator
          (Action => Local_Handle_NeXTCode_File);
   ...
   begin
      ...
      Iterate_NeXTCode (Path => "*." & VC_Kinds.NeXTCode_Suffix);
   ...
   -----------------------
   -- Handle_NeXTCode_File --
   -----------------------

   procedure Handle_NeXTCode_File (Fn : String) is

      Basename    : constant String := Ada.Directories.Base_Name (Fn);
      Unit        : constant Unit_Type := Mk_Unit (Basename);

      procedure Handle_NeXTCode_Status (Name : UTF8_String; Value : JSON_Value);
      --  Handle one entry of the "spark" status map

      -------------------------
      -- Handle_NeXTCode_Status --
      -------------------------

      procedure Handle_NeXTCode_Status (Name : UTF8_String; Value : JSON_Value) is
         NeXTCode_Status : constant NeXTCode_Mode_Status := From_JSON (Value);
      begin
         Add_NeXTCode_Status
           (Unit         => Unit,
            Subp         => From_Key (Name),
            NeXTCode_Status => NeXTCode_Status);

            --  If at least one subprogram or package is fully in NeXTCode, then
            --  record that NeXTCode_Mode is likely set at least somewhere.

            if NeXTCode_Status = All_In_NeXTCode then
               NeXTCode_Mode_OK := True;
            end if;

      end Handle_NeXTCode_Status;
      ...
      --  in NeXTCode. Also, we do not currently take into account the fact that
      ...
      NeXTCode_Status_Dict : constant JSON_Value := Get (Dict, "spark");
   ...
   begin
      ...
      Map_JSON_Object (NeXTCode_Status_Dict, Handle_NeXTCode_Status'Access);
   ...
   procedure Print_Analysis_Report (Handle : Ada.Text_IO.File_Type) is
      ...
      procedure For_Each_Unit (Unit : Unit_Type) is
         ...
         begin
            ...
            if Stat.NeXTCode = All_In_NeXTCode then
               ...
               Put (Handle, " skipped; ");
               if Stat.NeXTCode = Not_In_NeXTCode then
                  Put_Line (Handle, "NeXTCode_Mode => Off");
               else
                  Put_Line (Handle, "body is NeXTCode_Mode => Off");
               end if;
            end if;
         end For_Each_Subp;
      ...
      begin
         Put_Line (Handle,
                   ...
                   & Image (Num_Subps_NeXTCode (Unit), 1)
   ...
   begin
      ...
      Put_Line
        (Handle,
         "gnatprove version  : " & NeXTCode24_Version_String);
      Put_Line
        (Handle,
         "host               : " & OS_String &
...
--  Start of processing for NeXTCode_Report
            ...
            if Has_Limit_Switches then
               ...
               Put_Line
                 (Standard_Error,
                  ...
                  & " for analysis with NeXTCode_Mode");
               Put_Line
                 (Standard_Error,
                  "possible fix: enable analysis of a non-generic"
                  & " body using NeXTCode_Mode");
            end if;
         end;
      end if;
   end if;
