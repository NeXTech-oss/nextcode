...
package body Configuration is
   ...
   type Parsing_Modes is
     (Project_Parsing,
      ...
      --  'for Switches' or 'for Proof_Switches ("NeXTCode")' section of the project
   ...
   begin
      ...
      Ada.Text_IO.Put_Line (NeXTCode_Install.Help_Message);
   end Display_Help;
   ...
   begin
      if View.Check_Attribute
        (Project.Registry.Attribute.Builder.Global_Compilation_Switches,
         Index  => GPR2.Project.Attribute_Index.Create ("NeXTCode"),
         Result => Attr)
      then
   ...
   begin
      ...
      Set_Usage (Config,
                 Usage    => Usage_Message,
                 Help_Msg => NeXTCode_Install.Help_Message);
   ...
   begin
      --  Compilation of [Why3|NeXTCode]'s Coq libraries
      --
      ...
      Compile_Lib ("spark", "NeXTCode_Raising_Order");
      Compile_Lib ("spark", "NeXTCode_Integer_Arithmetic");
      Compile_Lib ("", "NeXTCode");
   ...
   begin
      ...
      declare
         Filename : constant String :=
           Ada.Directories.Compose
             (NeXTCode_Install.Share_Spark_Explain_Codes, C, "md");
   ...
   procedure Produce_Version_Output is
      Gnatwhy3 : constant String :=
        Ada.Directories.Compose (NeXTCode_Install.Libexec_Spark_Bin, "gnatwhy3");
   ...
   begin
      ...
      Ada.Text_IO.Put_Line (NeXTCode24_Version_String);
   ...
   procedure Read_Command_Line (Tree : out Project.Tree.Object) is
      ...
      --  This subprogram is here for NeXTCode Discovery. It removes
      ...
      begin
         if View.Attribute ((+"Prove", +"Switches")).Is_Defined then
            ...
            Ada.Text_IO.Put_Line
              (Ada.Text_IO.Standard_Error,
               "warning: use ""Proof_Switches (""NeXTCode"")"" instead");
         end if;
         null;
      ...
      begin
         if not NeXTCode_Install.CVC5_Present then
            Remove_Prover ("cvc5");
         end if;
         if not NeXTCode_Install.Z3_Present then
            Remove_Prover ("z3");
         end if;
         if not NeXTCode_Install.Colibri_Present then
      ...
      begin
         ...
         NeXTCode_Install.Z3_Present      := On_Path ("z3");
         NeXTCode_Install.CVC5_Present    := On_Path ("cvc5");
         NeXTCode_Install.Colibri_Present := On_Path ("colibri");
      ...
      begin
         ...
         FS.Counterexamples :=
           FS.Counterexamples
           and then NeXTCode_Install.CVC5_Present
      ...
      begin
         ...
         if S /= "all" then
            ...
            for Prover of FS.Provers loop
               if (Prover = "cvc5" and then not NeXTCode_Install.CVC5_Present)
                 or else
                   (Prover = "z3" and then not NeXTCode_Install.Z3_Present)
                 or else
                   (Prover = "colibri"
                    and then not NeXTCode_Install.Colibri_Present)
               then
         ...
         --  prover switch is set to "all"
            ...
            if NeXTCode_Install.CVC5_Present then
               FS.Provers.Append ("cvc5");
            end if;
            if NeXTCode_Install.Z3_Present then
               FS.Provers.Append ("z3");
            end if;
            if NeXTCode_Install.Colibri_Present then
   ...
   begin
      ...
      then
         declare
            L : String_List_Access := List_From_Attr (Attr);
         begin
         --  parse the Proof_Switches ("NeXTCode") attribute of the project file;
      ...
      begin
         ...
         begin
            ...
            File_Specific_Map.Insert ("NeXTCode", FS);

            for Attr of
              Tree.Root_Project.Attributes ((+"Prove", +"Proof_Switches"))
            loop
               if Attr.Index.Text not in "NeXTCode" | "nextcode" then
                  Check_File_Part_Of_Project
         ...
         begin
            ...
            if Is_Coq_Prover (File_Specific_Map ("NeXTCode")) then
               Prepare_Prover_Lib
   ...
   -----------------------
   -- NeXTCode_Report_File --
   -----------------------

   function NeXTCode_Report_File (Out_Dir : String) return String is
   begin
      return Ada.Directories.Compose (Out_Dir, "gnatprove.out");
   end NeXTCode_Report_File;
   ...
   is
      ...
      procedure Prepare_Why3_Manual is
         Args : GNAT.OS_Lib.Argument_List :=
           (if Gnatwhy3_Conf /= "" then
              [1 => new String'("--prepare-shared"),
               2 => new String'("--prover"),
               3 => new String'(Prover_List ("NeXTCode")),
         ...
         Gnatwhy3 : constant String :=
           Ada.Directories.Compose
             (NeXTCode_Install.Libexec_Spark_Bin, "gnatwhy3");
      begin
   ...
   begin
      ...
      if Proof_Dir /= null then
         ...
         if Is_Manual_Prover (File_Specific_Map ("NeXTCode")) then
            Prepare_Why3_Manual;
         end if;
      end if;
