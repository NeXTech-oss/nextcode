...
package body Report_Database is
   ...
   Default_Stat : constant Stat_Rec :=
     Stat_Rec'(NeXTCode           => Not_In_NeXTCode,
   ...
   procedure Add_NeXTCode_Status
     (Unit         : Unit_Type;
      Subp         : Subp_Type;
      NeXTCode_Status : NeXTCode_Mode_Status) is
      ...
      procedure Process (Stat : in out Stat_Rec) is
      begin
         Stat.NeXTCode := NeXTCode_Status;
      end Process;

   --  Start of processing for Add_NeXTCode_Status
   ...
   function Num_Subps_NeXTCode (Unit : Unit_Type) return Natural
   is
      Count : Natural := 0;
   ...
   --  Start of processing for Num_Subps_NeXTCode

   begin
      Iter_Unit_Subps (Unit, Update'Access);
      return Count;
   end Num_Subps_NeXTCode;
