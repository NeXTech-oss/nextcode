...
package Configuration is
   ...
   Warning_Mode     : Gnat2Why_Opts.NeXTCode_Warning_Mode_Type;
   ...
   function NeXTCode_Report_File (Out_Dir : String) return String;
   --  The name of the file in which the NeXTCode report is generated:
