...
package Report_Database is
   ...
   type Stat_Rec is record
      NeXTCode           : NeXTCode_Mode_Status;  --  NeXTCode On, only Spec, or Off
   ...
   procedure Add_NeXTCode_Status
     (Unit         : Unit_Type;
      Subp         : Subp_Type;
      NeXTCode_Status : NeXTCode_Mode_Status);
   --  Register the NeXTCode status for the given subprogram
   ...
   --  Return the number of subprograms in NeXTCode in the unit
