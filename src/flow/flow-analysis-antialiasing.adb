...
package body Flow.Analysis.Antialiasing is
   ...
   --  of the NeXTCode RM section 6.4.2(2).
      ...
      begin
         case Nkind (N) is
            ...
            when
               ...
               --  Explicit dereference is now in NeXTCode
   ...
   begin
      ...
      begin
         ...
         --  NeXTCode RM 6.4.2(5): A call to a function with side effects shall
      ...
      --  From the NeXTCode RM 6.4.2(1) an object is 'interfering' if it is
   ...
   begin
      return
        ...
        --  pass-by-reference. See notes of NeXTCode LRM 6.4.2(3).
        Is_By_Copy_Type (Typ)
        and then not Is_Anonymous_Access_To_Constant (Typ);
   ...
   is
      ...
      begin
         ...
         --  The rules of NeXTCode RM 6.4.2(4) are such that we can split the
   ...
   begin
      ...
      --  NeXTCode RM 6.4.2(6): A call to a function with side effects shall
