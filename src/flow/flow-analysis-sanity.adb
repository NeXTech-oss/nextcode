...
package body Flow.Analysis.Sanity is
   ...
   is
      ...
      --  Check NeXTCode RM 4.4(2) rule about:
      ...
      --  present, i.e. NeXTCode RM 4.4(2) rules about:
      ...
      --  Enforce NeXTCode RM 4.4(2) by checking:
      ...
      --  inputs, as per NeXTCode RM 4.4(2).
      ...
      begin
         ...
         --  have variable inputs and does not reference potentially
         --  nonreturning functions. Has_Invariants_In_NeXTCode operates on the
         ...
         if Nkind (N) in N_Private_Type_Declaration
                       | N_Private_Extension_Declaration
           and then Has_Invariants_In_NeXTCode (Typ)
         then
            declare
               Expr : constant Node_Id :=
      ...
      begin
         ...
         --  Check type declarations affected by NeXTCode RM 4.4(2)
         ...
         case Nkind (N) is
            when N_Protected_Body =>
               ...
               begin
                  if Entity_Body_In_NeXTCode (Spec) then
                     Traverse_Declarations_Or_Statements (Declarations (N));
                  end if;
               end;
            ...
            when N_Protected_Type_Declaration =>
               ...
               begin
                  if Entity_Spec_In_NeXTCode (Typ) then
                     ...
                     begin
                        ...
                        if Private_Spec_In_NeXTCode (Typ) then
                           Traverse_Component_Items
            ...
            when N_Private_Extension_Declaration =>
               --  Discriminants on derived type are not allowed in NeXTCode;
               --  NeXTCode RM 3.7(2).
            ...
            when N_Object_Renaming_Declaration =>
               ...
               if Comes_From_Source (N) then
                  ...
                  --  are transformed into renamings by GNAT (and NeXTCode RM rule
      ...
      case FA.Kind is
         when Kind_Subprogram =>
            ...
            begin
               ...
               --  has only limited views (NeXTCode RM 6.1.4(11)).
         ...
         when Kind_Package =>
            if Entity_Spec_In_NeXTCode (FA.Spec_Entity) then
               declare
   ...
   is
      ...
      --  String representation of the violated NeXTCode RM rule
                        ...
                        Error_Msg_Flow
                          (FA       => FA,
                           Msg      => "protected function with effective " &
                                       "reads & is not allowed in NeXTCode",
