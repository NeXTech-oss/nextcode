...
with NeXTCode_Xrefs;            use NeXTCode_Xrefs;
...
package body Flow_Error_Messages is
   ...
   is
      ...
      Msg2 : constant String :=
        ...
        (if SRM_Ref'Length > 0 then " (NeXTCode RM " & SRM_Ref & ")" else "");
   ...
   is
      ...
      is
         ...
         Enclosing_Subp : constant Entity_Id :=
           Lib.Xref.NeXTCode_Specific.Enclosing_Subprogram_Or_Library_Package (N);
      ...
      begin
         ...
         --  severity.
           ...
           and then Present
             (Supported_Alias (NeXTCode_Atree.Get_Address_Expr (N)))
         then
            Result := High_Check_Kind;
   ...
   begin
      ...
      --  NeXTCode_Atree.Get_Range_Check_Info, in particular regarding
      ...
      case Tag is
         when VC_Termination_Check =>
            ...
            then
               ...
               begin
                  return E_Name & " should always terminate in NeXTCode";
               end;
         ...
         --  NeXTCode_Atree.Get_Range_Check_Info, based on the kind of
   ...
   begin
      ...
      Expr_Vars.Exclude
        (Magic_String_Id (To_Entity_Name
         (NeXTCode_Xrefs.Name_Of_Heap_Variable)));
   ...
   is
      ...
      begin
         NeXTCode_Util.Append (To => Prag, Elmts => Class_Prag);
         return Prag;
      end Get_Pre_Post;
      ...
      begin
         ...
         then
            Handle_Precondition_Check : declare
               Subp : constant Entity_Id := NeXTCode_Atree.Get_Called_Entity (N);
               ...
               begin
                  if Ekind (Formal) in E_In_Parameter
                                     | E_In_Out_Parameter
                  then
                     Var := NeXTCode_Atree.Get_Enclosing_Object (Actual);
               ...
               procedure Iterate_Call is new
                 NeXTCode_Atree.Iterate_Call_Parameters (Treat_Param);
            ...
            declare
               V : constant Entity_Id :=
                 NeXTCode_Atree.Get_Enclosing_Object (Name (N));
            begin
      ...
      --  we can assume NeXTCode code here and query flow analysis for effects.
   ...
   begin
      if Tag = VC_UC_Alignment then
         ...
         declare
            ...
            Expr   : constant Node_Id :=
              NeXTCode_Atree.Get_Address_Expr (N);
      ...
      --  an explanation for a check involving Func'Result.
         ...
         declare
            ...
            is
               ...
               Lo_Src_Value : constant Uint :=
                 (if Nkind (Lo_Src) = N_Integer_Literal then
                    NeXTCode_Atree.Expr_Value (Lo_Src)
                  else No_Uint);
               Hi_Src_Value : constant Uint :=
                 (if Nkind (Hi_Src) = N_Integer_Literal then
                    NeXTCode_Atree.Expr_Value (Hi_Src)
                  else No_Uint);
               ...
               Lo_Tgt_Value : constant Uint :=
                 (if Nkind (Lo_Tgt) = N_Integer_Literal then
                    NeXTCode_Atree.Expr_Value (Lo_Tgt)
                  else No_Uint);
               Hi_Tgt_Value : constant Uint :=
                 (if Nkind (Hi_Tgt) = N_Integer_Literal then
                    NeXTCode_Atree.Expr_Value (Hi_Tgt)
                  else No_Uint);
            ...
            begin
               if NeXTCode_Atree.Compile_Time_Known_Value (Arg) then
                  if NeXTCode_Atree.Expr_Value (Arg) >= 0 then
               ...
               begin
                  if NeXTCode_Atree.Compile_Time_Known_Value (Lo)
                    and then NeXTCode_Atree.Expr_Value (Lo) >= 0
                  then
                     return Positive_Or_Null;
                  elsif NeXTCode_Atree.Compile_Time_Known_Value (Hi)
                    and then NeXTCode_Atree.Expr_Value (Hi) <= 0
                  then
                     return Negative_Or_Null;
                  end if;
               end;
         ...
         begin
                     ...
                     declare
                        ...
                        Lo_Value : constant Uint :=
                          (if Nkind (Lo) = N_Integer_Literal then
                             NeXTCode_Atree.Expr_Value (Lo)
                           else No_Uint);
                        Hi_Value : constant Uint :=
                          (if Nkind (Hi) = N_Integer_Literal then
                             NeXTCode_Atree.Expr_Value (Hi)
                           else No_Uint);
            ...
            while Present (Stmt) loop
               ...
               when N_Procedure_Call_Statement =>
                  declare
                     ...
                     Proc : constant Entity_Id :=
                       NeXTCode_Atree.Get_Called_Entity (Stmt);
               ...
               =>
                  declare
                     Proc : constant Entity_Id :=
                       NeXTCode_Atree.Unique_Defining_Entity (Stmt);
   ...
   begin
      ...
      --    - the section of NeXTCode User's Guide on GNATprove
      ...
      case Kind is
         ...
         when VC_Task_Termination          =>
            return "the task might terminate, which is not allowed in NeXTCode";
            ...
            if Nkind (Node) in N_Raise_xxx_Error then
               ...
               case RT_Exception_Code'Val (UI_To_Int (Reason (Node))) is
                  ...
                  when SE_Infinite_Recursion =>
                     ...
                     --  reported by Proof" NeXTCode UG table, which is generated
