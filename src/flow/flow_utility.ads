...
package Flow_Utility is
   ...
   --  the generic instance; see NeXTCode RM 6.1.4(20):
   --
   ...
   --       - globals generated by flow in phase 1 for subprograms in NeXTCode
   --       - globals generated by the front end for subprograms not in NeXTCode
   ...
   --  body is in NeXTCode and Global if only spec is in NeXTCode.
