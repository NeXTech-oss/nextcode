...
package Flow_Generated_Globals.Phase_2 is
   ...
   --  blocking status is unknown, e.g. when the body is not in NeXTCode).
   --
   ...
   --    - has its body not in NeXTCode.
   --
   --    The case of a subprogram with body not NeXTCode needs a closer look. In
   ...
   --    3) if a subprogram has a body and this is not in NeXTCode then we always
