...
package Flow_Generated_Globals is
   ...
   --
   --    * For every subprogram and task in NeXTCode a GG graph is created. The
   ...
   --
   --    * For every subprogram and task that is NOT in NeXTCode and does NOT
   ...
   --      NeXTCode_Mode Off or that contain illegal NeXTCode constructs we use the
