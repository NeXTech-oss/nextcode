//===--- Serialization.h - Read and write NeXTCode modules ---------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_SERIALIZATION_SERIALIZATION_H
#define NEXTCODE_SERIALIZATION_SERIALIZATION_H
...
public:
  ...
  using UniquedDerivativeFunctionConfigTable = llvm::MapVector<
      Identifier,
      nextcode::SmallSetVector<std::pair<Identifier, GenericSignature>, 4>>;
...
private:
  ...
  /// Writes the NeXTCode module file header and name, plus metadata determining
  ...
  /// section of this nextcode module.
