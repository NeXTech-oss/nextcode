...
#ifndef NEXTCODE_SERIALIZATION_MODULEFILE_H
#define NEXTCODE_SERIALIZATION_MODULEFILE_H
...
public:
  ...
  /// The NeXTCode compatibility version in use when this module was built.
  ...
  /// arbitrary granularity and arbitrary stage; unlike serialized NeXTCode
  ...
  /// Whether this module was built using embedded NeXTCode.
  bool isEmbeddedNeXTCodeModule() const {
    return Core->Bits.IsEmbeddedNeXTCodeModule;
  }
  ...
  /// Generate a \c SourceLoc pointing at the loaded nextcodemodule file.
  ...
  bool hasLoadedNeXTCodeDoc() const;
