...
nextcode::replaceAllSimplifiedUsesAndErase(SILInstruction *i, SILValue result,
...
SILValue nextcode::simplifyOverflowBuiltinInstruction(BuiltinInst *BI) {
...
SILBasicBlock::iterator nextcode::simplifyAndReplaceAllSimplifiedUsesAndErase(
