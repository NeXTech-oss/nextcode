...
#include "nextcode/SILOptimizer/Analysis/ArraySemantic.h"
...
ArrayCallKind nextcode::getArraySemanticsKind(SILFunction *f) {
...
bool nextcode::ArraySemanticsCall::isValidSignature() {
  ...
  case ArrayCallKind::kArrayUninitialized: {
    ...
    if (Arg0->getType().isExistentialType()) {
      ...
      if (!AllocFn || AllocFn->getName() != "nextcode_bufferAllocate" ||
...
nextcode::ArraySemanticsCall::ArraySemanticsCall(SILValue V,
...
/// Match array semantic calls.
nextcode::ArraySemanticsCall::ArraySemanticsCall(SILInstruction *I,
                                              StringRef semanticName,
                                              bool matchPartialName)
    : SemanticsCall(nullptr) {
...
/// Match array semantic calls.
nextcode::ArraySemanticsCall::ArraySemanticsCall(ApplyInst *AI,
                                              StringRef semanticName,
                                              bool matchPartialName)
    : SemanticsCall(nullptr) {
  initialize(AI, semanticName, matchPartialName);
...
ArrayCallKind nextcode::ArraySemanticsCall::getKind() const {
  if (!SemanticsCall)
...
bool nextcode::ArraySemanticsCall::hasSelf() const {
...
SILValue nextcode::ArraySemanticsCall::getSelf() const {
  return SemanticsCall->getSelfArgument();
}

Operand &nextcode::ArraySemanticsCall::getSelfOperand() const {
  return SemanticsCall->getSelfArgumentOperand();
}

bool nextcode::ArraySemanticsCall::hasGuaranteedSelf() const {
  if (!hasSelf())
    return false;
...
bool nextcode::ArraySemanticsCall::hasGetElementDirectResult() const {
...
SILValue nextcode::ArraySemanticsCall::getTypeCheckedArgument() const {
  return SemanticsCall->getArgument(hasGetElementDirectResult() ? 1 : 2);
}

SILValue nextcode::ArraySemanticsCall::getSubscriptCheckArgument() const {
  return SemanticsCall->getArgument(hasGetElementDirectResult() ? 2 : 3);
}

SILValue nextcode::ArraySemanticsCall::getIndex() const {
  assert(SemanticsCall && "Must have a semantics call");
...
std::optional<int64_t> nextcode::ArraySemanticsCall::getConstantIndex() const {
...
bool nextcode::ArraySemanticsCall::canHoist(SILInstruction *InsertBefore,
...
ApplyInst *nextcode::ArraySemanticsCall::hoistOrCopy(SILInstruction *InsertBefore,
                                                  DominanceInfo *DT,
                                                  bool LeaveOriginal) {
...
void nextcode::ArraySemanticsCall::removeCall() {
...
SILValue
nextcode::ArraySemanticsCall::getArrayPropertyIsNativeTypeChecked() const {
  switch (getKind()) {
    case ArrayCallKind::kCheckSubscript:
...
bool nextcode::ArraySemanticsCall::doesNotChangeArray() const {
  switch (getKind()) {
...
bool nextcode::ArraySemanticsCall::mayHaveBridgedObjectElementType() const {
...
bool nextcode::ArraySemanticsCall::canInlineEarly() const {
  switch (getKind()) {
    default:
      return false;
...
SILValue nextcode::ArraySemanticsCall::getInitializationCount() const {
...
SILValue nextcode::ArraySemanticsCall::getArrayValue() const {
...
SILValue nextcode::ArraySemanticsCall::getArrayElementStoragePointer() const {
  return getArrayUninitializedInitResult(*this, 1);
}

bool nextcode::ArraySemanticsCall::replaceByValue(SILValue V) {
  assert(getKind() == ArrayCallKind::kGetElement &&
...
bool nextcode::ArraySemanticsCall::replaceByAppendingValues(
...
bool nextcode::ArraySemanticsCall::mapInitializationStores(
