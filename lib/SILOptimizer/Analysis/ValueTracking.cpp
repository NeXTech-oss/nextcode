...
bool nextcode::isExclusiveArgument(SILValue V) {
...
std::optional<bool> nextcode::computeSignBit(SILValue V) {
  SILValue Value = V;
  while (true) {
    ValueBase *Def = Value;
    // Inspect integer literals.
...
bool nextcode::canOverflow(BuiltinInst *BI) {
