...
#ifndef NEXTCODE_SILOPTIMIZER_PASSMANAGER_SILCOMBINER_H
#define NEXTCODE_SILOPTIMIZER_PASSMANAGER_SILCOMBINER_H
...
#include "nextcode/SIL/SILInstructionWorklist.h"
...
private:
  ...
  /// For invoking NeXTCode instruction passes.
...
private:
  ...
  void runNeXTCodeInstructionPass(SILInstruction *inst,
