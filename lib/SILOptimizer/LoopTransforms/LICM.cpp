...
static void checkSideEffects(nextcode::SILInstruction &Inst,
                      InstSet &SideEffectInsts,
...
static bool analyzeBeginAccess(BeginAccessInst *BI,
  ...
  // TODO Introduce "Pure NeXTCode" deinitializers
  ...
  for (auto *BB : Loop->getBlocks()) {
    ...
    for (auto &Inst : *BB) {
      ...
      case SILInstructionKind::RefElementAddrInst:
        ...
        break;
      case nextcode::SILInstructionKind::CondFailInst:
...
SILTransform *nextcode::createLICM() {
  return new LICM(false);
}

SILTransform *nextcode::createHighLevelLICM() {
