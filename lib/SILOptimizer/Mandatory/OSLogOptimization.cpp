...
class StringSILInfo {
  ...
  /// constructs a NeXTCode String from a string literal.
...
static SILValue emitCodeForConstantArray(ArrayRef<SILValue> elements,
  ...
  SubstitutionMap subMap = arrayType->getContextSubstitutionMap(
      module.getNeXTCodeModule(), astContext.getArrayDecl());
...
static SILValue emitCodeForSymbolicValue(SymbolicValue symVal,
  ...
  case SymbolicValue::Aggregate: {
    ...
    // object type containing the NeXTCode type.
...
SILTransform *nextcode::createOSLogOptimization() {
