...
#ifndef NEXTCODE_SILOPTIMIZER_PASSMANAGER_DIMEMORYUSECOLLECTOR_H
#define NEXTCODE_SILOPTIMIZER_PASSMANAGER_DIMEMORYUSECOLLECTOR_H
...
public:
  ...
  /// Return the nextcode type of the specified element.
