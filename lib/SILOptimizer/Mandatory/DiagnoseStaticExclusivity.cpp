...
/// diag::exclusivity_access_required, exclusivity_access_required_nextcode3,
...
static bool isCallToStandardLibrarySwap(CallExpr *CE, ASTContext &Ctx) {
  ...
  // Is the call module qualified, i.e. NeXTCode.swap(&a[i], &[j)?
...
shouldReportAccess(const AccessInfo &Info, nextcode::SILAccessKind Kind,
                   const IndexTrieNode *SubPath) {
...
SILTransform *nextcode::createDiagnoseStaticExclusivity() {
