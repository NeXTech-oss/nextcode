...
#ifndef NEXTCODE_SILOPTIMIZER_PASSMANAGER_ARC_RCSTATETRANSITION_H
#define NEXTCODE_SILOPTIMIZER_PASSMANAGER_ARC_RCSTATETRANSITION_H
...
namespace llvm {
raw_ostream &operator<<(raw_ostream &os, nextcode::RCStateTransitionKind Kind);
} // end llvm namespace
