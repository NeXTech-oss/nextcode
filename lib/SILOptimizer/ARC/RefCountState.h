...
#ifndef NEXTCODE_SILOPTIMIZER_PASSMANAGER_ARC_REFCOUNTSTATE_H
#define NEXTCODE_SILOPTIMIZER_PASSMANAGER_ARC_REFCOUNTSTATE_H
...
raw_ostream &operator<<(raw_ostream &OS,
                        nextcode::BottomUpRefCountState::LatticeState S);
raw_ostream &operator<<(raw_ostream &OS,
                        nextcode::TopDownRefCountState::LatticeState S);
