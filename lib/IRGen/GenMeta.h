//===--- GenMeta.h - NeXTCode IR generation for metadata -----------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_GENMETA_H
#define NEXTCODE_IRGEN_GENMETA_H
...
namespace irgen {
  ...
  /// Emit "embedded NeXTCode" class metadata (a simple vtable) for the given class
  /// declaration.
