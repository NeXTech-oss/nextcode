...
//===----------------------------------------------------------------------===//
//
//  This file implements IR debug info generation for NeXTCode.
//
//===----------------------------------------------------------------------===//
...
#include "nextcode/AST/TypeDifferenceVisitor.h"
...
private:
  ...
  /// Use the NeXTCode SM to figure out the actual line/column of a SourceLoc.
  template <typename WithLoc>
  FileAndLocation getNeXTCodeFileAndLocation(WithLoc *ASTNode, bool End) {
    if (!ASTNode)
      return {};
  ...
  FileAndLocation getFileAndLocation(Pattern *P, bool End = false) {
    return getNeXTCodeFileAndLocation(P, End);
  }
  FileAndLocation getFileAndLocation(Expr *E, bool End = false) {
    return getNeXTCodeFileAndLocation(E, End);
  }
  FileAndLocation getFileAndLocation(Decl *D, bool End = false) {
    ...
    return getNeXTCodeFileAndLocation(D, End);
  }
...
private:
  ...
  llvm::DIModule *getOrCreateModule(ImportedModule IM) {
    ...
    // aliasing was used (nextcode modules only). For example, if a source file has
  ...
  StringRef getMangledName(DebugTypeInfo DbgTy) {
    ...
    // TODO(https://github.com/apple/nextcode/issues/57699): We currently cannot round trip some C++ types.
    if (!Opts.DisableRoundTripDebugTypes &&
      ...
      if (!Reconstructed) {
        ...
        llvm::errs() << NEXTCODE_CRASH_BUG_REPORT_MESSAGE << "\n"
  ...
  llvm::TempDIType createStructForwardDecl(
    ...
    llvm::TempDICompositeType FwdDecl(DBuilder.createReplaceableCompositeType(
        ...
        llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, 0, Flags, UniqueID));
  ...
  createStructType(DebugTypeInfo DbgTy, NominalTypeDecl *Decl, Type BaseTy,
    ...
    for (VarDecl *VD : Decl->getStoredProperties()) {
      auto memberTy = BaseTy->getTypeOfMember(IGM.getNeXTCodeModule(), VD);
      ...
      if (auto DbgTy = CompletedDebugTypeInfo::getFromTypeInfo(
        ...
        return DBuilder.createForwardDecl(
            ...
            llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, 0);
    }
  ...
  llvm::DICompositeType *createUnsubstitutedGenericStructOrClassType(
    ...
    for (VarDecl *VD : Decl->getStoredProperties()) {
      auto memberTy =
          UnsubstitutedType->getTypeOfMember(IGM.getNeXTCodeModule(), VD);
  ...
  createSpecializedEnumType(NominalOrBoundGenericNominalType *EnumTy,
    ...
    auto FwdDecl = llvm::TempDIType(DBuilder.createReplaceableCompositeType(
        ...
        llvm::dwarf::DW_LANG_NeXTCode, 0, 0, llvm::DINode::FlagZero, MangledName));
...
createSpecializedStructOrClassType(NominalOrBoundGenericNominalType *Type,
  ...
  auto FwdDecl = llvm::TempDIType(DBuilder.createReplaceableCompositeType(
      ...
      llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, 0, Flags, MangledName));
  ...
  if (DeclTypeMangledName == MangledName) {
    return createUnsubstitutedGenericStructOrClassType(
        ...
        llvm::dwarf::DW_LANG_NeXTCode, DeclTypeMangledName);
  }
  // Force the creation of the unsubstituted type, don't create it
  // directly so it goes through all the caching/verification logic.
  ...
  llvm::DICompositeType *createRawEnumType(CompletedDebugTypeInfo DbgTy,
    ...
    // Default, since NeXTCode doesn't allow specifying a custom alignment.
    unsigned AlignInBits = 0;

    llvm::TempDICompositeType FwdDecl(DBuilder.createReplaceableCompositeType(
        llvm::dwarf::DW_TAG_enumeration_type, MangledName, Scope, File, Line,
        llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, AlignInBits, Flags,
        MangledName));
    ...
    if (!ElemDbgTy)
      ...
      return DBuilder.createForwardDecl(
          ...
          llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, 0, MangledName);
    ...
    auto DITy = DBuilder.createEnumerationType(
        ...
        llvm::dwarf::DW_LANG_NeXTCode, MangledName, false);
  ...
  llvm::DICompositeType *createVariantType(CompletedDebugTypeInfo DbgTy,
    ...
    auto DITy = DBuilder.createStructType(
        ...
        DBuilder.getOrCreateArray(VPTy), llvm::dwarf::DW_LANG_NeXTCode, nullptr,
  ...
  /// resolved in the debugger without needing to query the NeXTCode module.
  llvm::DINodeArray
  ...
  llvm::DIType *createOpaqueStructWithSizedContainer(
    ...
    if (llvm::Metadata *V = InnerTypeCache.lookup(UID))
      ...
      UniqueType = DBuilder.createForwardDecl(
          llvm::dwarf::DW_TAG_structure_type, MangledName, Scope, File, Line,
          llvm::dwarf::DW_LANG_NeXTCode, 0, 0);
      if (BoundParams)
    ...
    return DBuilder.createStructType(
        ...
        llvm::dwarf::DW_LANG_NeXTCode, nullptr, "", SpecificationOf, 0);
  }
  ...
  llvm::DIType *createPointerSizedStruct(
    ...
    return DBuilder.createStructType(
        ...
        /* DerivedFrom */ nullptr, DBuilder.getOrCreateArray(Elements),
        llvm::dwarf::DW_LANG_NeXTCode, nullptr, MangledName, SpecificationOf);
  }
  ...
  createDoublePointerSizedStruct(llvm::DIScope *Scope, StringRef Name,
    ...
    return DBuilder.createStructType(
        ...
        /* DerivedFrom */ nullptr, DBuilder.getOrCreateArray(Elements),
        llvm::dwarf::DW_LANG_NeXTCode, nullptr, MangledName);
  }
  ...
  llvm::DIType *createFixedValueBufferStruct(llvm::DIType *PointeeTy) {
    ...
    return DBuilder.createStructType(
        Scope, "$nextcode.fixedbuffer", File, Line, 3 * PtrSize, 0, Flags,
        /* DerivedFrom */ nullptr, DBuilder.getOrCreateArray(Elements),
        llvm::dwarf::DW_LANG_NeXTCode, nullptr);
  }
  ...
  llvm::DIType *createFunctionPointer(DebugTypeInfo DbgTy, llvm::DIScope *Scope,
    ...
    if (FunTy->getRepresentation() == SILFunctionType::Representation::Thick) {
      if (SizeInBits == 2 * CI.getTargetInfo().getPointerWidth(clang::LangAS::Default))
        // This is a FunctionPairTy: { i8*, %nextcode.refcounted* }.
  ...
  llvm::DIType *createTuple(DebugTypeInfo DbgTy, llvm::DIScope *Scope,
    ...
    auto DITy = DBuilder.createStructType(
        ...
        nullptr, // DerivedFrom
        DBuilder.getOrCreateArray(Elements), llvm::dwarf::DW_LANG_NeXTCode,
        nullptr, MangledName);
  ...
  bool shouldCacheDIType(llvm::DIType *DITy, DebugTypeInfo &DbgTy) {
    ...
    if (auto Ty = DbgTy.getType())
      ...
      // getMangledName().
      return Ty->getKind() != nextcode::TypeKind::PrimaryArchetype;
    return true;
  }
  ...
  llvm::DIType *createType(DebugTypeInfo DbgTy, StringRef MangledName,
    ...
    if (!BaseTy) {
      ...
      if (!InternalType) {
        ...
        InternalType = DBuilder.createForwardDecl(
            ...
            /*Line*/ 0, llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, AlignInBits,
            MangledName);
      }
      return InternalType;
    }
    ...
    case TypeKind::BuiltinJob: {
      ...
      if (Opts.DebugInfoLevel > IRGenDebugInfoLevel::ASTTypes) {
        ...
        llvm::DICompositeType *PTy = DBuilder.createStructType(
            ...
            llvm::dwarf::DW_LANG_NeXTCode, nullptr, {}, nullptr,
            NumExtraInhabitants);
        return PTy;
    ...
    // Even builtin nextcode types usually come boxed in a struct.
    case TypeKind::Struct: {
      ...
      if (Opts.DebugInfoLevel > IRGenDebugInfoLevel::ASTTypes) {
        ...
        return createStructType(DbgTy, Decl, StructTy, Scope, L.File, L.Line,
                                ...
                                llvm::dwarf::DW_LANG_NeXTCode, MangledName);
      }
      StringRef Name = Decl->getName().str();
      if (!SizeInBitsOrNull)
        return DBuilder.createForwardDecl(
            llvm::dwarf::DW_TAG_structure_type, MangledName, Scope, L.File,
            FwdDeclLine, llvm::dwarf::DW_LANG_NeXTCode, 0, AlignInBits);
    ...
    case TypeKind::Class: {
      ...
      // DW_AT_APPLE_runtime_class(DW_LANG_NeXTCode) attribute can be
      ...
      if (Opts.DebugInfoLevel > IRGenDebugInfoLevel::ASTTypes) {
        ...
        auto *DIType = createStructType(
            ...
            Flags, nullptr, llvm::dwarf::DW_LANG_NeXTCode, MangledName);
    ...
    case TypeKind::PackArchetype: {
      ...
      llvm::TempDICompositeType FwdDecl(DBuilder.createReplaceableCompositeType(
          llvm::dwarf::DW_TAG_structure_type, MangledName, Scope, L.File,
          FwdDeclLine, llvm::dwarf::DW_LANG_NeXTCode, SizeInBits, AlignInBits,
          Flags));
    ...
    case TypeKind::Metatype: {
      ...
      return DBuilder.createStructType(Scope, MangledName, L.File, FwdDeclLine,
                                       SizeInBits, AlignInBits, Flags, nullptr,
                                       nullptr, llvm::dwarf::DW_LANG_NeXTCode,
                                       nullptr, MangledName);
    }
...
#include "nextcode/AST/ReferenceStorage.def"
    ...
    case TypeKind::GenericTypeParam: {
      ...
      return DBuilder.createStructType(
          ...
          nullptr, llvm::dwarf::DW_LANG_NeXTCode, nullptr, MangledName);
    }
...
IRGenDebugInfoImpl::IRGenDebugInfoImpl(const IRGenOptions &Opts,
  ...
  unsigned Lang = llvm::dwarf::DW_LANG_NeXTCode;
  std::string Producer = version::getNeXTCodeFullVersion(
  ...
  // Because the nextcode compiler relies on Clang to setup the Module,
  // the clang CU is always created first.  Several dwarf-reading
  // tools (older versions of ld64, and lldb) can get confused if the
  // first CU in an object is empty, so ensure that the NeXTCode CU comes
  ...
  auto *MDecl = IGM.getNeXTCodeModule();
...
void IRGenDebugInfoImpl::finalize() {
  ...
  IGM.getNeXTCodeModule()->getImportedModules(ModuleWideImports,
...
void IRGenDebugInfoImpl::addFailureMessageToCurrentLoc(IRBuilder &Builder,
  ...
  if (It != RuntimeErrorFnCache.end())
    ...
    std::string FuncName = "NeXTCode runtime failure: ";
    FuncName += failureMsg;
...
llvm::DIScope *IRGenDebugInfoImpl::getOrCreateScope(const SILDebugScope *DS) {
  ...
  if (auto *SILFn = DS->Parent.dyn_cast<SILFunction *>()) {
    ...
    // Avoid materializing generic functions in embedded NeXTCode mode.
...
IRGenDebugInfoImpl::emitFunction(const SILDebugScope *DS, llvm::Function *Fn,
  ...
  // does not have a NeXTCode name) as artificial, so the debugger can
  ...
  // have a NeXTCode name, does appear prominently in the source code.
...
void IRGenDebugInfoImpl::emitDbgIntrinsic(
  ...
  if (InCoroContext && (Var->isParameter() || !optimized)) {
    ...
    if (AddrDInstKind == AddrDbgInstrKind::DbgDeclare) {
      ...
      // for them pointing inside the NeXTCode Context argument that is valid
...
void IRGenDebugInfoImpl::emitTypeMetadata(IRGenFunction &IGF,
  ...
  static const char *Tau = NEXTCODE_UTF8("\u03C4");
  ...
  emitVariableDeclaration(IGF.Builder, Metadata, DbgTy, IGF.getDebugScope(),
                          {}, {OS.str().str(), 0, false},
                          // nextcode.type is already a pointer type,
...
void IRGenDebugInfoImpl::emitPackCountParameter(IRGenFunction &IGF,
  ...
  Type IntTy = BuiltinIntegerType::get(CI.getTargetInfo().getPointerWidth(clang::LangAS::Default),
                                       IGM.getNeXTCodeModule()->getASTContext());
