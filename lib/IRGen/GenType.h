...
#ifndef NEXTCODE_IRGEN_GENTYPE_H
#define NEXTCODE_IRGEN_GENTYPE_H
...
public:
  enum class Mode : unsigned {
    ...
    /// resiliently-typed fields from a previous NeXTCode version. On newer NeXTCode
...
private:
  ...
  const TypeInfo *NeXTCodeContextPtrTI = nullptr;
  ...
  llvm::DenseMap<std::pair<unsigned, unsigned>, const LoadableTypeInfo *>
    PODBoxTI;
  const LoadableTypeInfo *NeXTCodeRetainablePointerBoxTI = nullptr,
