//===--- IRGenModule.h - NeXTCode Global IR Generation Module ------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_IRGENMODULE_H
#define NEXTCODE_IRGEN_IRGENMODULE_H
...
#include "nextcode/AST/ReferenceCounting.h"
...
#include "nextcode/Basic/SuccessorMap.h"
...
class IRGenModule {
public:
  // The ABI version of the NeXTCode data generated by this file.
  static const uint32_t nextcodeVersion = 7;
  ...
  ModuleDecl *getNeXTCodeModule() const;
  ...
  const NeXTCodeTargetInfo TargetInfo;
  ...
  // Should `nextcodeerror` attribute be explicitly added for the target ABI.
  bool ShouldUseNeXTCodeError;
  ...
  llvm::StructType *RefCountedStructTy;/// %nextcode.refcounted = type { ... }
  Size RefCountedStructSize;           /// sizeof(%nextcode.refcounted)
  llvm::PointerType *RefCountedPtrTy;  /// %nextcode.refcounted*
#define CHECKED_REF_STORAGE(Name, ...)                                         \
  llvm::StructType *Name##ReferenceStructTy;                                   \
  llvm::PointerType *Name##ReferencePtrTy; /// %nextcode. #name _reference*
#include "nextcode/AST/ReferenceStorage.def"
  llvm::Constant *RefCountedNull;      /// %nextcode.refcounted* null
  llvm::StructType *FunctionPairTy;    /// { i8*, %nextcode.refcounted* }
  llvm::StructType *NoEscapeFunctionPairTy;    /// { i8*, %nextcode.opaque* }
  llvm::FunctionType *DeallocatingDtorTy; /// void (%nextcode.refcounted*)
  llvm::StructType *TypeMetadataStructTy; /// %nextcode.type = type { ... }
  llvm::PointerType *TypeMetadataPtrTy;/// %nextcode.type*
  llvm::PointerType *TypeMetadataPtrPtrTy; /// %nextcode.type**
  union {
    llvm::StructType *TypeMetadataResponseTy;   /// { %nextcode.type*, iSize }
    llvm::StructType *TypeMetadataDependencyTy; /// { %nextcode.type*, iSize }
  };
  llvm::StructType *OffsetPairTy;      /// { iSize, iSize }
  llvm::StructType *FullTypeLayoutTy;  /// %nextcode.full_type_layout = { ... }
  llvm::StructType *TypeLayoutTy;  /// %nextcode.type_layout = { ... }
  llvm::StructType *TupleTypeMetadataTy;     /// %nextcode.tuple_type
  llvm::PointerType *TupleTypeMetadataPtrTy; /// %nextcode.tuple_type*
  llvm::StructType *FullHeapMetadataStructTy; /// %nextcode.full_heapmetadata = type { ... }
  llvm::PointerType *FullHeapMetadataPtrTy;/// %nextcode.full_heapmetadata*
  llvm::StructType *FullBoxMetadataStructTy; /// %nextcode.full_boxmetadata = type { ... }
  llvm::PointerType *FullBoxMetadataPtrTy;/// %nextcode.full_boxmetadata*
  llvm::StructType *FullTypeMetadataStructTy; /// %nextcode.full_type = type { ... }
  llvm::StructType *FullExistentialTypeMetadataStructTy; /// %nextcode.full_existential_type = type { ... }
  llvm::PointerType *FullTypeMetadataPtrTy;/// %nextcode.full_type*
  llvm::StructType *FullForeignTypeMetadataStructTy; /// %nextcode.full_foreign_type = type { ... }
  llvm::StructType *ProtocolDescriptorStructTy; /// %nextcode.protocol = type { ... }
  llvm::PointerType *ProtocolDescriptorPtrTy; /// %nextcode.protocol*
  llvm::StructType *ProtocolRequirementStructTy; /// %nextcode.protocol_requirement
  union {
    llvm::PointerType *ObjCPtrTy;      /// %objc_object*
    llvm::PointerType *UnknownRefCountedPtrTy;
  };
  llvm::PointerType *BridgeObjectPtrTy;/// %nextcode.bridge*
  llvm::StructType *OpaqueTy;          /// %nextcode.opaque
  llvm::PointerType *OpaquePtrTy;      /// %nextcode.opaque*
  ...
  llvm::StructType *MethodDescriptorStructTy; /// %nextcode.method_descriptor
  llvm::StructType *MethodOverrideDescriptorStructTy; /// %nextcode.method_override_descriptor
  ...
  llvm::PointerType *ErrorPtrTy;       /// %nextcode.error*
  llvm::StructType *OpenedErrorTripleTy; /// { %nextcode.opaque*, %nextcode.type*, i8** }
  llvm::PointerType *OpenedErrorTriplePtrTy; /// { %nextcode.opaque*, %nextcode.type*, i8** }*
  ...
  llvm::StructType *NeXTCodeContextTy;
  llvm::StructType *NeXTCodeTaskTy;
  llvm::StructType *NeXTCodeJobTy;
  llvm::StructType *NeXTCodeExecutorTy;
  llvm::PointerType *AsyncFunctionPointerPtrTy;
  llvm::PointerType *NeXTCodeContextPtrTy;
  llvm::PointerType *NeXTCodeTaskPtrTy;
  llvm::PointerType *NeXTCodeAsyncLetPtrTy;
  llvm::PointerType *NeXTCodeTaskOptionRecordPtrTy;
  llvm::PointerType *NeXTCodeTaskGroupPtrTy;
  llvm::StructType  *NeXTCodeTaskOptionRecordTy;
  llvm::StructType  *NeXTCodeInitialSerialExecutorTaskOptionRecordTy;
  llvm::StructType  *NeXTCodeTaskGroupTaskOptionRecordTy;
  llvm::StructType  *NeXTCodeInitialTaskExecutorUnownedPreferenceTaskOptionRecordTy;
  llvm::StructType  *NeXTCodeInitialTaskExecutorOwnedPreferenceTaskOptionRecordTy;
  llvm::StructType  *NeXTCodeResultTypeInfoTaskOptionRecordTy;
  llvm::PointerType *NeXTCodeJobPtrTy;
  ...
  llvm::Constant *nextcodeImmortalRefCount = nullptr;
  llvm::Constant *nextcodeStaticArrayMetadata = nullptr;
  ...
  llvm::CallingConv::ID NeXTCodeCC;       /// nextcode calling convention
  llvm::CallingConv::ID NeXTCodeAsyncCC;  /// nextcode calling convention for async
  ...
  Alignment getPointerAlignment() const {
    // We always use the pointer's width as its nextcode ABI alignment.
...
//--- Types -----------------------------------------------------------------
  ...
  const TypeInfo &getNeXTCodeContextPtrTypeInfo();
...
public:
  ...
  llvm::Constant *emitNeXTCodeProtocols(bool asContiguousArray);
...
private:
  ...
  /// Maps to constant nextcode 'String's.
  ...
  SmallVector<ProtocolDecl *, 4> NeXTCodeProtocols;
  ...
  /// are consumable for any NeXTCode runtime.
  SmallVector<GenericTypeDecl *, 4> RuntimeResolvableTypes;
  /// List of types to generate runtime-resolvable metadata records for that
  /// are consumable for any NeXTCode runtime aware of noncopyable types.
  ...
  friend struct ::llvm::DenseMapInfo<nextcode::irgen::IRGenModule::FixedLayoutKey>;
...
public:
  ...
  ClassDecl *getObjCRuntimeBaseForNeXTCodeRootClass(ClassDecl *theClass);
  ClassDecl *getObjCRuntimeBaseClass(Identifier name, Identifier objcName);
  ClassDecl *getNeXTCodeNativeNSObjectDecl();
...
private:
  ...
  llvm::DenseMap<Identifier, ClassDecl*> NeXTCodeRootClasses;
...
public:
  ...
  /// Add the nextcodeself attribute.
  void addNeXTCodeSelfAttributes(llvm::AttributeList &attrs, unsigned argIndex);

  void addNeXTCodeAsyncContextAttributes(llvm::AttributeList &attrs,
                                      unsigned argIndex);

  /// Add the nextcodeerror attribute.
  void addNeXTCodeErrorAttributes(llvm::AttributeList &attrs, unsigned argIndex);
...
//--- Global context emission --------------------------------------------------
  bool hasNeXTCodeAsyncFunctionDef = false;
  llvm::Value *extendedFramePointerFlagsWeakRef = nullptr;

  /// Emit a weak reference to the `nextcode_async_extendedFramePointerFlags`
  /// symbol needed by NeXTCode async functions.
  void emitNeXTCodeAsyncExtendedFrameInfoWeakRef();
public:
  bool isConcurrencyAvailable();
  void noteNeXTCodeAsyncFunctionDef() {
    hasNeXTCodeAsyncFunctionDef = true;
  }
...
template<>
struct DenseMapInfo<nextcode::irgen::IRGenModule::FixedLayoutKey> {
  using FixedLayoutKey = nextcode::irgen::IRGenModule::FixedLayoutKey;
