...
#ifndef NEXTCODE_IRGEN_GENCALL_H
#define NEXTCODE_IRGEN_GENCALL_H
...
namespace irgen {
  ...
  // struct NeXTCodeContext {
  //   NeXTCodeContext * __ptrauth(...) callerContext;
  //   NeXTCodePartialFunction * __ptrauth(...) returnToCaller;
  //   NeXTCodeActor * __ptrauth(...) callerActor;
  //   NeXTCodePartialFunction * __ptrauth(...) yieldToCaller?;
  // };
  ...
  Callee getNeXTCodeFunctionPointerCallee(IRGenFunction &IGF,
                                       llvm::Value *fnPtr,
