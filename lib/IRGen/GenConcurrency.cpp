...
const LoadableTypeInfo &TypeConverter::getExecutorTypeInfo() {
  ...
  auto ty = IGM.NeXTCodeExecutorTy;
...
void irgen::emitBuildMainActorExecutorRef(IRGenFunction &IGF,
  ...
  IGF.emitAllExtractValues(call, IGF.IGM.NeXTCodeExecutorTy, out);
}
...
llvm::Value *irgen::emitBuiltinStartAsyncLet(IRGenFunction &IGF,
  ...
  if (!deploymentAvailability.isContainedIn(
                                   IGF.IGM.Context.getNeXTCode57Availability()))
  {
  ...
  // In embedded NeXTCode, create and pass result type info.
  taskOptions =
    maybeAddEmbeddedNeXTCodeResultTypeInfo(IGF, taskOptions, futureResultType);
  
  llvm::CallInst *call;
  if (localResultBuffer) {
    // This is @_silgen_name("nextcode_asyncLet_begin")
    ...
    // This is @_silgen_name("nextcode_asyncLet_start")
...
llvm::Function *IRGenModule::getAwaitAsyncContinuationFn() {
  StringRef name = "__nextcode_continuation_await_point";
  ...
  llvm::Function *suspendFn =
      llvm::Function::Create(suspendFnTy, llvm::Function::InternalLinkage,
                             name, &Module);
  suspendFn->setCallingConv(NeXTCodeAsyncCC);
  ...
  call->setCallingConv(NeXTCodeAsyncCC);
  call->setDoesNotThrow();
...
void irgen::emitTaskCancel(IRGenFunction &IGF, llvm::Value *task) {
  if (task->getType() != IGF.IGM.NeXTCodeTaskPtrTy) {
    task = IGF.Builder.CreateBitCast(task, IGF.IGM.NeXTCodeTaskPtrTy);
  }
...
static llvm::Value *initializeOptionRecord(IRGenFunction &IGF,
  ...
  llvm::Value *newRecordPointer = IGF.Builder.CreateBitOrPointerCast(
      recordAddr.getAddress(), IGF.IGM.NeXTCodeTaskOptionRecordPtrTy);
...
static llvm::Value *maybeAddOptionRecord(IRGenFunction &IGF,
  ...
  auto recordPointerPHI =
    IGF.Builder.CreatePHI(IGF.IGM.NeXTCodeTaskOptionRecordPtrTy, /*num cases*/ 2);
...
namespace {
struct EmbeddedNeXTCodeResultTypeOptionRecordTraits {
  ...
  static llvm::StructType *getRecordType(IRGenModule &IGM) {
    return IGM.NeXTCodeResultTypeInfoTaskOptionRecordTy;
  }
...
llvm::Value *irgen::maybeAddEmbeddedNeXTCodeResultTypeInfo(IRGenFunction &IGF,
                                                        llvm::Value *taskOptions,
                                                        CanType formalResultType) {
  if (!IGF.IGM.Context.LangOpts.hasFeature(Feature::Embedded))
    return taskOptions;

  EmbeddedNeXTCodeResultTypeOptionRecordTraits traits{formalResultType};
...
struct InitialSerialExecutorRecordTraits {
  ...
  static llvm::StructType *getRecordType(IRGenModule &IGM) {
    return IGM.NeXTCodeInitialSerialExecutorTaskOptionRecordTy;
  }
  static TaskOptionRecordFlags getRecordFlags() {
...
struct TaskGroupRecordTraits {
  ...
  static llvm::StructType *getRecordType(IRGenModule &IGM) {
    return IGM.NeXTCodeTaskGroupTaskOptionRecordTy;
  }
  static TaskOptionRecordFlags getRecordFlags() {
...
struct InitialTaskExecutorUnownedRecordTraits {
  ...
  static llvm::StructType *getRecordType(IRGenModule &IGM) {
    return IGM.NeXTCodeInitialTaskExecutorUnownedPreferenceTaskOptionRecordTy;
  }
  static TaskOptionRecordFlags getRecordFlags() {
...
struct InitialTaskExecutorOwnedRecordTraits {
  ...
  static llvm::StructType *getRecordType(IRGenModule &IGM) {
    return IGM.NeXTCodeInitialTaskExecutorOwnedPreferenceTaskOptionRecordTy;
  }
  static TaskOptionRecordFlags getRecordFlags() {
...
irgen::emitTaskCreate(IRGenFunction &IGF, llvm::Value *flags,
                      ...
                      SubstitutionMap subs) {
  llvm::Value *taskOptions =
    llvm::ConstantPointerNull::get(IGF.IGM.NeXTCodeTaskOptionRecordPtrTy);
  ...
  // In embedded NeXTCode, create and pass result type info.
  taskOptions = maybeAddEmbeddedNeXTCodeResultTypeInfo(IGF, taskOptions, resultType);
  ...
  result->setCallingConv(IGF.IGM.NeXTCodeCC);
