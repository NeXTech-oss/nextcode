//===--- GenObjC.h - NeXTCode IR generation for Objective-C --------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_GENOBJC_H
#define NEXTCODE_IRGEN_GENOBJC_H
...
namespace irgen {
  ...
  public:
    ...
    /// FIXME: Thunk down to a NeXTCode function value?
    llvm::Value *getExplosionValue(IRGenFunction &IGF) const {
      llvm_unreachable("thunking unapplied objc method to nextcode function "
                       "not yet implemented");
    }
