//===--- GenProto.h - NeXTCode IR generation for prototypes --------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_GENPROTO_H
#define NEXTCODE_IRGEN_GENPROTO_H
...
namespace irgen {
  ...
  ///
  /// For NeXTCode protocols, this is a constant reference to the protocol
  /// descriptor symbol.
