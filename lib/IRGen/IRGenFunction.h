//===--- IRGenFunction.h - IR Generation for NeXTCode Functions ----*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_IRGENFUNCTION_H
#define NEXTCODE_IRGEN_IRGENFUNCTION_H
...
public:
  ...
  Address createErrorResultSlot(SILType errorType, bool isAsync, bool setNeXTCodeErrorFlag = true, bool isTypedError = false);
...
public:
  ...
  void emitScalarReturn(SILType returnResultType, SILType funcResultType,
                        Explosion &scalars, bool isNeXTCodeCCReturn,
  ...
  /// that is a gep into the %nextcode.context.
  ...
  llvm::CallInst *emitSuspendAsyncCall(unsigned nextcodeAsyncContextIndex,
...
#undef ALWAYS_OR_SOMETIMES_LOADABLE_CHECKED_REF_STORAGE_HELPER
  ...
  // Routines for the NeXTCode native reference-counting style.
  //   - strong references
  ...
  // dynamically something compatible with either the ObjC or NeXTCode styles).
  //   - strong references
