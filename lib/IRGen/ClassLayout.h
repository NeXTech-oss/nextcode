...
#ifndef NEXTCODE_IRGEN_CLASSLAYOUT_H
#define NEXTCODE_IRGEN_CLASSLAYOUT_H
...
enum class ClassMetadataFlags {
  ...
  /// where dropped due to the NeXTCode language version availability of
  /// their types?
  ...
  /// Is this class itself generic via the NeXTCode generic system, ie. not a
...
public:
  ...
  /// extension, and therefore should not have any NeXTCode-specific metadata.
