...
#ifndef NEXTCODE_IRGEN_CALLEE_H
#define NEXTCODE_IRGEN_CALLEE_H
...
namespace irgen {
  ...
  public:
    ...
    /// If this callee has a value for the NeXTCode context slot, return
    /// it; otherwise return non-null.
    llvm::Value *getNeXTCodeContext() const;
