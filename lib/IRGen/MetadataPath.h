...
#ifndef NEXTCODE_IRGEN_METADATAPATH_H
#define NEXTCODE_IRGEN_METADATAPATH_H

#include "nextcode/Basic/EncodedSequence.h"
...
/// A path from one source metadata --- either NeXTCode type metadata or a NeXTCode
