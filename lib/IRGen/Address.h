...
#ifndef NEXTCODE_IRGEN_ADDRESS_H
#define NEXTCODE_IRGEN_ADDRESS_H
...
namespace llvm {
template <>
struct DenseMapInfo<nextcode::irgen::Address> {
  static nextcode::irgen::Address getEmptyKey() {
    return nextcode::irgen::Address(DenseMapInfo<llvm::Value *>::getEmptyKey(),
                                 DenseMapInfo<llvm::Type *>::getEmptyKey(),
                                 nextcode::irgen::Alignment(8));
  }
  static nextcode::irgen::Address getTombstoneKey() {
    return nextcode::irgen::Address(DenseMapInfo<llvm::Value *>::getTombstoneKey(),
                                 DenseMapInfo<llvm::Type *>::getTombstoneKey(),
                                 nextcode::irgen::Alignment(8));
  }
  static unsigned getHashValue(nextcode::irgen::Address address) {
    return detail::combineHashValue(
        ...
        detail::combineHashValue(
            ...
            DenseMapInfo<nextcode::irgen::Alignment::int_type>::getHashValue(
                address.getAlignment().getValue())));
  }
  static bool isEqual(nextcode::irgen::Address LHS, nextcode::irgen::Address RHS) {
    return LHS == RHS;
  }
};
template <>
struct DenseMapInfo<nextcode::irgen::StackAddress> {
  static nextcode::irgen::StackAddress getEmptyKey() {
    return nextcode::irgen::StackAddress(
        DenseMapInfo<nextcode::irgen::Address>::getEmptyKey(),
        DenseMapInfo<llvm::Value *>::getEmptyKey());
  }
  static nextcode::irgen::StackAddress getTombstoneKey() {
    return nextcode::irgen::StackAddress(
        DenseMapInfo<nextcode::irgen::Address>::getTombstoneKey(),
        DenseMapInfo<llvm::Value *>::getTombstoneKey());
  }
  static unsigned getHashValue(nextcode::irgen::StackAddress address) {
    return detail::combineHashValue(
        DenseMapInfo<nextcode::irgen::Address>::getHashValue(address.getAddress()),
        DenseMapInfo<nextcode::irgen::Alignment::int_type>::getHashValue(
            address.getAlignment().getValue()));
  }
  static bool isEqual(nextcode::irgen::StackAddress LHS,
                      nextcode::irgen::StackAddress RHS) {
    return LHS == RHS;
  }
};
} // end namespace llvm
