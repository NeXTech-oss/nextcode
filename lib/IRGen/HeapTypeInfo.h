...
#ifndef NEXTCODE_IRGEN_HEAPTYPEINFO_H
#define NEXTCODE_IRGEN_HEAPTYPEINFO_H
...
/// if it's known to be OK to use NeXTCode reference-counting on values
/// of this type:
...
public:
  HeapTypeInfo(ReferenceCounting refcounting, llvm::PointerType *storage,
    ...
    : super(nextcode::irgen::refcountingToScalarKind(refcounting), storage,
  ...
  IsaEncoding getIsaEncoding(ResilienceExpansion expansion) const {
    ...
    // We can access the isa of pure NeXTCode heap objects directly.
