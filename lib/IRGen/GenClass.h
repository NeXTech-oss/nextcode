//===--- GenClass.h - NeXTCode IR generation for classes -----------*- C++ -*-===//
//
/*
...
#ifndef NEXTCODE_IRGEN_GENCLASS_H
#define NEXTCODE_IRGEN_GENCLASS_H
...
namespace irgen {
  ...
  bool hasKnownNeXTCodeMetadata(IRGenModule &IGM, ClassDecl *theClass);
  ...
  /// Is the given class-like type known to have NeXTCode-compatible
  /// metadata?
  bool hasKnownNeXTCodeMetadata(IRGenModule &IGM, CanType theType);
