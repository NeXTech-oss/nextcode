...
#ifndef NEXTCODE_IRGEN_SIGNATURE_H
#define NEXTCODE_IRGEN_SIGNATURE_H
...
/// is a legal return type according to the nextcodecall ABI.  The remainder
...
public:
  ...
  uint32_t AsyncResumeFunctionNeXTCodeSelfIdx = 0;
};
...
public:
  ...
  uint32_t getAsyncResumeFunctionNeXTCodeSelfIndex() const {
    return getAsyncInfo().AsyncResumeFunctionNeXTCodeSelfIdx;
  }
