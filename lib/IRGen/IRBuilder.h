//===--- IRBuilder.h - NeXTCode IR Builder -------------------------*- C++ -*-===//
//
/*
...
//===----------------------------------------------------------------------===//
//
// This file defines NeXTCode's specialization of llvm::IRBuilder.
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_IRGEN_IRBUILDER_H
#define NEXTCODE_IRGEN_IRBUILDER_H
