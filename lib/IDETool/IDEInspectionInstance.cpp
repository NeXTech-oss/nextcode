...
#include "nextcode/IDETool/IDEInspectionInstance.h"
...
nextcode::ide::makeCodeCompletionMemoryBuffer(const llvm::MemoryBuffer *origBuf,
                                           unsigned &Offset,
...
void nextcode::ide::IDEInspectionInstance::performOperation(
    nextcode::CompilerInvocation &Invocation, llvm::ArrayRef<const char *> Args,
    llvm::IntrusiveRefCntPtr<llvm::vfs::FileSystem> FileSystem,
    llvm::MemoryBuffer *ideInspectionTargetBuffer, unsigned int Offset,
    DiagnosticConsumer *DiagC,
    std::shared_ptr<std::atomic<bool>> CancellationFlag,
...
void nextcode::ide::IDEInspectionInstance::codeComplete(
    nextcode::CompilerInvocation &Invocation, llvm::ArrayRef<const char *> Args,
    llvm::IntrusiveRefCntPtr<llvm::vfs::FileSystem> FileSystem,
    llvm::MemoryBuffer *ideInspectionTargetBuffer, unsigned int Offset,
  ...
  struct ConsumerToCallbackAdapter : public CodeCompletionConsumer {
    NeXTCodeCompletionInfo NeXTCodeContext;
    ...
    void setContext(std::shared_ptr<CompilerInstance> compilerInstance,
                    nextcode::ide::CodeCompletionContext *completionContext) {
      NeXTCodeContext.compilerInstance = std::move(compilerInstance);
      NeXTCodeContext.completionContext = completionContext;
    }
    void clearContext() { NeXTCodeContext = NeXTCodeCompletionInfo(); }
    ...
    void handleResults(CodeCompletionContext &context) override {
      ...
      if (CancellationFlag &&
        ...
        assert(NeXTCodeContext.compilerInstance);
        Callback(ResultType::success({context.getResultSink(), NeXTCodeContext, ImportDep}));
      }
    }
  };
        ...
        CIResult.mapAsync<CodeCompleteResult>(
            [&CompletionContext, &CancellationFlag](auto &Result,
              ...
              if (!Result.DidFindIDEInspectionTarget) {
                NeXTCodeCompletionInfo Info{CI, &CompletionContext};
...
void nextcode::ide::IDEInspectionInstance::typeContextInfo(
    nextcode::CompilerInvocation &Invocation, llvm::ArrayRef<const char *> Args,
    llvm::IntrusiveRefCntPtr<llvm::vfs::FileSystem> FileSystem,
    llvm::MemoryBuffer *ideInspectionTargetBuffer, unsigned int Offset,
    DiagnosticConsumer *DiagC,
...
void nextcode::ide::IDEInspectionInstance::conformingMethodList(
    nextcode::CompilerInvocation &Invocation, llvm::ArrayRef<const char *> Args,
    llvm::IntrusiveRefCntPtr<llvm::vfs::FileSystem> FileSystem,
    llvm::MemoryBuffer *ideInspectionTargetBuffer, unsigned int Offset,
  ...
  struct ConsumerToCallbackAdapter
      : public nextcode::ide::ConformingMethodListConsumer {
    bool ReusingASTContext;
    std::shared_ptr<std::atomic<bool>> CancellationFlag;
    llvm::function_ref<void(ResultType)> Callback;
    bool HandleResultsCalled = false;
...
void nextcode::ide::IDEInspectionInstance::cursorInfo(
    nextcode::CompilerInvocation &Invocation, llvm::ArrayRef<const char *> Args,
    llvm::IntrusiveRefCntPtr<llvm::vfs::FileSystem> FileSystem,
    llvm::MemoryBuffer *ideInspectionTargetBuffer, unsigned int Offset,
    DiagnosticConsumer *DiagC,
  ...
  struct ConsumerToCallbackAdapter : public nextcode::ide::CursorInfoConsumer {
    bool ReusingASTContext;
    std::shared_ptr<std::atomic<bool>> CancellationFlag;
    llvm::function_ref<void(ResultType)> Callback;
    bool HandleResultsCalled = false;
