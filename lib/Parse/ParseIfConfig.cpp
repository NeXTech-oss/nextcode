//===--- ParseIfConfig.cpp - NeXTCode Language Parser for #if directives -----===//
//
/*
...
public:
  ...
  // Fold sequence expression for non-NeXTCode3 mode.
...
public:
  ...
  bool visitCallExpr(CallExpr *E) {
    ...
    } else if ((KindName == "nextcode") || (KindName == "compiler") ||
               (KindName == "_compiler_version")) {
...
public:
  ...
  bool visitCallExpr(CallExpr *E) {
    auto KindName = getDeclRefStr(E->getFn());
    return KindName == "_compiler_version" || KindName == "nextcode" ||
        KindName == "compiler";
  }
