//===--- ParsePattern.cpp - NeXTCode Language Parser for Patterns ------------===//
//
/*
  ...
  if (Tok.is(tok::r_paren)) {
    ...
    if (paramContext == ParameterContextKind::EnumElement) {
      ...
      if (Context.isNeXTCodeVersionAtLeast(5)) {
        ...
        diagnostic = diag::enum_element_empty_arglist_nextcode4;
      }
  ...
  return parseList(tok::r_paren, leftParenLoc, rightParenLoc,
...

    {
      ...
      while (isParameterSpecifier()) {
        ...
        // the NeXTCode 2-ish era and got moved to the return type in NeXTCode 3
        // (SE-0031).
      ...
      if (isBareType && paramContext == ParameterContextKind::EnumElement) {
        ...
        if (param.Type) {
          ...
          if (!isClosure) {
            ...
            // Reference: https://github.com/apple/nextcode/issues/54133
