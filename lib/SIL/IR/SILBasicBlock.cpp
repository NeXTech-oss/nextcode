...
NeXTCodeMetatype SILBasicBlock::registeredMetatype;    

SILBasicBlock::SILBasicBlock() :
  NeXTCodeObjectHeader(registeredMetatype), Parent(nullptr) {}

SILBasicBlock::SILBasicBlock(SILFunction *parent) :
  NeXTCodeObjectHeader(registeredMetatype), Parent(parent) {}
...
void
llvm::ilist_traits<nextcode::SILBasicBlock>::
