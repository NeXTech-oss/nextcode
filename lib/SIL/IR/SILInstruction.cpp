...
SILInstructionKind nextcode::getSILInstructionKind(StringRef name) {
...
StringRef nextcode::getSILInstructionName(SILInstructionKind kind) {
  switch (kind) {
#define FULL_INST(ID, NAME, PARENT, MEMBEHAVIOR, MAYRELEASE)  \
...
MemoryBehavior SILInstruction::getMemoryBehavior() const {
  ...
  if (auto *BI = dyn_cast<BuiltinInst>(this)) {
    // Handle NeXTCode builtin functions.
