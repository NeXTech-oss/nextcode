...
void nextcode::changeBranchTarget(TermInst *T, unsigned edgeIdx,
...
void nextcode::getEdgeArgs(TermInst *T, unsigned edgeIdx, SILBasicBlock *newEdgeBB,
...
SILBasicBlock *nextcode::splitEdge(TermInst *T, unsigned edgeIdx,
...
void nextcode::mergeBasicBlockWithSingleSuccessor(SILBasicBlock *BB,
...
void nextcode::findJointPostDominatingSet(
...
bool
nextcode::checkDominates(SILBasicBlock *sourceBlock, SILBasicBlock *destBlock) {
