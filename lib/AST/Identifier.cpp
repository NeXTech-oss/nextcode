...
void nextcode::simple_display(llvm::raw_ostream &out, DeclName name) {
  out << "'" << name << "'";
}
...
void nextcode::simple_display(llvm::raw_ostream &out, DeclNameRef name) {
  out << "'" << name << "'";
}

raw_ostream &llvm::operator<<(raw_ostream &OS, nextcode::ObjCSelector S) {
