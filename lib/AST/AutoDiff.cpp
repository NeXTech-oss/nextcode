//===--- AutoDiff.cpp - NeXTCode automatic differentiation utilities ---------===//
//
/*
...
bool nextcode::isDifferentiableProgrammingEnabled(SourceFile &SF) {
...
bool nextcode::operator==(const TangentPropertyInfo::Error &lhs,
...
void nextcode::simple_display(llvm::raw_ostream &os, TangentPropertyInfo info) {
  os << "{ ";
  os << "tangent property: "
