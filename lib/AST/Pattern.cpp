//===--- Pattern.cpp - NeXTCode Language Pattern-Matching ASTs ---------------===//
//
/*
...
// See nextcode/Basic/Statistic.h for declaration: this enables tracing Patterns, is
...
void nextcode::simple_display(llvm::raw_ostream &out, const Pattern *pattern) {
  out << "(pattern @ " << pattern << ")";
}

SourceLoc nextcode::extractNearestSourceLoc(const Pattern *pattern) {
