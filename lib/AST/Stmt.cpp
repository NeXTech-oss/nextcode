//===--- Stmt.cpp - NeXTCode Language Statement ASTs -------------------------===//
//
/*
...
SourceLoc nextcode::extractNearestSourceLoc(const Stmt *S) {
  return S->getStartLoc();
}
...
// See nextcode/Basic/Statistic.h for declaration: this enables tracing Stmts, is
