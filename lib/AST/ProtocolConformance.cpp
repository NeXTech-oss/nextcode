...
ConditionalRequirementsRequest::evaluate(Evaluator &evaluator,
  ...
  // parameters. (NB. if/when NeXTCode gets parameterized extensions, this needs to
  // change.)
...
SourceLoc nextcode::extractNearestSourceLoc(const ProtocolConformance *conformance) {
