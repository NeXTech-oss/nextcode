...
#include "nextcode/AST/ASTBridgingImpl.h"
#endif
...
BridgedDiagnosticArgument::BridgedDiagnosticArgument(NeXTCodeInt i)
...
BridgedNeXTCodeNativeObjCRuntimeBaseAttr_createParsed(BridgedASTContext cContext,
  ...
  return new (cContext.unbridged())
      NeXTCodeNativeObjCRuntimeBaseAttr(cName.unbridged(), cAtLoc.unbridged(),
...
bool BridgedNominalTypeDecl_isStructWithUnreferenceableStorage(
  ...
  if (auto *structDecl = dyn_cast<nextcode::StructDecl>(decl.unbridged())) {
