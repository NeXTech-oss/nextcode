...
//===----------------------------------------------------------------------===//
//
// This file implements routines for converting NeXTCode AST interface types to
// rewrite system terms.
//
// A type parameter in NeXTCode is a GenericTypeParamType wrapped in zero or
...
// used by NeXTCode's ABI and name mangling. What this means in practice is that
...
// to map associated type symbols back to NeXTCode types.
//
...
/// extracting a structural sub-component or performing a (NeXTCode AST)
...
/// original substitutions {X.Y}, and perform a NeXTCode AST subst() to get
