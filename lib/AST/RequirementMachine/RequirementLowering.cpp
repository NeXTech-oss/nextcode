...
void
nextcode::rewriting::desugarRequirement(
                                  Requirement req,
                                  SourceLoc loc,
                                  SmallVectorImpl<Requirement> &result,
                                  SmallVectorImpl<InverseRequirement> &inverses,
...
void nextcode::rewriting::desugarRequirements(
...
void nextcode::rewriting::inferRequirements(
...
void nextcode::rewriting::realizeRequirement(
    DeclContext *dc,
...
void nextcode::rewriting::applyInverses(
    ASTContext &ctx,
    ArrayRef<Type> gps,
...
void nextcode::rewriting::realizeInheritedRequirements(
