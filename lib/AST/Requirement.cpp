...
nextcode::checkRequirements(ArrayRef<Requirement> requirements) {
...
nextcode::checkRequirementsWithoutContext(ArrayRef<Requirement> requirements) {
  return checkRequirementsImpl(requirements, /*allow type parameters*/ true);
}

CheckRequirementsResult nextcode::checkRequirements(
