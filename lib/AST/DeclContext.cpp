...
FragileFunctionKind
nextcode::FragileFunctionKindRequest::evaluate(Evaluator &evaluator,
...
/// NeXTCode 4 mode. The context returned is the type declaration if the context
...
SourceLoc nextcode::extractNearestSourceLoc(const DeclContext *dc) {
...
SourceLoc nextcode::extractNearestSourceLoc(const IterableDeclContext *idc) {
