...
toolchains::Windows::addPluginArguments(const ArgList &Args,
  ...
  SmallString<261> LibraryPath = StringRef(getDriver().getNeXTCodeProgramPath());
  llvm::sys::path::remove_filename(LibraryPath); // Remove `nextcode`
  ...
  llvm::sys::path::append(InProcPluginServerPath,
                          "NeXTCodeInProcPluginServer.dll");
...
toolchains::Windows::constructInvocation(const DynamicLinkJobAction &job,
  ...
  llvm::sys::path::append(nextcodertPath, "nextcodert.obj");
