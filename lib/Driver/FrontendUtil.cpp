...
void nextcode::driver::ExpandResponseFilesWithRetry(llvm::StringSaver &Saver,
...
bool nextcode::driver::getSingleFrontendInvocationFromDriverArguments(
  ...
  Args.push_back("<codec>"); // FIXME: Remove dummy argument.
  ...
  // Force the driver into batch mode by specifying "codec" as the name.
  Driver TheDriver(DriverPath, "codec", Args, Diags);
