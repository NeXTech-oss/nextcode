...
/// function call is annotated as "read-only", then it is safe. Since NeXTCode does
...
#include "nextcode/SILOptimizer/Analysis/VisitBarrierAccessScopes.h"
...
namespace {
class DestroyAddrHoisting : public nextcode::SILFunctionTransform {
  void run() override;
};
...
SILTransform *nextcode::createDestroyAddrHoisting() {
