...
struct ValueUseToDeclInferrer {
  ...
  SmallPtrSet<nextcode::SILInstruction *, 8> visitedDebugValueInsts;
...
bool ValueToDeclInferrer::infer(
  ...
  NEXTCODE_DEFER { accessPath.clear(); };
  ...
  while (true) {
    ...
    //
    //   %0 = global_addr @_nextcodeEmptyArrayStorage : $*_NeXTCodeEmptyArrayStorage
    //   %1 = address_to_pointer %0 : $*_NeXTCodeEmptyArrayStorage to
...
SILTransform *nextcode::createAssemblyVisionRemarkGenerator() {
