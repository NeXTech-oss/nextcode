...
SILFunction *PromotedParamCloner::initCloned(SILOptFunctionBuilder &FuncBuilder,
  ...
  auto *Fn = FuncBuilder.createFunction(
      nextcode::getSpecializedLinkage(Orig, Orig->getLinkage()), ClonedName,
...
static void rewriteApplySites(AllocBoxToStackState &pass) {
  nextcode::SmallBlotMapVector<ApplySite, ArgIndexList, 8> AppliesToSpecialize;
...
SILTransform *nextcode::createAllocBoxToStack() {
