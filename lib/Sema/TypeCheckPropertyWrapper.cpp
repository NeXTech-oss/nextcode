...
Type nextcode::computeWrappedValueType(const VarDecl *var, Type backingStorageType,
...
Type nextcode::computeProjectedValueType(const VarDecl *var, Type backingStorageType) {
...
Expr *nextcode::buildPropertyWrapperInitCall(
...
bool nextcode::isWrappedValueOfPropWrapper(VarDecl *var) {
  if (!var->isStatic())
