...
ConstraintSystem::matchResultBuilder(AnyFunctionRef fn, Type builderType,
  ...
  // https://github.com/apple/nextcode/issues/64332.
  auto request =
...
Type nextcode::inferResultBuilderComponentType(NominalTypeDecl *builder) {
  Type componentType;
...
nextcode::determineResultBuilderBuildFixItInfo(NominalTypeDecl *builder) {
...
void nextcode::printResultBuilderBuildFunction(
