...
TermInst *nextcode::addNewEdgeValueToBranch(TermInst *branch, SILBasicBlock *dest,
                                         SILValue val,
...
TermInst *nextcode::deleteEdgeValue(TermInst *branch, SILBasicBlock *destBlock,
...
void nextcode::erasePhiArgument(SILBasicBlock *block, unsigned argIndex,
...
/// specified index.
TermInst *nextcode::changeEdgeValue(TermInst *branch, SILBasicBlock *dest,
...
bool nextcode::isCriticalEdge(TermInst *t, unsigned edgeIdx) {
...
SILBasicBlock *nextcode::createSplitBranchTarget(SILBasicBlock *targetBlock,
                                              SILBuilder &builder,
                                              SILLocation loc) {
...
SILBasicBlock *nextcode::splitBasicBlockAndBranch(SILBuilder &builder,
...
void nextcode::splitEdgesFromTo(SILBasicBlock *From, SILBasicBlock *To,
...
SILBasicBlock *nextcode::splitCriticalEdge(TermInst *t, unsigned edgeIdx,
                                        DominanceInfo *domInfo,
                                        SILLoopInfo *loopInfo) {
...
bool nextcode::splitCriticalEdgesFrom(SILBasicBlock *fromBB,
                                   DominanceInfo *domInfo,
                                   SILLoopInfo *loopInfo) {
  bool changed = false;
...
bool nextcode::splitCriticalEdgesTo(SILBasicBlock *toBB, DominanceInfo *domInfo,
                                 SILLoopInfo *loopInfo) {
  bool changed = false;
...
bool nextcode::hasCriticalEdges(SILFunction &f, bool onlyNonCondBr) {
...
bool nextcode::splitAllCriticalEdges(SILFunction &f, DominanceInfo *domInfo,
                                  SILLoopInfo *loopInfo) {
  bool changed = false;
...
/// merged.
bool nextcode::mergeBasicBlockWithSuccessor(SILBasicBlock *bb,
                                         DominanceInfo *domInfo,
                                         SILLoopInfo *loopInfo) {
...
bool nextcode::mergeBasicBlocks(SILFunction *f) {
  bool merged = false;
...
SILBasicBlock *nextcode::splitIfCriticalEdge(SILBasicBlock *from,
                                          SILBasicBlock *to,
                                          DominanceInfo *domInfo,
                                          SILLoopInfo *loopInfo) {
...
bool nextcode::splitAllCondBrCriticalEdgesWithNonTrivialArgs(
...
bool nextcode::isTrapNoReturnFunction(SILFunction *f) {
...
bool nextcode::findAllNonFailureExitBBs(
