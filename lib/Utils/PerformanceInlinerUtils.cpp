...
SILValue nextcode::stripFunctionConversions(SILValue val) {
...
SemanticFunctionLevel nextcode::getSemanticFunctionLevel(SILFunction *function) {
...
bool nextcode::isNestedSemanticCall(FullApplySite apply) {
...
SILFunction *nextcode::getEligibleFunction(FullApplySite AI,
  ...
  bool IsInStdlib = (NeXTCodeModule->isStdlibModule() ||
                     NeXTCodeModule->isOnoneSupportModule());
...
static bool hasInterestingSideEffect(SILInstruction *I) {
  switch (I->getKind()) {
    ...
    case nextcode::SILInstructionKind::StrongRetainInst:
    case nextcode::SILInstructionKind::StrongReleaseInst:
    case nextcode::SILInstructionKind::RetainValueInst:
    case nextcode::SILInstructionKind::ReleaseValueInst:
    case nextcode::SILInstructionKind::StoreInst:
    case nextcode::SILInstructionKind::DeallocStackRefInst:
    case nextcode::SILInstructionKind::DeallocRefInst:
      return false;
    default:
...
bool nextcode::isPureCall(FullApplySite AI, BasicCalleeAnalysis *BCA) {
