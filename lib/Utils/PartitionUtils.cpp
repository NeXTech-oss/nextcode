...
bool nextcode::PartitionPrimitives::REGIONBASEDISOLATION_ENABLE_VERBOSE_LOGGING;
...
static llvm::cl::opt<bool, true> // The parser
    RegionBasedIsolationVerboseLog(
        ...
        llvm::cl::desc("Enable verbose logging for SIL region based isolation "
                       "diagnostics"),
        llvm::cl::Hidden,
        llvm::cl::location(nextcode::PartitionPrimitives::
...
void Partition::trackNewElement(Element newElt, bool updateHistory) {
  NEXTCODE_DEFER { validateRegionToTransferredOpMapRegions(); };
