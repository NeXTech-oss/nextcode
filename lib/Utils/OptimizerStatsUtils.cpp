...
void nextcode::updateSILModuleStatsAfterTransform(SILModule &M,
                                               SILTransform *Transform,
                                               SILPassManager &PM,
...
void nextcode::updateSILModuleStatsBeforeTransform(SILModule &M,
                                                SILTransform *Transform,
                                                SILPassManager &PM,
                                                int PassNumber) {
...
SILAnalysis *nextcode::createOptimizerStatsAnalysis(SILModule *M) {
