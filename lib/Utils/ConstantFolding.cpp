...
APInt nextcode::constantFoldBitOperation(APInt lhs, APInt rhs, BuiltinValueKind ID) {
  switch (ID) {
...
APInt nextcode::constantFoldComparisonFloat(APFloat lhs, APFloat rhs,
                                         BuiltinValueKind ID) {
  bool result;
...
APInt nextcode::constantFoldComparisonInt(APInt lhs, APInt rhs,
                                       BuiltinValueKind ID) {
  bool result;
  switch (ID) {
...
APInt nextcode::constantFoldBinaryWithOverflow(APInt lhs, APInt rhs,
                                            bool &Overflow,
...
APInt nextcode::constantFoldDiv(APInt lhs, APInt rhs, bool &Overflow,
                             BuiltinValueKind ID) {
...
APInt nextcode::constantFoldCast(APInt val, const BuiltinInfo &BI) {
  // Get the cast result.
...
/// SIL instruction is specified using hex-float notation in the NeXTCode source.
...
SILValue nextcode::constantFoldBuiltin(BuiltinInst *BI,
                                    std::optional<bool> &ResultsInError) {
