...
bool nextcode::canonicalizeLoop(SILLoop *L, DominanceInfo *DT, SILLoopInfo *LI) {
...
bool nextcode::canonicalizeAllLoops(DominanceInfo *DT, SILLoopInfo *LI) {
...
bool nextcode::canDuplicateLoopInstruction(SILLoop *L, SILInstruction *I) {
