...
#ifndef NEXTCODE_REFACTORING_ASYNCREFACTORING_H
#define NEXTCODE_REFACTORING_ASYNCREFACTORING_H
...
struct LabeledReturnType {
  ...
  LabeledReturnType(Identifier Label, nextcode::Type Ty) : Label(Label), Ty(Ty) {}
};
...
struct AsyncHandlerDesc {
  ...
  /// error type.
  std::optional<nextcode::Type> getErrorType() const;
  ...
  // type T.
  nextcode::Type getSuccessParamAsyncReturnType(nextcode::Type Ty) const;
  ...
  bool shouldUnwrap(nextcode::Type Ty) const {
