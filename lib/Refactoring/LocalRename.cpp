...
nextcode::ide::getRenameInfo(ResolvedCursorInfoPtr cursorInfo) {
...
RenameLocs nextcode::ide::localRenameLocs(SourceFile *SF,
...
nextcode::ide::findLocalRenameRanges(SourceFile *SF, RangeConfig Range) {
  using ResultType =
      CancellableResult<std::vector<SyntacticRenameRangeDetails>>;
