...
ExtractCheckResult
nextcode::refactoring::checkExtractConditions(const ResolvedRangeInfo &RangeInfo,
  ...
  case nextcode::DeclContextKind::GenericTypeDecl:
  case nextcode::DeclContextKind::ExtensionDecl:
