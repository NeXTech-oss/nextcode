...
#ifndef NEXTCODE_FRONTEND_ARGSTOFRONTENDOUTPUTSCONVERTER_H
#define NEXTCODE_FRONTEND_ARGSTOFRONTENDOUTPUTSCONVERTER_H
...
#endif /* NEXTCODE_FRONTEND_ARGSTOFRONTENDOUTPUTSCONVERTER_H */
