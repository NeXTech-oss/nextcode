...
std::error_code ExplicitModuleInterfaceBuilder::buildNeXTCodeModuleFromInterface(
  ...
  NEXTCODE_DEFER {
    ...
    if (Instance.getASTContext().hadError()) {
      auto builtByCompiler = getNeXTCodeInterfaceCompilerVersionForCurrentCompiler(
...
bool ImplicitModuleInterfaceBuilder::buildNeXTCodeModuleInternal(
    StringRef OutPath,
        ...
        [&](SubCompilerInstanceInfo &info) {
          auto EBuilder = ExplicitModuleInterfaceBuilder(
              *info.Instance, rebuildDiags, sourceMgr, moduleCachePath, backupInterfaceDir,
              ...
              dependencyTracker);
          return EBuilder.buildNeXTCodeModuleFromInterface(
...
bool ImplicitModuleInterfaceBuilder::buildNeXTCodeModule(StringRef OutPath,
                                                      bool ShouldSerializeDeps,
                                                      std::unique_ptr<llvm::MemoryBuffer> *ModuleBuffer,
  ...
  auto build = [&]() {
    ...
    return buildNeXTCodeModuleInternal(OutPath, ShouldSerializeDeps,
  ...
  case llvm::LockFileManager::LFS_Shared: {
    ...
    case llvm::LockFileManager::Res_Timeout: {
      ...
      // another process to complete the build so nextcode does not do it done
