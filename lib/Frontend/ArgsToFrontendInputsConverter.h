...
#ifndef NEXTCODE_FRONTEND_ARGSTOFRONTENDINPUTSCONVERTER_H
#define NEXTCODE_FRONTEND_ARGSTOFRONTENDINPUTSCONVERTER_H
...
#endif /* NEXTCODE_FRONTEND_ARGSTOFRONTENDINPUTSCONVERTER_H */
