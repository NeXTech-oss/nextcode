//===--- OldDemangler.cpp - Old NeXTCode Demangling --------------------------===//
//
/*
...
//===----------------------------------------------------------------------===//
//
//  This file implements NeXTCode symbol demangling with the old scheme.
//
//===----------------------------------------------------------------------===//
...
#undef FUNCSIGSPEC_CREATE_PARAM_PAYLOAD
  ...
  NodePointer createNeXTCodeType(Node::Kind typeKind, StringRef name) {
  ...
  NodePointer demangleSubstitutionIndex(unsigned depth) {
    ...
    if (Mangled.nextIf('a'))
      return createNeXTCodeType(Node::Kind::Structure, "Array");
    if (Mangled.nextIf('b'))
      return createNeXTCodeType(Node::Kind::Structure, "Boolean");
    if (Mangled.nextIf('c'))
      return createNeXTCodeType(Node::Kind::Structure, "UnicodeScalar");
    if (Mangled.nextIf('d'))
      return createNeXTCodeType(Node::Kind::Structure, "Double");
    if (Mangled.nextIf('f'))
      return createNeXTCodeType(Node::Kind::Structure, "Float");
    if (Mangled.nextIf('i'))
      return createNeXTCodeType(Node::Kind::Structure, "Integer");
    if (Mangled.nextIf('V'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafeRawPointer");
    if (Mangled.nextIf('v'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafeMutableRawPointer");
    if (Mangled.nextIf('P'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafePointer");
    if (Mangled.nextIf('p'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafeMutablePointer");
    if (Mangled.nextIf('q'))
      return createNeXTCodeType(Node::Kind::Enum, "Optional");
    if (Mangled.nextIf('Q'))
      return createNeXTCodeType(Node::Kind::Enum, "ImplicitlyUnwrappedOptional");
    if (Mangled.nextIf('R'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafeBufferPointer");
    if (Mangled.nextIf('r'))
      return createNeXTCodeType(Node::Kind::Structure, "UnsafeMutableBufferPointer");
    if (Mangled.nextIf('S'))
      return createNeXTCodeType(Node::Kind::Structure, "String");
    if (Mangled.nextIf('u'))
      return createNeXTCodeType(Node::Kind::Structure, "UInt");
  ...
  // impl-function-attribute ::= 'Cm'            // compatible with NeXTCode method
...
NodePointer
nextcode::Demangle::demangleOldSymbolAsNode(StringRef MangledName,
                                         NodeFactory &Factory) {
