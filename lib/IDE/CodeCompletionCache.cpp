...
namespace nextcode {
  namespace ide {
    struct CodeCompletionCacheImpl {
      ...
      sys::Cache<Key, ValueRefCntPtr> TheCache{"nextcode.libIDE.CodeCompletionCache"};
    };
  } // end namespace ide
...
namespace nextcode {
  namespace sys {
    template<>
    struct CacheValueCostInfo<nextcode::ide::CodeCompletionCacheImpl::Value> {
      static size_t
      getCost(const nextcode::ide::CodeCompletionCacheImpl::Value &V) {
