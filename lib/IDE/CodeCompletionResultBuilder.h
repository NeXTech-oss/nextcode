...
#ifndef NEXTCODE_LIB_IDE_CODE_COMPLETION_RESULT_BUILDER_H
#define NEXTCODE_LIB_IDE_CODE_COMPLETION_RESULT_BUILDER_H
...
#endif // NEXTCODE_LIB_IDE_CODE_COMPLETION_RESULT_BUILDER_H
