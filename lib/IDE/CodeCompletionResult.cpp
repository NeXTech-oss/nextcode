...
CodeCompletionMacroRoles nextcode::ide::getCompletionMacroRoles(const Decl *D) {
...
nextcode::ide::getCompletionMacroRoles(OptionSet<CustomAttributeKind> kinds) {
  CodeCompletionMacroRoles roles;
...
CodeCompletionMacroRoles
nextcode::ide::getCompletionMacroRoles(CodeCompletionFilter filter) {
  CodeCompletionMacroRoles roles;
...
nextcode::ide::getCompletionFilter(CodeCompletionMacroRoles roles) {
