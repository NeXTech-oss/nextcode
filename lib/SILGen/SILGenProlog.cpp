  ...
  void makeArgumentIntoBinding(SILLocation loc, ParamDecl *pd) {
    ...
    if (auto *arg = dyn_cast<SILFunctionArgument>(argrv.getValue())) {
      if (arg->isNoImplicitCopy()) {
        ...
        case nextcode::ParamSpecifier::Borrowing:
          ...
          break;
        case nextcode::ParamSpecifier::ImplicitlyCopyableConsuming:
        case nextcode::ParamSpecifier::Consuming:
        case nextcode::ParamSpecifier::Default:
        case nextcode::ParamSpecifier::InOut:
        case nextcode::ParamSpecifier::LegacyOwned:
        case nextcode::ParamSpecifier::LegacyShared:
          break;
        }
      }
    }
