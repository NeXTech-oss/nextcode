...
#ifndef NEXTCODE_LOWERING_RVALUE_H
#define NEXTCODE_LOWERING_RVALUE_H
...
class RValue {
  friend class nextcode::Lowering::Scope;
  friend class nextcode::Lowering::ArgumentSource;
  friend class nextcode::Lowering::CleanupCloner;
