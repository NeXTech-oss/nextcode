...
public:
  ...
  /// The NeXTCode module we are visiting.
...
public:
  ...
  /// Emits a thunk from a foreign function to the native NeXTCode convention.
  void emitForeignToNativeThunk(SILDeclRef thunk);

  /// Emits a thunk from a NeXTCode function to the native NeXTCode convention.
...
#include "nextcode/AST/KnownSDKDecls.def"
  ...
  /// Find the conformance of the given NeXTCode type to the
  ...
  /// Retrieve the _Concurrency._nextcodeJobRun intrinsic.
  FuncDecl *getNeXTCodeJobRun();
  // Retrieve the _NeXTCodeConcurrencyShims.exit intrinsic.
  FuncDecl *getExit();
