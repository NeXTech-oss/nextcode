...
#include "nextcode/AST/TypeCheckRequests.h" // FIXME: Temporary
#include "nextcode/AST/NameLookupRequests.h" // FIXME: Temporary
...
static ManagedValue emitBuiltinAutoDiffApplyDerivativeFunction(
  ...
  // FIXME(https://github.com/apple/nextcode/issues/54259): Support throwing functions.
  ...
  auto functionValue = [&] {
    ...
    auto extInfo =
        ASTExtInfoBuilder()
            ...
            .withRepresentation(GenericFunctionType::Representation::NeXTCode)
            .build();
