...
#ifndef NEXTCODE_SILGEN_SILGENFUNCTION_H
#define NEXTCODE_SILGEN_SILGENFUNCTION_H
...
#include "nextcode/Basic/NoDiscard.h"
...
public:
  ...
  /// Generates a thunk from a foreign function to the native NeXTCode convention.
  ...
  /// Emits the standard rethrow epilog using a NeXTCode error result.
  ...
  /// call to nextcode_willThrow, that will allow the debugger to place a
  ...
  /// Convert a native NeXTCode value to a value that can be passed as an argument
  ...
  /// the given calling convention to a native NeXTCode value of the given type.
  ...
  /// Convert a bridged error type to the native NeXTCode Error
  /// representation.  The value may be optional.
  ManagedValue emitBridgedToNativeError(SILLocation loc, ManagedValue v);

  /// Convert a value in the native NeXTCode Error representation to
