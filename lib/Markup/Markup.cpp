...
ParseResult<MarkupASTNode> parseElement(MarkupContext &MC, ParseState State) {
  ...
  case CMARK_NODE_FOOTNOTE_DEFINITION: {
    llvm_unreachable("Footnotes are not currently parsed by nextcodeMarkup");
  }
...
Document *nextcode::markup::parseDocument(MarkupContext &MC, LineList &LL) {
  return parseDocumentImpl(MC, LL.str());
}

Document *nextcode::markup::parseDocument(MarkupContext &MC, StringRef String) {
