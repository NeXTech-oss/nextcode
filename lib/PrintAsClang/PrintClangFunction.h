...
#ifndef NEXTCODE_PRINTASCLANG_PRINTCLANGFUNCTION_H
#define NEXTCODE_PRINTASCLANG_PRINTCLANGFUNCTION_H
...
/// Responsible for printing a NeXTCode function decl or type in C or C++ mode, to
...
public:
  ...
  /// What kind of function signature should be emitted for the given NeXTCode
  /// function.
  ...
  /// Print the NeXTCode method as C++ method declaration/definition, including
  /// constructors.
  void printCxxMethod(
  ...
  /// Print NeXTCode type as C/C++ type, as the return type of a C/C++ function.
...
private:
  ...
  // _impl::_impl_<typename> C++ class for the given NeXTCode type.
