...
#ifndef NEXTCODE_LLVMPASSES_ARCENTRYPOINTBUILDER_H
#define NEXTCODE_LLVMPASSES_ARCENTRYPOINTBUILDER_H
...
private:
  ...
  /// getRetain - Return a callable function for nextcode_retain.
  Constant *getRetain(CallInst *OrigI) {
    ...
    Retain = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_retain" : "nextcode_retain",
  ...
  /// getRelease - Return a callable function for nextcode_release.
  Constant *getRelease(CallInst *OrigI) {
    ...
    Release = getRuntimeFn(getModule(), cache,
                           isNonAtomic(OrigI) ? "nextcode_nonatomic_release"
                                              : "nextcode_release",
  ...
  Constant *getCheckUnowned(CallInst *OrigI) {
    ...
    CheckUnowned = cast<llvm::Function>(
        M.getOrInsertFunction("nextcode_checkUnowned", AttrList,
  ...
  /// getRetainN - Return a callable function for nextcode_retain_n.
  Constant *getRetainN(CallInst *OrigI) {
    ...
    RetainN = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_retain_n" : "nextcode_retain_n",
        DefaultCC, RuntimeAvailability::AlwaysAvailable, {ObjectPtrTy},
  ...
  /// Return a callable function for nextcode_release_n.
  Constant *getReleaseN(CallInst *OrigI) {
    ...
    ReleaseN = getRuntimeFn(getModule(), cache,
                            isNonAtomic(OrigI) ? "nextcode_nonatomic_release_n"
                                               : "nextcode_release_n",
                            DefaultCC, RuntimeAvailability::AlwaysAvailable,
  ...
  /// nextcode_unknownObjectRetain_n.
  Constant *getUnknownObjectRetainN(CallInst *OrigI) {
    ...
    UnknownObjectRetainN = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_unknownObjectRetain_n"
                           : "nextcode_unknownObjectRetain_n",
        DefaultCC, RuntimeAvailability::AlwaysAvailable, {ObjectPtrTy},
        {ObjectPtrTy, Int32Ty}, {NoUnwind, FirstParamReturned}, {});
  ...
  /// Return a callable function for nextcode_unknownObjectRelease_n.
  Constant *getUnknownObjectReleaseN(CallInst *OrigI) {
    ...
    UnknownObjectReleaseN = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_unknownObjectRelease_n"
                           : "nextcode_unknownObjectRelease_n",
  ...
  /// Return a callable function for nextcode_bridgeRetain_n.
  Constant *getBridgeRetainN(CallInst *OrigI) {
    ...
    BridgeRetainN = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_bridgeObjectRetain_n"
                           : "nextcode_bridgeObjectRetain_n",
        DefaultCC, RuntimeAvailability::AlwaysAvailable, {BridgeObjectPtrTy},
        {BridgeObjectPtrTy, Int32Ty}, {NoUnwind}, {});
    return BridgeRetainN.get();
  }

  /// Return a callable function for nextcode_bridgeRelease_n.
  Constant *getBridgeReleaseN(CallInst *OrigI) {
    ...
    BridgeReleaseN = getRuntimeFn(
        getModule(), cache,
        isNonAtomic(OrigI) ? "nextcode_nonatomic_bridgeObjectRelease_n"
                           : "nextcode_bridgeObjectRelease_n",
        DefaultCC, RuntimeAvailability::AlwaysAvailable, {VoidTy},
        {BridgeObjectPtrTy, Int32Ty}, {NoUnwind}, {});
    return BridgeReleaseN.get();
  }
  ...
  Type *getObjectPtrTy() {
    ...
    ObjectPtrTy = getNamedOpaquePtrTy("nextcode.refcounted");
    return ObjectPtrTy.get();
  }
  ...
  Type *getBridgeObjectPtrTy() {
    ...
    BridgeObjectPtrTy = getNamedOpaquePtrTy("nextcode.bridge");
    return BridgeObjectPtrTy.get();
  }
