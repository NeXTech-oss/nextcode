//===--- DeclSynthesizer.cpp - Synthesize helper NeXTCode decls --------------===//
//
/*
...
NeXTCodeDeclSynthesizer::createVarWithPattern(DeclContext *dc, Identifier name,
                                           Type ty,
...
Pattern *NeXTCodeDeclSynthesizer::createTypedNamedPattern(VarDecl *decl) {
...
Type NeXTCodeDeclSynthesizer::getConstantLiteralType(
...
ValueDecl *NeXTCodeDeclSynthesizer::createConstant(
  ...
  auto &context = ImporterImpl.NeXTCodeContext;
...
ValueDecl *NeXTCodeDeclSynthesizer::createConstant(
    ...
    ConstantConvertKind convertKind, bool isStatic, ClangNode ClangN) {
  ASTContext &ctx = ImporterImpl.NeXTCodeContext;
...
ValueDecl *NeXTCodeDeclSynthesizer::createConstant(
    ...
    ConstantConvertKind convertKind, bool isStatic, ClangNode ClangN) {
  auto &C = ImporterImpl.NeXTCodeContext;
...
ConstructorDecl *
NeXTCodeDeclSynthesizer::createDefaultConstructor(NominalTypeDecl *structDecl) {
  auto &context = ImporterImpl.NeXTCodeContext;
...
ConstructorDecl *NeXTCodeDeclSynthesizer::createValueConstructor(
...
ConstructorDecl *NeXTCodeDeclSynthesizer::createRawValueBridgingConstructor(
...
void NeXTCodeDeclSynthesizer::makeStructRawValued(
...
NeXTCodeDeclSynthesizer::makeUnionFieldAccessors(
...
std::pair<FuncDecl *, FuncDecl *> NeXTCodeDeclSynthesizer::makeBitFieldAccessors(
...
std::pair<AccessorDecl *, AccessorDecl *>
NeXTCodeDeclSynthesizer::makeIndirectFieldAccessors(
...
ConstructorDecl *
NeXTCodeDeclSynthesizer::makeEnumRawValueConstructor(EnumDecl *enumDecl) {
  ASTContext &C = ImporterImpl.NeXTCodeContext;
  auto rawTy = enumDecl->getRawType();
...
void NeXTCodeDeclSynthesizer::makeEnumRawValueGetter(EnumDecl *enumDecl,
...
AccessorDecl *NeXTCodeDeclSynthesizer::makeStructRawValueGetter(
...
AccessorDecl *NeXTCodeDeclSynthesizer::buildSubscriptGetterDecl(
...
AccessorDecl *NeXTCodeDeclSynthesizer::buildSubscriptSetterDecl(
...
Expr *NeXTCodeDeclSynthesizer::synthesizeReturnReinterpretCast(ASTContext &ctx,
                                                            Type givenType,
                                                            Type exprType,
                                                            Expr *baseExpr) {
  auto reinterpretCast = cast<FuncDecl>(
...
synthesizeUnwrappingGetterOrAddressGetterBody(AbstractFunctionDecl *afd,
  ...
  if (isAddress &&
    ...
    propertyExpr = NeXTCodeDeclSynthesizer::synthesizeReturnReinterpretCast(
...
SubscriptDecl *NeXTCodeDeclSynthesizer::makeSubscript(FuncDecl *getter,
                                                   FuncDecl *setter) {
...
VarDecl *
NeXTCodeDeclSynthesizer::makeDereferencedPointeeProperty(FuncDecl *getter,
                                                      FuncDecl *setter) {
  assert((getter || setter) &&
...
synthesizeSuccessorFuncBody(AbstractFunctionDecl *afd, void *context) {
  ...
  std::tie(copyDecl, patternDecl) = NeXTCodeDeclSynthesizer::createVarWithPattern(
...
FuncDecl *NeXTCodeDeclSynthesizer::makeSuccessorFunc(FuncDecl *incrementFunc) {
  auto &ctx = ImporterImpl.NeXTCodeContext;
...
synthesizeOperatorMethodBody(AbstractFunctionDecl *afd, void *context) {
  ...
  auto methodDecl =
      static_cast<FuncDecl *>(context); /* NeXTCode version of CXXMethod */
...
clang::CXXMethodDecl *NeXTCodeDeclSynthesizer::synthesizeCXXForwardingMethod(
  ...
  // derived-to-base call is invoked from NeXTCode's subscript getter.
...
FuncDecl *
NeXTCodeDeclSynthesizer::makeOperator(FuncDecl *operatorMethod,
...
FuncDecl *NeXTCodeDeclSynthesizer::makeVirtualMethod(
...
FuncDecl *NeXTCodeDeclSynthesizer::makeInstanceToStaticOperatorCallMethod(
    const clang::CXXMethodDecl *clangMethodDecl) {
  auto clangDC = clangMethodDecl->getParent();
  auto &ctx = ImporterImpl.NeXTCodeContext;
  ...
  newMethod->addAttr(clang::NeXTCodeNameAttr::CreateImplicit(
...
VarDecl *
NeXTCodeDeclSynthesizer::makeComputedPropertyFromCXXMethods(FuncDecl *getter,
                                                         FuncDecl *setter) {
  auto &ctx = ImporterImpl.NeXTCodeContext;
...
synthesizeDefaultArgumentBody(AbstractFunctionDecl *afd, void *context) {
  ...
  // Import `func __cxx__defaultArg_XYZ() -> ParamTY` into NeXTCode.
...
CallExpr *
NeXTCodeDeclSynthesizer::makeDefaultArgument(const clang::ParmVarDecl *param,
  ...
  auto funcDecl = FuncDecl::createImplicit(
      ...
      {}, ParameterList::createEmpty(ctx), nextcodeParamTy,
