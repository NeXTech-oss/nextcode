//===--- MathStubs.cpp - NeXTCode Language Runtime Stubs ---------------------===//
//
/*
...
#define NEXTCODE_MODE_DI __attribute__((__mode__(DI)))
#define NEXTCODE_MODE_TI __attribute__((__mode__(TI)))
#else
#define NEXTCODE_MODE_DI
#define NEXTCODE_MODE_TI
#endif

typedef int si_int;
typedef int di_int NEXTCODE_MODE_DI;
typedef int ti_int NEXTCODE_MODE_TI;

typedef unsigned su_int;
typedef unsigned du_int NEXTCODE_MODE_DI;
typedef unsigned tu_int NEXTCODE_MODE_TI;
