//===--- NeXTCodeNativeNSXXXBaseARC.mm - Runtime stubs that require ARC ------===//
//
/*
...
size_t nextcode_stdlib_NSStringHashValue(NSString *str,
                                      bool isASCII) {
  AUTORELEASEPOOL {
...
NEXTCODE_CC(nextcode) NEXTCODE_RUNTIME_STDLIB_API
size_t
nextcode_stdlib_NSStringHashValuePointer(void *opaque, bool isASCII) {
