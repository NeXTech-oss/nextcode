...
#ifndef NEXTCODE_BACKTRACING_COMPRESSION_H
#define NEXTCODE_BACKTRACING_COMPRESSION_H
...
// that we don't need to install the -dev packages in order to build NeXTCode.

#if NEXTCODE_BACKTRACE_STATIC_ZLIB
#include "zlib.h"
#else
...
#if NEXTCODE_BACKTRACE_STATIC_ZSTD
#include "zstd.h"
#else
...
#if NEXTCODE_BACKTRACE_STATIC_LIBLZMA
#include "lzma.h"
#else
typedef enum {
  LZMA_OK = 0,
...
// The NeXTCode importer can't cope with complex macros; it will do inline
// functions, however.
...
#endif // NEXTCODE_BACKTRACING_COMPRESSION_H
