...
#ifndef NEXTCODE_BACKTRACING_DARWIN_H
#define NEXTCODE_BACKTRACING_DARWIN_H
#ifdef __APPLE__
...
// Use an inline function for mach_task_self() or it won't import into NeXTCode
...
/* We can't import these from the system header, because it uses all kinds of
   macros and the NeXTCode importer can't cope with that.  So declare them here
...
#endif // __APPLE__
#endif // NEXTCODE_BACKTRACING_DARWIN_H
