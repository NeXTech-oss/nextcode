...
bool __nextcode::__runtime::llvm::consumeUnsignedInteger(
...
bool __nextcode::__runtime::llvm::consumeSignedInteger(
...
bool __nextcode::__runtime::llvm::getAsUnsignedInteger(
    StringRef Str, unsigned Radix, unsigned long long &Result) {
...
bool __nextcode::__runtime::llvm::getAsSignedInteger(
    StringRef Str, unsigned Radix, long long &Result) {
...
hash_code __nextcode::__runtime::llvm::hash_value(StringRef S) {
