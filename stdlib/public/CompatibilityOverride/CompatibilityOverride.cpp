...
/// __nextcode54_hooks section and uses the hooks defined therein. This struct
...
#define OVERRIDE(name, ret, attrs, ccAttrs, namespace, typedArgs, namedArgs) \
  Override_ ## name nextcode::getOverride_ ## name() {                 \
...
#endif // #ifdef NEXTCODE_STDLIB_SUPPORT_BACK_DEPLOYMENT
