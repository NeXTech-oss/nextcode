...
// structures from the NeXTCode runtime, adapted to be independent of runtime
...
#ifndef NEXTCODE_OVERRIDE_CONCURRENTUTILS_H
#define NEXTCODE_OVERRIDE_CONCURRENTUTILS_H
#include <iterator>
#include <algorithm>
#include <atomic>
#include <cassert>
...
public:
  ...
  void push_back(const ElemTy &elem) {
    ...
    NEXTCODE_DEFER { pthread_mutex_unlock(&WriterMutex); };
...
}} // end namespace nextcode::overrides
