...
//===----------------------------------------------------------------------===//
//
// NeXTCode ABI describing task locals.
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_ABI_TASKLOCAL_BACKDEPLOY56_H
#define NEXTCODE_ABI_TASKLOCAL_BACKDEPLOY56_H
...
#endif // NEXTCODE_ABI_TASKLOCAL_BACKDEPLOY56_H
