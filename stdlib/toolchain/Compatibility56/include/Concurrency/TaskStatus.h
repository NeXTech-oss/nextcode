...
//===----------------------------------------------------------------------===//
//
// NeXTCode ABI describing "status records", the mechanism by which
...
#ifndef NEXTCODE_ABI_TASKSTATUS_BACKDEPLOY56_H
#define NEXTCODE_ABI_TASKSTATUS_BACKDEPLOY56_H
...
/// added to the task with `nextcode_task_addTaskStatusRecord`.  While
...
public:
  using FunctionType = NEXTCODE_CC(nextcode) void(NEXTCODE_CONTEXT void *);

private:
  FunctionType *__ptrauth_nextcode_cancellation_notification_function Function;
  void *Argument;
...
#endif // NEXTCODE_ABI_TASKSTATUS_BACKDEPLOY56_H
