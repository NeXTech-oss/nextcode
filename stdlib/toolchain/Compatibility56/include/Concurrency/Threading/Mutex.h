...
// for use in NeXTCode runtime.
//
//===----------------------------------------------------------------------===//

#ifndef NEXTCODE_RUNTIME_MUTEX_BACKDEPLOY56_H
#define NEXTCODE_RUNTIME_MUTEX_BACKDEPLOY56_H
...
#if defined(NEXTCODE_STDLIB_SINGLE_THREADED_RUNTIME) || defined(__wasi__)
...
#endif // NEXTCODE_RUNTIME_MUTEX_BACKDEPLOY56_H
