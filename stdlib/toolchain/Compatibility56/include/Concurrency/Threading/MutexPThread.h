...
#ifndef NEXTCODE_RUNTIME_MUTEX_PHTREAD_BACKDEPLOY56_H
#define NEXTCODE_RUNTIME_MUTEX_PHTREAD_BACKDEPLOY56_H
...
#define NEXTCODE_CONDITION_SUPPORTS_CONSTEXPR 0
#define NEXTCODE_MUTEX_SUPPORTS_CONSTEXPR 0
#define NEXTCODE_READWRITELOCK_SUPPORTS_CONSTEXPR 0
#else
...
#if NEXTCODE_CONDITION_SUPPORTS_CONSTEXPR
  static constexpr
#else
  static
#endif
...
struct MutexPlatformHelper {
  __attribute__((visibility("hidden")))
#if NEXTCODE_MUTEX_SUPPORTS_CONSTEXPR
  static constexpr
#else
  static
#endif
...
struct ReadWriteLockPlatformHelper {
  ...
  __attribute__((visibility("hidden")))
#if NEXTCODE_READWRITELOCK_SUPPORTS_CONSTEXPR
  static constexpr
#else
  static
#endif
...
#endif // NEXTCODE_RUNTIME_MUTEX_PHTREAD_BACKDEPLOY56_H
