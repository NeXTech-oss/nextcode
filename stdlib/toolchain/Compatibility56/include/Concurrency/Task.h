...
#ifndef NEXTCODE_ABI_TASK_BACKDEPLOY56_H
#define NEXTCODE_ABI_TASK_BACKDEPLOY56_H

#include "Concurrency/TaskLocal.h"
#include "Executor.h"
#include "nextcode/ABI/HeapObject.h"
#include "nextcode/ABI/Metadata.h"
#include "nextcode/ABI/MetadataValues.h" // Maybe replace?
...
/// The NeXTCode5.6 AsyncContextKind for the AsyncContext.
/// Note that these were removed in NeXTCode5.7
...
/// The NeXTCode5.6 AsyncContextFlags for the AsyncContext.
/// Note that these were removed in NeXTCode5.7
/// (aca744b21165a20655502b563a6fa54c2c83efdf).
...
#endif // NEXTCODE_ABI_TASK_BACKDEPLOY56_H
