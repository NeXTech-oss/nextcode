...
inline namespace __nextcode { inline namespace __runtime {
namespace llvm {
...
namespace std {
  ...
  template<typename T>
  inline void
  swap(__nextcode::__runtime::llvm::SmallVectorImpl<T> &LHS,
       __nextcode::__runtime::llvm::SmallVectorImpl<T> &RHS) {
    LHS.swap(RHS);
  }
  ...
  template<typename T, unsigned N>
  inline void
  swap(__nextcode::__runtime::llvm::SmallVector<T, N> &LHS,
       __nextcode::__runtime::llvm::SmallVector<T, N> &RHS) {
    LHS.swap(RHS);
  }
