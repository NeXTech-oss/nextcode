...
function(get_compatibility_libs sdk arch result_var_name)
  ...
  if(NEXTCODE_STDLIB_SUPPORT_BACK_DEPLOYMENT)
    set(vsuffix "-${NEXTCODE_SDK_${sdk}_LIB_SUBDIR}-${arch}")

    list(APPEND compatibility_libs
      nextcodeCompatibilityConcurrency${vsuffix}
      nextcodeCompatibilityDynamicReplacements${vsuffix}
      nextcodeCompatibilityPacks${vsuffix}
      nextcodeCompatibility56${vsuffix})
    ...
    if(NOT (sdk STREQUAL "WATCHOS" AND arch IN_LIST arm64Archs))
      list(APPEND compatibility_libs
        nextcodeCompatibility50${vsuffix}
        nextcodeCompatibility51${vsuffix})
    endif()
  endif()
