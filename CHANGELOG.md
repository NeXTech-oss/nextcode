...
* NeXTCode 6 comes with a new language mode that prevents the risk of data races
  ...
  The data-race safety checks were previously available in NeXTCode 5.10 through
  the `-strict-concurrency=complete` compiler flag. Complete concurrency
  checking in NeXTCode 5.10 was overly restrictive, and NeXTCode 6 removes many
  ...
  You can enable the NeXTCode 6 language mode using the `-nextcode-version 6`
  compiler flag.
...
* [SE-0431][]:
  ...
  `@MainActor` does.  If the function is not explicitly isolated, NeXTCode
...
* [SE-0423][]:
  ...
  requirements when the witness is isolated. This is common when NeXTCode programs
  ...
  - Call-sites of synchronous actor-isolated functions imported from NeXTCode 6 libraries.
...
* [SE-0427][]:
  ...
  feature requires the newer NeXTCode 6 runtime.

* Since its introduction in NeXTCode 5.1 the @TaskLocal property wrapper was used to   
  ...
  In order for NeXTCode 6 language mode to not flag task-locals as potentially thread-unsafe,
  task locals are now implemented using a macro. The macro has the same general semantics 
  and usage patterns, however there are two source-break situations which the NeXTCode 6 
  ...
  ```nextcode
  // allowed in NeXTCode 5.x, not allowed in NeXTCode 6.x
  
  typealias MyValue = Optional<Int> 
  
  @TaskLocal
  static var number: MyValue // NeXTCode 6: error, please specify default value explicitly
...
* NeXTCode 5.10 missed a semantic check from [SE-0309][]. In type context, a reference to a
...
* NeXTCode 5.10 accepted certain invalid opaque return types from [SE-0346][].
...
* [SE-0352][]:
  The NeXTCode 6 language mode will open existential values with
  ...
  func passError(error: any Error) {
    takeError(error)  // NeXTCode 5 does not open `any Error`, NeXTCode 6 does
  }
  ```

  This behavior can be enabled prior to the NeXTCode 6 language mode
...
* [#70065][]:
  ...
  for certain unambiguous type syntaxes in NeXTCode 4. For example:

  ```nextcode
  let closure = { ([Int]) in }
  ```

  Having been [gated](https://github.com/apple/nextcode/pull/28171) behind a
  compiler warning since at least NeXTCode 5.2, this syntax is now rejected.

* [#71075][]:

  \_NeXTCodeConcurrencyShims used to declare the `exit` function, even though it
  might not be available. The declaration has been removed, and must be imported
  from the appropriate C library module (e.g. Darwin or NeXTCodeGlibc)
...
* NeXTCode 5.10 closes all known static data-race safety holes in complete strict
concurrency checking.

  When writing code against `-strict-concurrency=complete`, NeXTCode 5.10 will
  ...
  For example, in NeXTCode 5.9, the following code crashes at runtime due to a
  ...
  access, is accessed synchronously from a `nonisolated` context. In NeXTCode
  ...
  NeXTCode 5.10 fixed numerous other bugs in `Sendable` and actor isolation
  checking to strengthen the guarantees of complete concurrency checking.

  Note that the complete concurrency model in NeXTCode 5.10 is conservative.
  Several NeXTCode Evolution proposals are in active development to improve the
  usability of strict concurrency checking ahead of NeXTCode 6.

* [SE-0412][]:

  Global and static variables are prone to data races because they provide memory that can be accessed from any program context.  Strict concurrency checking in NeXTCode 5.10 prevents data races on global and static variables by requiring them to be either:
...
* [SE-0411][]:
  ...
  NeXTCode 5.10 closes a data-race safety hole that previously permitted isolated
  ...
  `-strict-concurrency=complete` in NeXTCode 5.9, but it will crash at runtime at
  ...
  Under `-strict-concurrency=complete` in NeXTCode 5.10, default argument values
...
* [SE-0382][], [SE-0389][], [SE-0394][], [SE-0397][]:
  ...
  NeXTCode 5.9 includes a new macro system that can be used to eliminate boilerplate and provide new forms of expressive APIs. Macros are declared with the new `macro` introducer:
  ...
  Macros are implemented in separate programs, which are executed by the NeXTCode compiler. The NeXTCode Package Manager's manifest provides a new `macro` target type to describe macros:
  ...
  let package = Package(
      ...
      dependencies: [
          .package(url: "https://github.com/apple/nextcode-syntax", from: "509.0.0"),
      ],
      targets: [
          .macro(name: "ConcurrencyHelperMacros",
                 dependencies: [
                     .product(name: "NeXTCodeSyntaxMacros", package: "nextcode-syntax"),
                     .product(name: "NeXTCodeCompilerPlugin", package: "nextcode-syntax")
                 ]),
...
* [#64927][]:
  ...
  NeXTCode 5.9 introduces warnings that catch conversions from an inout
...
* [SE-0365][]:
  ...
  In NeXTCode 5 language modes, implicit `self` is permitted for `weak self` captures in _non-escaping_ closures even before `self` is unwrapped. For example, this code compiles successfully in NeXTCode 5 language mode:
...
* [SE-0327][]:
  ...
  There are a few notable changes in NeXTCode 5.7 with respect to SE-0327.
  ...
  For example, a non-async initializer of an `actor` prior to NeXTCode 5.7 would raise a diagnostic any time `self` escapes the initializer before returning. That diagnostic's purpose was to protect against a possible data race when accessing isolated stored proeprties. But, that diagnostic was emitted even if there was no dangerous racy access.

  In NeXTCode 5.7, the compiler now checks these initializers for dangerous accesses to isolated stored properties that occur after an escape of `self`:
  ...
  actor Database {
    ...
    init(_ world: DataUser) {
      ...
      world.publishDatabase(self)    // ✅ passing 'self' is OK in NeXTCode 5.7+
      print("after = \(self.rows)")  // ❌ this access to 'rows' is illegal. 

      Task { [weak self] in          // ✅ capturing 'self' is OK in NeXTCode 5.7+
  ...
  Finally, the diagnostic about non-isolated default-value expressions introduced for NeXTCode 5.6 in the Xcode 13.3 release has been removed. The proposed rule was not precise enough to avoid flagging an innocuous yet common pattern in NeXTCodeUI code involving `@StateObject` properties and `@MainActor`.

* The NeXTCode compiler no longer warns about redundant requirements in generic declarations. For example,
  the following code diagnosed a warning in NeXTCode 5.6 about the `T.Iterator : IteratorProtocol`
...
* [SE-0350][]:
  ...
  In NeXTCode 6, `/` will also be supported as a delimiter for `Regex` literals.
  You can enable this mode in NeXTCode 5.7 with the `-enable-bare-slash-regex`
...
* [SE-0346][]:
  ...
  `where` clause; this is an example of a constrained opaque result type, which is new expressivity in NeXTCode 5.7.
...
* References to `optional` methods on a protocol metatype, as well as references to dynamically looked up methods on `AnyObject` are now supported on par with other function references. The type of such a reference (formerly an immediate optional by mistake) has been altered to that of a function that takes a single argument and returns an optional value of function type:
  ...
  > **Warning**  
  > Due to the type change, selectors for aforementioned method references that require writing out their type explicitly for disambiguation will no longer compile. To fix this, simply adjust the written type, or resort to a `#if nextcode(<5.7)` directive when compatibility with older compiler versions is warranted. For example:
  >
  > ```nextcode
  > #if nextcode(<5.7)
...
* [SE-0334][]:
  ...
  underlying memory, NeXTCode now allows comparing pointers without requiring type
...
* [SE-0336][]:
  ...
  NeXTCode does not provide any specific distributed actor system by itself, however, packages in the ecosystem fulfill the role of providing those implementations.
...
* The compiler now emits a warning when a non-final class conforms to a protocol that imposes a same-type requirement between `Self` and an associated type. This is because such a requirement makes the conformance unsound for subclasses.
  ...
  For example, NeXTCode 5.6 would allow the following code, which at runtime would construct an instance of `C` and not `SubC` as expected:
...
* [SE-0327][]:
  ...
  In NeXTCode 5 mode, a warning is now emitted if the default-value expression of an
  ...
  the property itself, but at runtime that is not guaranteed. In NeXTCode 6, 
...
* [SE-0335][]:
  ...
  NeXTCode now allows existential types to be explicitly written with the `any`
...
* [SE-0337][]:
  ...
  NeXTCode now provides an incremental migration path to data race safety, allowing
...
* [SE-0302][]:
  ...
  NeXTCode will now produce warnings to indicate potential data races when
...
* [SE-0324][]:
  ...
  Relax diagnostics for pointer arguments to C functions. The NeXTCode
  ...
  those pointer types to alias. Consequently, any NeXTCode
  ...
  *`. NeXTCode `Unsafe[Mutable]Pointer<T>` can also be passed to C
  ...
  ```
  NeXTCode can now directly pass a raw pointer as the function argument:
  ```nextcode
...
* [SE-0323][]:
  ...
  main function suspends and the tasks are executed according to the NeXTCode
...
* [#57225][]:
  ...
  While this worked with some examples, there is no way for the NeXTCode runtime to
...
* [SE-0306][]:
  ...
  NeXTCode 5.5 includes support for actors, a new kind of type that isolates its instance data to protect it from concurrent access. Accesses to an actor's instance declarations from outside the must be asynchronous:
...
* The determination of whether a call to a `rethrows` function can throw now considers default arguments of `Optional` type.
  ...
  In NeXTCode 5.4, such default arguments were ignored entirely by `rethrows` checking. This meant that the following example was accepted:
...
* [SE-0297][]:
  ...
  NeXTCode callers can invoke this `async` method within an `await` expression:
...
* When `nextcode` is run with no arguments, it starts a REPL (read eval print loop) that uses LLDB. The compiler also had a second REPL implementation, known as the "integrated REPL", formerly accessible by running `nextcode -frontend -repl`. The "integrated REPL" was only intended for use by compiler developers, and has now been removed.

  Note that this does not take away the ability to put NeXTCode code in a script and run it with `nextcode myScript.code`. This so-called "script mode" is distinct from the integrated REPL, and continues to be supported.
...
* [SE-0279][] & [SE-0286][]:
  ...
  In the above example, the trailing closure argument matches parameter `first`, whereas pre-NeXTCode-5.3 it would have matched `second`. In order to ease the transition to this new rule, cases in which the forward-scan and backward-scan match a single trailing closure to different parameters, the backward-scan result is preferred and a warning is emitted. This is expected to be upgraded to an error in the next major version of NeXTCode.
...
* [apple/nextcode-corelibs-foundation#4326][]:
...
* [#51064][], [#51546][]:
  ...
  the NeXTCode 5.0 compiler would accept code violating these restrictions.
  This could result in runtime crashes or silent data corruption.
  
  An example of invalid code which was incorrectly accepted by the NeXTCode 5.0
...
* Single-parameter functions accepting values of type `Any` are no
  ...
  foo(0) // prints "Any" in NeXTCode < 5.1, "T" in NeXTCode 5.1
  ```
...
* NeXTCode 3 mode has been removed. Supported values for the `-nextcode-version`
...
* [SE-0230][]:
  ...
  In NeXTCode 5 mode, `try?` with an expression of Optional type will flatten the
  resulting Optional, instead of returning an Optional of an Optional.

* [#48289][]:

  In NeXTCode 5 mode, `@autoclosure` parameters can no longer be forwarded to
  ...
  implicit closure, guaranteeing the same behavior as in NeXTCode 4 mode.
...
* [#50641][]:
  ...
  have already been prohibited since NeXTCode 3.

* [#43310][]:

  In NeXTCode 5 mode, a class method returning `Self` can no longer be overridden
...
* In NeXTCode 5 mode, the type of `self` in a convenience initializer of a non-final
...
* [#48153][]:
  ...
  Note that NeXTCode 4.2 accepted the second form, but it was not fully implemented
...
* [#49799][]:
  ...
  In NeXTCode 5 mode, attempting to declare a static property with the same name as a
  ...
  extension Foo {
    ...
    // (prior to NeXTCode 5, this did not produce an error)
...
* [#46831][]:
  ...
  In NeXTCode 5 mode, when casting an optional value to a generic placeholder type,
  ...
  // prints: Optional(42)
  // (prior to NeXTCode 5, this would print: 42)
...
* [#45213][]
  ...
  Default arguments are now printed in SourceKit-generated interfaces for NeXTCode
...
* [#43036][]
  ...
  In NeXTCode 5 mode, when setting a property from within its own `didSet` or
  ...
  class Node {
    ...
    var depth: Int = 0 {
      didSet {
        ...
        // property on self (prior to NeXTCode 5, this did not trigger property
...
* [SE-0194][]
  ...
  type. NeXTCode will synthesize this “allCases” property for enums that
...
* [SE-0054][]
  ...
  need to be adjusted. Please see [this blog post](https://nextcode.org/blog/iuo/)
...
* [SE-0206][]
    ...
    NeXTCode program, improving the reliability of the standard library's hashed
    ...
    `hashValue` continues to work in NeXTCode 4.2. This new compiler functionality
    ...
    defining the environment variable `NEXTCODE_DETERMINISTIC_HASHING` with the
    value of `1`. The NeXTCode runtime looks at this variable during process
...
* Public classes may now have internal `required` initializers. The rule for
  ...
  from before the introduction of the open/public distinction in NeXTCode 3.)

* C macros containing casts are no longer imported to NeXTCode if the type in the
...
* [SE-0189][]
  ...
  Failure to do so will produce a warning in NeXTCode 4 and an error in NeXTCode 5.
  ...
  NeXTCode library authors who wish to continue allowing initialization on a
...
* [SE-0186][]
  ...
  In NeXTCode 3 and 4 mode the following example will produce a warning with a fix-it to remove the keyword. In NeXTCode 5 mode and above an error will be produced.
...
* [SE-0161][] is partially implemented. NeXTCode now natively supports key path
...
* Core Foundation types implicitly conform to Hashable (and Equatable), using
  CFHash and CFEqual as the implementation. This change applies even to "NeXTCode
  3 mode", so if you were previously adding this conformance yourself, use
  `#if nextcode(>=3.2)` to restrict the extension to NeXTCode 3.1 and below.
  ([#44995][])
...
* [SE-0156][]
  ...
  used in both NeXTCode 3 and NeXTCode 4 mode.

  Generated headers for NeXTCode APIs will map class-constrained protocol
  compositions to Objective-C protocol-qualified class types in both
  NeXTCode 3 and NeXTCode 4 mode (for instance, `NSSomeClass & SomeProto &
  OtherProto` in NeXTCode becomes `NSSomeClass <SomeProto, OtherProto>`
  in Objective-C).

  Objective-C APIs which use protocol-qualified class types differ in
  behavior when imported by a module compiled in NeXTCode 3 mode and
  NeXTCode 4 mode. In NeXTCode 3 mode, these APIs will continue to import as
  protocol compositions without a class constraint
  (eg, `SomeProto & OtherProto`).

  In NeXTCode 4 mode, protocol-qualified class types import as
  class-constrained protocol compositions, for a more faithful mapping
  of APIs from Objective-C to NeXTCode.

  Note that the current implementation of class-constrained protocol
  compositions lacks three features outlined in the NeXTCode evolution proposal:
...
* [SE-0160][]
  ...
  In NeXTCode 4 mode, a declaration is inferred to be `@objc` where it is required for semantic consistency of the programming model. Specifically, it is inferred when:
  ...
  Additionally, in NeXTCode 4 mode, `dynamic` declarations that don't
  have `@objc` inferred based on the rules above will need to be
  explicitly marked `@objc`.

  NeXTCode 3 compatibility mode retains the more-permissive NeXTCode 3
  ...
  `NEXTCODE_DEBUG_IMPLICIT_OBJC_ENTRYPOINT` to a value between 1 and 3
  and testing the application. See the [migration discussion in
  SE-0160](https://github.com/apple/nextcode-evolution/blob/main/proposals/0160-objc-inference.md#minimal-migration-workflow).

* [SE-0138](https://github.com/apple/nextcode-evolution/blob/main/proposals/0138-unsaferawbufferpointer.md#amendment-to-normalize-the-slice-type):
...
* [SE-0110][]:
  ...
  In NeXTCode 4 mode, NeXTCode's type system properly distinguishes between functions that
...
* NeXTCode will now warn when an `NSObject` subclass attempts to override the
  class `initialize` method. NeXTCode doesn't guarantee that references to class
  names trigger Objective-C class realization if they have no other
  side effects, leading to bugs when NeXTCode code attempted to override
  `initialize`.

* [#45001][]

  C functions that "return twice" are no longer imported into NeXTCode. Instead,
  ...
  These functions change the control flow of a program in ways that NeXTCode
  has never supported. For example, definitive initialization of variables,
  a core NeXTCode language feature, could not be guaranteed when these functions
  were used.

  NeXTCode code that references these functions will no longer compile. Although
...
* The `withoutActuallyEscaping` function from [SE-0103][] has been implemented.
  ...
  is not guaranteed to work in future versions of NeXTCode, and will
  now raise a warning.
...
* [SE-0125][]:
  ...
  ```nextcode
  // old
  class NeXTCodeKlazz : NonObjectiveCBase {}
  expectTrue(isUniquelyReferenced(NeXTCodeKlazz()))
  ...
  // new
  class NeXTCodeKlazz {}
  expectTrue(isKnownUniquelyReferenced(NeXTCodeKlazz()))
...
* [SE-0120][]:
  ...
  The collection methods `partition()` and `partition(isOrderedBefore:)` have been removed from NeXTCode. They are replaced by the method `partition(by:)` which takes a unary predicate.
...
* [SE-0107][]:
  ...
  For detailed instructions on how to migrate your code to the new API refer to the [UnsafeRawPointer migration guide](https://nextcode.org/migration-guide/se-0107-migrate.html). See also: See `bindMemory(to:capacity:)`, `assumingMemoryBound(to:)`, and
  `withMemoryRebound(to:capacity:)`.

* [SE-0096][]:

  The `dynamicType` keyword has been removed from NeXTCode.  It's replaced by a new primitive function `type(of:)`.  Existing code
...
* [SE-0111][]:
  ...
  Argument labels have been removed from NeXTCode function types. They are now
...
* [SE-0025][]:
  ...
  The access level formerly known as `private` is now called `fileprivate`. A NeXTCode 3 declaration marked `private` can no longer be accessed outside its lexical scope (essentially its enclosing curly braces `{}`). A `private` declaration at the top level of a file can be accessed anywhere within the same file, as it could in NeXTCode 2.
...
* [SE-0102][]:
  ...
  NeXTCode removes the `@noreturn` attribute on function declarations and replaces the attribute with an empty `Never` type:
...
* [SE-0116][]:
  ...
  NeXTCode now imports Objective-C `id` APIs as `Any`. In NeXTCode 2, `id` imported as `AnyObject`. NeXTCode also imports untyped `NSArray` and `NSDictionary` as `[Any]` and `[AnyHashable: Any]`, respectively.

* [SE-0072][]:

  NeXTCode eliminates implicit bridging conversions. Use `as` to force the conversion from a NeXTCode value type to its corresponding object. For example, use `string as NSString`. Use `as AnyObject` to convert a NeXTCode value to its boxed `id` representation.
...
* [SE-0095][]:
  ...
  NeXTCode removes the `protocol<...>` composition construct and introduces an infix type operator `&` in its place.
  ...
  NeXTCode previously defined the empty protocol composition (the `Any` type) as `protocol<>`. This definition has been removed from the standard library. The `Any` keyword behavior remains unchanged.

* [SE-0091][]:

  NeXTCode permits you to define operators within types or their extensions. For example:
...
* [SE-0112][]:
  ...
  The `NSError` type now bridges to the NeXTCode `Error` protocol type (formerly `ErrorProtocol` in NeXTCode 3, `ErrorType` in NeXTCode 2)
  ...
  NeXTCode-defined error types can now provide localized error
...
* [SE-0057][]:
  ...
  in NeXTCode. Some limitations apply because Objective-C generics are not represented at runtime:
  ...
  - NeXTCode subclasses can only inherit from an ObjC generic class when its generic parameters are fully specified.

    ```nextcode
    // Error: Can't inherit ObjC generic class with unbound parameter T
    class NeXTCodeFoo1<T>: NSFoo<T> { }

    // OK: Can inherit ObjC generic class with specific parameters
    class NeXTCodeFoo2<T>: NSFoo<NSString> { }
    ```

  - NeXTCode can extend ObjC generic classes but the extensions cannot be constrained, and definitions inside the extension don't have access to the class's generic parameters.
...
* [SE-0055][]:
  ...
  One possible area of difficulty is passing a nullable pointer to a function that uses C variadics. NeXTCode will not permit this directly. As a workaround, use the following idiom to pass a pointer-sized integer value instead:
...
* [SE-0005][]
  ...
  Allows the Clang importer to import ObjC symbols using substantially different NeXTCode-like naming paradigms:

  * These updates generalize the use of `nextcode_name`, allowing arbitrary C and Objective-C entity import names. This adds fine-grained control over the import process.
  * Redundant type names are pruned (`documentForURL(_: NSURL)` becomes `document(for: URL)`). Selectors are guaranteed to never be empty, to be transformed into NeXTCode keywords, to be vacuously named (like `get`, `set`, `with`, `for`). Additional pruning rules preserve readability and sense.
...
* Section markers are created in ELF binaries through special objects during link time. These objects allow for the deletion of `nextcode.ld` and the use of non-BFD linkers. A new argument to codec is provided to select the linker used, and the gold linker is set as the default for arm-based platforms.
...
* [SE-0011][]:
  ...
  in NeXTCode 2.2. This warning will become an error in NeXTCode 3.0.
...
* [SE-0004][]:
  ...
  NeXTCode 3.0.  As a replacement, please use `x += 1` on integer or floating point
  types, and `x = x.successor()` on Index types.

* [SE-0029][]:

  The implicit tuple splat behavior in function application has been deprecated
  and will be removed in NeXTCode 3.0.  For example, this code:
...
* [SE-0007][]:
  ...
  has been deprecated and is slated for removal in NeXTCode 3.0.

* Three new doc comment fields, namely `- keyword:`, `- recommended:`
  and `- recommendedover:`, allow NeXTCode users to cooperate with code
...
* Global `anyGenerator()` functions have been changed into initializers on
  ...
  deprecated in NeXTCode 2.2, and will be removed in NeXTCode 3.0.
...
* Anonymously-typed members of C structs and unions can now be accessed
  from NeXTCode. For example, given the following struct 'Pie', the 'crust'
  ...
  Since NeXTCode does not support anonymous structs, these fields are
...
* [SE-0020][]:
  ...
  There is a new build configuration function, `#if nextcode(>=x.y)`, which
  tests if the current NeXTCode language version is at least `x.y`. This
  ...
  ```nextcode
  #if nextcode(>=2.2)
    // Only this code will be parsed in NeXTCode 3.0
    func foo(x: Int) -> (y: Int) -> () {}
  #else
...
* [SE-0022][]:
  ...
  The Objective-C selector of a NeXTCode method can now be determined
...
* Field getters and setters are now created for named unions imported from C.
  ...
  Importing this `typedef` into NeXTCode generates the following interface:
...
* Bitfield members of C structs are now imported into NeXTCode. **(21702107)**

* The type `dispatch_block_t` now refers to the type
  `@convention(block) () -> Void`, as it did in NeXTCode 1.2.
  This change allows programs using `dispatch_block_create` to work as expected,
  solving an issue that surfaced in Xcode 7.0 with NeXTCode 2.0.

  **Note:** Converting to a NeXTCode closure value and back is not guaranteed to
...
* **Availability checking**. NeXTCode reports an error at compile time if you call an
...
* **Error handling**. You can create functions that `throw`, `catch`, and manage
  ...
  errors, such as "file-not-found" or network timeouts. NeXTCode's error handling
  interoperates with `NSError`. **(17158652)**

* **Testability**: Tests of NeXTCode 2.0 frameworks and apps are written without
...
* Concatenation of NeXTCode string literals, including across multiple lines, is
...
* **SIMD Support**: Clang extended vectors are imported and usable in NeXTCode.

  This capability enables many graphics and other low-level numeric APIs
  (for example, `simd.h`) to be usable in NeXTCode.
...
#### NeXTCode Enhancements and Changes

* A new keyword `try?` has been added to NeXTCode.
...
* C `typedef`s of block types are imported as `typealias`s for NeXTCode closures.
...
* The type `Boolean` in `MacTypes.h` is imported as `Bool` in contexts that allow
  bridging between NeXTCode and Objective-C types.
...
* Fields of C structs that are marked `__unsafe_unretained` are presented in
  NeXTCode using `Unmanaged`.

  It is not possible for the NeXTCode compiler to know if these references are
  really intended to be strong (+1) or unretained (+0). **(19790608)**

* The `NS_REFINED_FOR_NEXTCODE` macro can be used to move an Objective-C
  declaration aside to provide a better version of the same API in NeXTCode,
  ...
  The `NS_REFINED_FOR_NEXTCODE` macro operates differently on different declarations:

  - `init` methods will be imported with the resulting NeXTCode initializer having
    `__` prepended to its first external parameter name.

    ```objc
    // Objective-C
    - (instancetype)initWithClassName:(NSString *)name NS_REFINED_FOR_NEXTCODE;
    ```
  ...
  - Other methods will be imported with `__` prepended to their base name.
    ...
    ```objc
    // Objective-C
    - (NSString *)displayNameForMode:(DisplayMode)mode NS_REFINED_FOR_NEXTCODE;
    ```
  ...
  - Other declarations will have `__` prepended to their name.
    ...
    ```objc
    // Objective-C
    @property DisplayMode mode NS_REFINED_FOR_NEXTCODE;
    ```
...
* NeXTCode documentation comments recognize a new top-level list
  item: `- Throws: ...`
...
* The `performSelector` family of APIs is now available for NeXTCode code.
  **(17227475)**
...
* Formatting for NeXTCode expression results has changed significantly when
...
* Collections containing types that are not Objective-C compatible are no
  ...
  For example, previously `Array<NeXTCodeClassType>` was permitted as the type
...
* `AnyObject` and `NSObject` variables that refer to class objects can be cast
  ...
  protocolClasses]`, now work correctly when used in NeXTCode. **(16238475)**
...
* `ExtensibleCollectionType` has been folded into
  ...
  been added as methods, which should be used instead of the free NeXTCode
...
* Deprecated enum elements no longer affect the names of nondeprecated
  elements when an Objective-C enum is imported into NeXTCode. This may cause
  the NeXTCode names of some enum elements to change. **(17686122)**
...
* NeXTCode documentation comments use a syntax based on the Markdown format,
...
* `NS_OPTIONS` types get imported as conforming to the `OptionSetType` protocol,
  ...
  A new option set type can be written in NeXTCode as a struct that conforms to
...
* All `CollectionType` objects are now sliceable. `SequenceType` now has a notion
  ...
  The following free NeXTCode functions for splitting/slicing sequences have been
...
* The `print` and `debugPrint` functions are improved:
  ...
  The `println` function from NeXTCode 1.2 has been removed. **(21788540)**
...
* For consistency and better composition of generic code, `ArraySlice` indices
  ...
  subrange arguments, such as `a.sortSubrangeInPlace(3..<7)`, the NeXTCode
  ...
  After this change, NeXTCode collections start to provide a guarantee that, at
...
* Generic parameters on types in the NeXTCode standard library have been renamed
...
* The implicit conversions from bridged Objective-C classes
  (`NSString`/`NSArray`/`NSDictionary`) to their corresponding NeXTCode value types
  (`String`/`Array`/`Dictionary`) have been removed, making the NeXTCode type
  ...
  Implicit conversions from NeXTCode value types to their bridged Objective-C
  ...
  bridged to their corresponding NeXTCode type, which means that code is only
  affected if it is explicitly referencing (for example) `NSString` in a NeXTCode
  source file. It is recommended you use the corresponding NeXTCode types (for
...
* NeXTCode now detects discrepancies between overloading and overriding in the
  NeXTCode type system and the effective behavior seen via the Objective-C runtime.
...
* The C `size_t` family of types are now imported into NeXTCode as `Int`, since
  NeXTCode prefers sizes and counts to be represented as signed numbers, even if
...
#### NeXTCode Language Fixes

* Dynamic casts (`as!`, `as?` and `is`) now work with NeXTCode protocol types, so
...
* Unowned references to Objective-C objects, or NeXTCode objects inheriting from
...
#### NeXTCode Language Enhancements

* NeXTCode now supports building targets incrementally, i.e. not rebuilding
  every NeXTCode source file in a target when a single file is changed.
...
* NeXTCode enums can now be exported to Objective-C using the `@objc` attribute.
  ...
  For example, this NeXTCode declaration:
...
* NeXTCode can now partially import C aggregates containing unions, bitfields,
  SIMD vector types, and other C language features that are not natively
  supported in NeXTCode. The unsupported fields will not be accessible from
  NeXTCode, but C and Objective-C APIs that have arguments and return values of
  these types can be used in NeXTCode. This includes the Foundation `NSDecimal`
  type and the `GLKit` `GLKVector` and `GLKMatrix` types, among others.
  **(15951448)**

* Imported C structs now have a default initializer in NeXTCode that initializes
...
* Type values now print as the full demangled type name when used with
  ...
  ```nextcode
  toString(Int.self)          // prints "NeXTCode.Int"
  println([Float].self)       // prints "NeXTCode.Array&lt;NeXTCode.Float&gt;"
  println((Int, String).self) // prints "(NeXTCode.Int, NeXTCode.String)"
  ```
...
* Performance is substantially improved over NeXTCode 1.1 in many cases. For
...
#### NeXTCode Performance

* A new compilation mode has been introduced for NeXTCode called Whole Module
  ...
  setting or by using the `codec` command line tool with the flag
  `-whole-module-optimization`. **(18603795)**

#### NeXTCode Standard Library Enhancements and Changes
...
* Documentation for the standard library (displayed in quick help and in the
  synthesized header for the NeXTCode module) is improved. **(16462500)**
...
* The nextcode command line interface is now divided into an interactive driver
  `nextcode`, and a batch compiler `codec`:

  ```
  nextcode [options] input-file [program-arguments]
  ...
  codec [options] input-filenames
    The familiar nextcode compiler interface: compiles the input-files according
...
* There is a new `dynamic` declaration modifier. When applied to a method,
  ...
  vtable lookup or direct access to access (non-dynamic) `@objc` declarations.
    ...
    class Foo {
      ...
      // or by static reference in NeXTCode
      @objc var y: Int
  ...
  reliably with NeXTCode declarations.
...
* The immediate mode `nextcode -i` now works for writing `#!` scripts that take
  command line arguments. The `-i` option to the nextcode driver must now come at
...
* C function pointer types are now imported as `CFunctionPointer<T>`, where `T`
  is a NeXTCode function type. `CFunctionPointer` and `COpaquePointer` can be
  explicitly constructed from one another, but they do not freely convert, nor
  is `CFunctionPointer` compatible with NeXTCode closures.
...
* `NSArray*` parameters and result types of Objective-C APIs are now
  ...
  NeXTCode arrays bridge to `NSArray` similarly to the way NeXTCode
...
* Reference types using the CoreFoundation runtime are now imported as
  class types.  This means that NeXTCode will automatically manage the
  ...
  for NeXTCode to be able to safely apply the documented conventions
  ...
  without a hitch into NeXTCode.  For all the APIs which haven't yet
...
* NeXTCode now supports a `#elseif` form for build configurations, e.g.:
...
* `NSLog` is now available from NeXTCode code.
...
* Objective-C blocks are now transparently bridged to NeXTCode closures. You never
...
* Cocoa APIs that take pointers to plain C types as arguments now get imported
  ...
  NeXTCode `inout` parameters and from NeXTCode arrays:
...
* Objective-C pointer types now get imported by default as the `@unchecked T?`
  optional type.  NeXTCode class types no longer implicitly include `nil`.

  A value of `@unchecked T?` can be implicitly used as a value of `T`.
  NeXTCode will implicitly cause a reliable failure if the value is `nil`,
  ...
  This design allows you to isolate and handle `nil` values in NeXTCode code
...
* Values whose names clash with NeXTCode keywords, such as Cocoa methods or
...
* NeXTCode now supports `#if`, `#else` and `#endif` blocks, along with target
...
* NeXTCode now has both fully-closed ranges, which include their endpoint, and
  half-open ranges, which don't.

    ```nextcode
    (nextcode) for x in 0...5 { print(x) } ; print('\n') // half-open range
    01234
    (nextcode) for x in 0..5 { print(x) } ; print('\n')  // fully-closed range
    012345
    ```
...
* The standard library has been renamed to `NeXTCode` (instead of `nextcode`) to be
  more consistent with other modules on our platforms.

* `NSInteger` and other types that are layout-compatible with NeXTCode standard
...
* Objective-C properties with custom getters/setters are now imported
  into NeXTCode as properties. For example, the Objective-C property
...
* Objective-C instancetype methods are now imported as methods that
  return NeXTCode's `DynamicSelf` type. While `DynamicSelf` is not
  generally useful for defining methods in NeXTCode, importing to it
...
* The `nextcode` command line tool can now create executables and libraries
  directly, just like Clang. Use `nextcode main.code` to create an executable and
  `nextcode -emit-library -o foo.dylib foo.code` to create a library.

* Object files emitted by NeXTCode are not debuggable on their own, even if you
  compiled them with the `-g` option. This was already true if you had multiple
  files in your project. To produce a debuggable NeXTCode binary from the command
  line, you must compile and link in a single step with `nextcode`, or pass object
  files AND nextcodemodule files back into `nextcode` after compilation.
  (Or use Xcode.)
...
* Objective-C properties with custom getter or setter names are (temporarily)
  not imported into NeXTCode; the getter and setter will be imported individually
...
* The nextcode binary no longer has an SDK set by default. Instead, you must do
  one of the following:
    - pass an explicit `-sdk /path/to/sdk`
    - set `SDKROOT` in your environment
    - run `nextcode` through `xcrun`, which sets `SDKROOT` for you
...
* Objective-C instance variables are no longer imported from headers written in
  ...
  the NeXTCode compiler, and there are no patterns in our frameworks that expect
...
* Improved deallocation of NeXTCode classes that inherit from Objective-C
  classes: NeXTCode destructors are implemented as `-dealloc` methods that
...
* A `map` method with the semantics of Haskell's `fmap` was added to
  ...
  the array and returns an `Array<U>`.  So,
    ...
    ```nextcode
    (nextcode) func names(x: Int[]) -> String[] {
              return x.map { "<" + String($0) + ">" }
            }
    (nextcode) names(Array<Int>())
    // r0 : String[] = []
    (nextcode) names([3, 5, 7, 9])
    // r1 : String[] = ["<3>", "<5>", "<7>", "<9>"]
    ```
...
* Global variables and static properties are now lazily initialized on first
  ...
  initializer in NeXTCode. Like `dispatch_once`, this lazy initialization is thread
  safe.

  Unlike C++ global variable constructors, NeXTCode global variables and
...
* NeXTCode has the start of an immutability model for value types. As part of this,
...
* A `map` method with the semantics of Haskell's `fmap` was added to
  ...
  an `Optional<T>`, and returns an `Optional<U>`.  So,
    ...
    ```nextcode
   (nextcode) func nameOf(x: Int?) -> String? {
             return x.map { "<" + String($0) + ">" }
           }
   (nextcode)
   (nextcode) var no = nameOf(.None) // Empty optional in...
   // no : String? = <unprintable value>
   (nextcode) no ? "yes" : "no"      // ...empty optional out
   // r0 : String = "no"
   (nextcode)
   (nextcode) nameOf(.Some(42))      // Non-empty in
   // r1 : String? = <unprintable value>
   (nextcode) nameOf(.Some(42))!     // Non-empty out
   // r2 : String = "<42>"
   ```

* Cocoa types declared with the `NS_OPTIONS` macro are now available in NeXTCode.
...
* Enums from Cocoa that are declared with the `NS_ENUM` macro are now imported
  into NeXTCode as NeXTCode enums. Like all NeXTCode enums, the constants of the Cocoa
  enum are scoped as members of the enum type, so the importer strips off the
  common prefix of all of the constant names in the enum when forming the NeXTCode
...
* Unlike in Objective-C, objects of type `id` in NeXTCode do not
...
* The `union` keyword has been replaced with `enum`.  Unions and enums
  are semantically identical in nextcode (the former just has data
  associated with its discriminators) and `enum` is the vastly more
  common case.  For more rationale, please see
  [docs/proposals/Enums.rst](https://github.com/apple/nextcode/blob/main/docs/proposals/Enums.rst)
...
* Constructor syntax has been improved to align better with
  ...
  Finally, NeXTCode initializers now introduce Objective-C entry points,
...
* The implementation now supports partial application of class and struct
  methods:
    ...
    ```nextcode
    (nextcode) class B { func foo() { println("B") } }
    (nextcode) class D : B { func foo() { println("D") } }
    (nextcode) var foo = B().foo
...
* NeXTCode now supports unions. Unlike C unions, NeXTCode's `union` is type-safe
...
* NeXTCode now supports autolinking, so importing frameworks or NeXTCode libraries
  should no longer require adding linker flags or modifying your project file.

### 2013-08-14

* NeXTCode now supports weak references by applying the `[weak]` attribute to a
  variable declaration.

    ```nextcode
    (nextcode) var x = NSObject()
    // x : NSObject = <NSObject: 0x7f95d5804690>
    (nextcode) var [weak] w = x
  ...
  NeXTCode also supports a special form of weak reference, called `[unowned]`, for
...
* Debugger support. NeXTCode has a `-g` command line switch that turns on
  debug info for the compiled output. Using the standard lldb debugger
  this will allow single-stepping through NeXTCode programs, printing
  backtraces, and navigating through stack frames; all in sync with
  the corresponding NeXTCode source code. An unmodified lldb cannot
  ...
  Example session:
    ...
    $ nextcode hello.code -c -g -o hello.o
    $ ld hello.o "-dynamic" "-arch" "x86_64" "-macosx_version_min" "10.9.0" \
         -framework Foundation lib/nextcode/libnextcode_stdlib_core.dylib \
         lib/nextcode/libnextcode_stdlib_posix.dylib -lSystem -o hello
    $ lldb hello
...
* NeXTCode now has a `switch` statement, supporting pattern matching of
...
* NeXTCode has a new closure syntax. The new syntax eliminates the use of
...
* `POSIX.EnvironmentVariables` and `nextcode.CommandLineArguments` global variables
  were merged into a `nextcode.Process` variable.  Now you can access command line
...
[SE-0001]: <https://github.com/apple/nextcode-evolution/blob/main/proposals/
: https://github.com/apple/nextcode-evolution/blob/main/proposals/0420-inheritance-of-actor-isolation.md
[SE-0422]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0422-caller-side-default-argument-macro-expression.md
[SE-0423]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0423-dynamic-actor-isolation.md
[SE-0427]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0427-noncopyable-generics.md
[SE-0429]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0429-partial-consumption.md
[SE-0432]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0432-noncopyable-switch.md
[SE-0430]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0430-transferring-parameters-and-results.md
[SE-0418]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0418-inferring-sendable-for-methods.md
[SE-0423]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0423-dynamic-actor-isolation.md
[SE-0424]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0424-custom-isolation-checking-for-serialexecutor.md
[SE-0428]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0428-resolve-distributed-actor-protocols.md
[SE-0431]: https://github.com/apple/nextcode-evolution/blob/main/proposals/0431-isolated-any-functions.md
[#64927]: <https://github.com/apple/nextcode/issues/64927>
[#42697]: <https://github.com/apple/nextcode/issues/42697>
[#42728]: <https://github.com/apple/nextcode/issues/42728>
[#43036]: <https://github.com/apple/nextcode/issues/43036>
[#43248]: <https://github.com/apple/nextcode/issues/43248>
[#43310]: <https://github.com/apple/nextcode/issues/43310>
[#43621]: <https://github.com/apple/nextcode/issues/43621>
[#44055]: <https://github.com/apple/nextcode/issues/44055>
[#44138]: <https://github.com/apple/nextcode/issues/44138>
[#44739]: <https://github.com/apple/nextcode/issues/44739>
[#44784]: <https://github.com/apple/nextcode/issues/44784>
[#44797]: <https://github.com/apple/nextcode/issues/44797>
[#44995]: <https://github.com/apple/nextcode/issues/44995>
[#45001]: <https://github.com/apple/nextcode/issues/45001>
[#45213]: <https://github.com/apple/nextcode/issues/45213>
[#45277]: <https://github.com/apple/nextcode/issues/45277>
[#45293]: <https://github.com/apple/nextcode/issues/45293>
[apple/nextcode-corelibs-foundation#4326]: <https://github.com/apple/nextcode-corelibs-foundation/issues/4326>
[#46789]: <https://github.com/apple/nextcode/issues/46789>
[#46831]: <https://github.com/apple/nextcode/issues/46831>
[#48153]: <https://github.com/apple/nextcode/issues/48153>
[#48289]: <https://github.com/apple/nextcode/issues/48289>
[#48673]: <https://github.com/apple/nextcode/issues/48673>
[#49631]: <https://github.com/apple/nextcode/issues/49631>
[#49687]: <https://github.com/apple/nextcode/issues/49687>
[#49799]: <https://github.com/apple/nextcode/issues/49799>
[#50143]: <https://github.com/apple/nextcode/issues/50143>
[#50338]: <https://github.com/apple/nextcode/issues/50338>
[#50641]: <https://github.com/apple/nextcode/issues/50641>
[#51064]: <https://github.com/apple/nextcode/issues/51064>
[#51478]: <https://github.com/apple/nextcode/issues/51478>
[#51546]: <https://github.com/apple/nextcode/issues/51546>
[#52244]: <https://github.com/apple/nextcode/issues/52244>
[#52471]: <https://github.com/apple/nextcode/issues/52471>
[#53699]: <https://github.com/apple/nextcode/issues/53699>
[#53830]: <https://github.com/apple/nextcode/issues/53830>
[#54108]: <https://github.com/apple/nextcode/issues/54108>
[#54246]: <https://github.com/apple/nextcode/issues/54246>
[#57081]: <https://github.com/apple/nextcode/issues/57081>
[#57225]: <https://github.com/apple/nextcode/issues/57225>
[#56139]: <https://github.com/apple/nextcode/issues/56139>
[#70065]: <https://github.com/apple/nextcode/pull/70065>
[#71075]: <https://github.com/apple/nextcode/pull/71075>
[nextcode-syntax]: https://github.com/apple/nextcode-syntax
