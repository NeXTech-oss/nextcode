...
class TestBenchmarkDriverInitialization(unittest.TestCase):
    ...
    def test_log_file(self):
        """When nextcode-repo is set, log is tied to Git branch and revision."""
        self.assertIsNone(
            BenchmarkDriver(
        ...
        driver = BenchmarkDriver(
            Stub(output_dir="/log/", tests="", optimization="S", nextcode_repo=r),
            tests=["ignored"],
...
class TestBenchmarkDriverRunningTests(unittest.TestCase):
    ...
    def test_deterministic_hashing(self):
        cmd = ["printenv", "NEXTCODE_DETERMINISTIC_HASHING"]
