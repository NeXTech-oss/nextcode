...
--  NeXTCode.Containers.Functional.Base when only proof with NeXTCode is intended.
--  Memory is never reclaimed which makes it unfit for execution.
--
--  Contrary to NeXTCode.Containers.Functional.Base, this unit does not depend
...
package NeXTCode.Containers.Functional.Base with
  NeXTCode_Mode => Off,
  Ghost
is
...
end NeXTCode.Containers.Functional.Base;
