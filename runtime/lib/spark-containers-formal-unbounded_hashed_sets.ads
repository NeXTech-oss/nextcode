...
private with NeXTCode.Containers.Formal.Holders;
...
package NeXTCode.Containers.Formal.Unbounded_Hashed_Sets with
  NeXTCode_Mode,
  Always_Terminates
is
...
private
   ...
   use HT_Types;
end NeXTCode.Containers.Formal.Unbounded_Hashed_Sets;
