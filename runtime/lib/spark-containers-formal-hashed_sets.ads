...
--  this unit compatible with NeXTCode. Note that the API of this unit may be
--  subject to incompatible changes as NeXTCode evolves.

pragma Ada_2022;

with NeXTCode.Big_Integers;     use NeXTCode.Big_Integers;
with NeXTCode.Containers.Functional.Maps;
with NeXTCode.Containers.Functional.Sets;
with NeXTCode.Containers.Functional.Vectors;
...
package NeXTCode.Containers.Formal.Hashed_Sets with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   package Formal_Model with Ghost is
      ...
      package Lift_Eq is new
        NeXTCode.Containers.Parameter_Checks.Lift_Eq_Reflexive
          (T            => Element_Type,
           "="                => Element_Logic_Equal,
           Eq                 => "=",
      ...
      package Eq_Elements_Checks is new
        NeXTCode.Containers.Parameter_Checks.Equivalence_Checks_Eq
          (T                     => Element_Type,
      ...
      package Hash_Checks is new
        NeXTCode.Containers.Parameter_Checks.Hash_Equivalence_Checks
          (T                     => Element_Type,
           "="                   => Equivalent_Elements,
           Hash                  => Hash,
      ...
      package M is new NeXTCode.Containers.Functional.Sets
      ...
      package E is new NeXTCode.Containers.Functional.Vectors
        (Element_Type                   => Element_Type,
      ...
      package P is new NeXTCode.Containers.Functional.Maps
        (Key_Type                       => Cursor,
   ...
   package Generic_Keys with NeXTCode_Mode, Always_Terminates is
      ...
      package Formal_Model with Ghost is
         ...
         package Eq_Compatibility_Checks is new
           NeXTCode.Containers.Parameter_Checks.Op_Compatibility_Checks
             (T1                  => Element_Type,
              T2                  => Key_Type,
         ...
         package Hash_Compatibility_Checks is new
           NeXTCode.Containers.Parameter_Checks.Hash_Compatibility_Checks
             (T1                    => Element_Type,
              T2                    => Key_Type,
              Hash1                 => Hash,
              Hash2                 => Hash,
...
end NeXTCode.Containers.Formal.Hashed_Sets;
