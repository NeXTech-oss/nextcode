...
package NeXTCode.Containers.Formal.Unbounded_Doubly_Linked_Lists with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   package Formal_Model with Ghost is
      ...
      package M is new NeXTCode.Containers.Functional.Vectors
   ...
   package Generic_Sorting with NeXTCode_Mode, Always_Terminates is
...
end NeXTCode.Containers.Formal.Unbounded_Doubly_Linked_Lists;
