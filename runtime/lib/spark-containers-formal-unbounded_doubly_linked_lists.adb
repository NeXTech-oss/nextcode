...
with NeXTCode.Containers.Stable_Sorting; use NeXTCode.Containers.Stable_Sorting;
with System; use type System.Address;

package body NeXTCode.Containers.Formal.Unbounded_Doubly_Linked_Lists with
  NeXTCode_Mode => Off
is
   ...
   package body Generic_Sorting with NeXTCode_Mode => Off is
