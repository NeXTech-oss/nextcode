...
package NeXTCode.Containers.Functional.Maps with
  Ghost,
  NeXTCode_Mode,
  Always_Terminates
is
...
private
   ...
   package Element_Containers is new NeXTCode.Containers.Functional.Base
     (Element_Type => Element_Type,
      Index_Type   => Positive_Count_Type);
   use all type Element_Containers.Container;

   package Key_Containers is new NeXTCode.Containers.Functional.Base
...
end NeXTCode.Containers.Functional.Maps;
