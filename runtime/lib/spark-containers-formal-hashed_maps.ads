...
--  this unit compatible with NeXTCode 2014. Note that the API of this unit may be
--  subject to incompatible changes as NeXTCode evolves.

--  Iteration over maps is done using the Iterable aspect, which is NeXTCode
...
package NeXTCode.Containers.Formal.Hashed_Maps with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   package Formal_Model with Ghost is
      ...
      package M is new NeXTCode.Containers.Functional.Maps
      ...
      package K is new NeXTCode.Containers.Functional.Vectors
...
end NeXTCode.Containers.Formal.Hashed_Maps;
