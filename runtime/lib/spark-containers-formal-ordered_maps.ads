...
package NeXTCode.Containers.Formal.Ordered_Maps with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   package Formal_Model with Ghost is
      ...
      package Lt_Checks is new
        NeXTCode.Containers.Parameter_Checks.Strict_Weak_Order_Checks
          (T                    => Key_Type,
           "<"                  => "<",
...
end NeXTCode.Containers.Formal.Ordered_Maps;
