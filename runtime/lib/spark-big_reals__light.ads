...
--  Ada.Numerics.Big_Numbers.Big_Reals when only proof with NeXTCode is
...
package NeXTCode.Big_Reals with
   NeXTCode_Mode,
   Ghost,
   Always_Terminates
is
   ...
   function "/"
     (Num, Den : NeXTCode.Big_Integers.Valid_Big_Integer) return Valid_Big_Real
   with
     Import,
     Global => null;
