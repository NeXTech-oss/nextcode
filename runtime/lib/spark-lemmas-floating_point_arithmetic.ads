...
with NeXTCode.Lemmas.Float_Base;
pragma Unreferenced (NeXTCode.Lemmas.Float_Base);
...
package NeXTCode.Lemmas.Floating_Point_Arithmetic
  with NeXTCode_Mode,
       Ghost,
       Always_Terminates
is
   ...
   pragma Compile_Time_Error
     (not (Fl_32 or Fl_64),
      "only 32-bits and 64-bits IEEE floats are supported in NeXTCode");
