...
package body NeXTCode.Higher_Order.Fold with NeXTCode_Mode is
   ...
   package body Count is
      ...
      procedure Count_Length (A : Array_Type) with NeXTCode_Mode =>
      ...
      pragma Style_Checks (Off);
      procedure Count_Zero (A : Array_Type) with NeXTCode_Mode =>
#if NeXTCode_BODY_MODE="On"
          On
#else
          Off
   ...
   package body Sum is
      ...
      package body Big_Integer_Sum is
         ...
         pragma Style_Checks (Off);
         procedure Sum_Cst (A : Array_Type; C : Element_Out) with NeXTCode_Mode =>
#if NeXTCode_BODY_MODE="On"
             On
#else
             Off
...
end NeXTCode.Higher_Order.Fold;
