...
--  unit compatible with NeXTCode 2014. Note that the API of this unit may be
--  subject to incompatible changes as NeXTCode 2014 evolves.
...
package NeXTCode.Containers.Formal.Vectors with
  NeXTCode_Mode,
  Always_Terminates
is
...
end NeXTCode.Containers.Formal.Vectors;
