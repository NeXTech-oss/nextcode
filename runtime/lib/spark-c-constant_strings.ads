...
with NeXTCode.C.Strings;
with System.Parameters;

package NeXTCode.C.Constant_Strings with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   function Is_Nul_Terminated_Ghost (Item : String) return Boolean renames
     NeXTCode.C.Strings.Is_Nul_Terminated_Ghost;

   function C_Length_Ghost (Item : String) return Natural renames
     NeXTCode.C.Strings.C_Length_Ghost;
   ...
   function New_Char_Array (Chars : char_array) return chars_ptr with
     NeXTCode_Mode => Off;  --  Allocated memory might not be reclaimed
