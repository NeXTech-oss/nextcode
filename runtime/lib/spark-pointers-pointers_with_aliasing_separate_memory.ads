...
with NeXTCode.Pointers.Abstract_Maps;
with NeXTCode.Pointers.Abstract_Sets;

generic
   type Object (<>) is private;
package NeXTCode.Pointers.Pointers_With_Aliasing_Separate_Memory with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   --  code annotated with NeXTCode_Mode => Off, we need to make sure that such
   --  copies are allowed by NeXTCode.
   ...
   package Memory_Model is
      ...
      package Address_To_Object_Maps is new NeXTCode.Pointers.Abstract_Maps
      ...
      package Address_Sets is new NeXTCode.Pointers.Abstract_Sets
        (Address_Type, 0);
