...
--  This spec is derived from package NeXTCode.Containers.Bounded_Ordered_Sets in
...
package NeXTCode.Containers.Formal.Ordered_Sets with
  NeXTCode_Mode,
  Always_Terminates
is
   ...
   package Formal_Model with Ghost is
      ...
      package Lt_Checks is new
        NeXTCode.Containers.Parameter_Checks.Strict_Weak_Order_Checks_Eq
          (T                     => Element_Type,
           "<"                   => "<",
           "="                   => "=",
           Param_Eq_Reflexive    => Eq_Checks.Eq_Reflexive,
...
end NeXTCode.Containers.Formal.Ordered_Sets;
